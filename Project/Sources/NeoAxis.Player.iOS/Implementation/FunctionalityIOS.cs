...
namespace NeoAxis
{
	public partial class PlatformFunctionalityIOS : PlatformFunctionality
	{
		static PlatformFunctionalityIOS instance;
		public static Vector2I screenSize;

		/////////////////////////////////////////

		public PlatformFunctionalityIOS()
		{
			instance = this;
			SetInstance( instance, SystemSettings.Platform.iOS );

			new LogPlatformFunctionalityIOS();
			new PlatformSpecificUtilityIOS();
		}
