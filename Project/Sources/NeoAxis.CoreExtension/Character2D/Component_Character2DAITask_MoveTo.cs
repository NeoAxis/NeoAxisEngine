...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_Character2DAITask_MoveTo : Component_AITask
	{
		/// <summary>
		...
		public event Action<Component_Character2DAITask_MoveTo> RunChanged;
		...
		public event Action<Component_Character2DAITask_MoveTo> DistanceToReachChanged;
	...
	public class Component_Character2DAITask_MoveToPosition : Component_Character2DAITask_MoveTo
	{
		/// <summary>
		/// The target position.
		/// </summary>
		...
		public event Action<Component_Character2DAITask_MoveToPosition> TargetChanged;
	...
	public class Component_Character2DAITask_MoveToObject : Component_Character2DAITask_MoveTo
	{
		/// <summary>
		/// The target object.
		/// </summary>
		...
		/// <summary>Occurs when the <see cref="Target"/> property value changes.</summary>
		public event Action<Component_Character2DAITask_MoveToObject> TargetChanged;
