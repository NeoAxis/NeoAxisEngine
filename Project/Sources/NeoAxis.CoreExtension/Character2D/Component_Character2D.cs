...
namespace NeoAxis
{
	...
	{
		Component_RigidBody2D mainBody;
		...
		Component_RigidBody2D groundBody;
		...
		public event Action<Component_Character2D> HeightChanged;
		...
		public event Action<Component_Character2D> RadiusChanged;
		...
		public event Action<Component_Character2D> WalkUpHeightChanged;
		...
		public event Action<Component_Character2D> PositionToGroundHeightChanged;
		...
		public event Action<Component_Character2D> MassChanged;
		...
		public event Action<Component_Character2D> EyePositionChanged;
		...
		public event Action<Component_Character2D> ApplyGroundVelocityChanged;
		...
		public event Action<Component_Character2D> MinSpeedToSleepBodyChanged;
		...
		public event Action<Component_Character2D> LinearDampingOnGroundIdleChanged;
		...
		public event Action<Component_Character2D> LinearDampingOnGroundChanged;
		...
		public event Action<Component_Character2D> LinearDampingFlyChanged;
		...
		public event Action<Component_Character2D> WalkForwardMaxSpeedChanged;
		...
		//public event Action<Component_Character2D> WalkBackwardMaxSpeedChanged;
		...
		public event Action<Component_Character2D> WalkForceChanged;
		...
		public event Action<Component_Character2D> RunSupportChanged;
		...
		public event Action<Component_Character2D> RunForwardMaxSpeedChanged;
		...
		//public event Action<Component_Character2D> RunBackwardMaxSpeedChanged;
		...
		public event Action<Component_Character2D> RunForceChanged;
		...
		public event Action<Component_Character2D> FlyControlSupportChanged;
		...
		public event Action<Component_Character2D> FlyControlMaxSpeedChanged;
		...
		public event Action<Component_Character2D> FlyControlForceChanged;
		...
		public event Action<Component_Character2D> JumpSupportChanged;
		...
		public event Action<Component_Character2D> JumpSpeedChanged;
		...
		public event Action<Component_Character2D> JumpSoundChanged;
		...
		public event Action<Component_Character2D> CrouchingSupportChanged;
		...
		public event Action<Component_Character2D> CrouchingHeightChanged;
		...
		public event Action<Component_Character2D> CrouchingWalkUpHeightChanged;
		...
		public event Action<Component_Character2D> CrouchingPositionToGroundHeightChanged;
		...
		public event Action<Component_Character2D> CrouchingMaxSpeedChanged;
		...
		public event Action<Component_Character2D> CrouchingForceChanged;
		...
		public event Action<Component_Character2D> AnimateChanged;
		...
		public event Action<Component_Character2D> IdleAnimationChanged;
		...
		public event Action<Component_Character2D> WalkAnimationChanged;
		...
		public event Action<Component_Character2D> WalkAnimationSpeedChanged;
		...
		public event Action<Component_Character2D> RunAnimationChanged;
		...
		public event Action<Component_Character2D> RunAnimationSpeedChanged;
		...
		public event Action<Component_Character2D> FlyAnimationChanged;
		...
		public event Action<Component_Character2D> JumpAnimationChanged;
		...
		public Component_RigidBody2D GetCollisionBody()
		{
			return GetComponent<Component_RigidBody2D>( "Collision Body" );
		}

		public delegate void UpdateCollisionBodyEventDelegate( Component_Character2D sender );
		...
		public void UpdateCollisionBody()
		{
			...
			if( body == null )
			{
				body = CreateComponent<Component_RigidBody2D>( enabled: false );
			...
			body.MotionType = Component_RigidBody2D.MotionTypeEnum.Dynamic;
			...
			var capsuleShape = body.GetComponent<Component_CollisionShape2D_Capsule>();
			if( capsuleShape == null )
			{
				body.Enabled = false;
				capsuleShape = body.CreateComponent<Component_CollisionShape2D_Capsule>();
		...
		[Browsable( false )]
		public Component_RigidBody2D MainBody
		{
			get { return mainBody; }
		}
		...
		void TickMovement()
		{
			...
			if( mainBody.Active || !IsOnGround() )
			{
				...
				{
					if( groundBody.MotionType.Value != Component_RigidBody2D.MotionTypeEnum.Static && groundBody.Active )
					{
		...
		bool VolumeCheckGetFirstNotFreePlace( Capsule2[] sourceVolumeCapsules, Vector2 destVector, bool firstIteration, float step,
			out List<Component_RigidBody2D> collisionBodies, out float collisionDistance, out bool collisionOnFirstCheck )
		{
			collisionBodies = new List<Component_RigidBody2D>();
			collisionDistance = 0;
			...
			for( int nStep = 0; nStep < stepCount; nStep++ )
			{
				...
				foreach( var sourceVolumeCapsule in sourceVolumeCapsules )
				{
					...
					if( scene != null )
					{
						...
						//check by capsule
						{
							var contactTestItem = new Physics2DContactTestItem( capsule, 32, tainicom.Aether.Physics2D.Dynamics.Category.All, tainicom.Aether.Physics2D.Dynamics.Category.All, 0, Physics2DContactTestItem.ModeEnum.All );
							...
							foreach( var item in contactTestItem.Result )
							{
								if( item.Body == mainBody )
									continue;
								var body = item.Body as Component_RigidBody2D;
		...
		void CalculateMainBodyGroundDistanceAndGroundBody()// out Vector2 addForceOnBigSlope )
		{
			...
			if( scene != null )
			{
				...
				List<Component_RigidBody2D> collisionBodies;
				...
				if( collisionBodies.Count != 0 )
				{
					...
					Component_RigidBody2D foundBodyWithGoodAngle = null;
					...
					for( int nStep = 0; nStep < stepCount; nStep++ )
					{
						...
						var item = new Physics2DRayTestItem( ray, tainicom.Aether.Physics2D.Dynamics.Category.All, tainicom.Aether.Physics2D.Dynamics.Category.All, 0, Physics2DRayTestItem.ModeEnum.All );
						...
						if( item.Result.Length != 0 )
						{
							...
							{
								var rigidBody = result.Body as Component_RigidBody2D;
		...
		Capsule2 GetWorldCapsule( Component_CollisionShape2D_Capsule shape )
		{
		...
		Capsule2[] GetVolumeCapsules()
		{
			...
			var capsuleShape = mainBody.GetComponent<Component_CollisionShape2D_Capsule>();
			if( capsuleShape != null )
		...
		{
			var sprite = GetComponent<Component_Sprite>( onlyEnabledInHierarchy: true );
			if( sprite != null )
				return sprite.GetComponent<Component_SpriteAnimationController>( onlyEnabledInHierarchy: true );
			return null;
		}
		...
		public override void NewObjectSetDefaultConfiguration( bool createdFromNewObjectWindow = false )
		{
			...
			{
				var body = CreateComponent<Component_RigidBody2D>();
				body.Name = "Collision Body";
				body.CanBeSelected = false;
				body.MotionType = Component_RigidBody2D.MotionTypeEnum.Dynamic;

				var sprite = CreateComponent<Component_Sprite>();
				sprite.Name = "Sprite";
				...
				var controller = sprite.CreateComponent<Component_SpriteAnimationController>();
				controller.Name = "Sprite Animation Controller";

				var transformOffset = sprite.CreateComponent<Component_TransformOffset>();
				...
				var inputProcessing = CreateComponent<Component_Character2DInputProcessing>();
				inputProcessing.Name = "Character Input Processing";

				var characterAI = CreateComponent<Component_Character2DAI>();
				...
				Animate = true;
				IdleAnimation = ReferenceUtility.MakeReference( @"Base\Sprites\Penguin\Animation Idle.component" );
				WalkAnimation = ReferenceUtility.MakeReference( @"Base\Sprites\Penguin\Animation Walk.component" );
				//RunAnimation = ReferenceUtility.MakeReference( @"Base\Sprites\Penguin\Animation Run.component" );
				FlyAnimation = ReferenceUtility.MakeReference( @"Base\Sprites\Penguin\Animation Fly.component" );
				JumpAnimation = ReferenceUtility.MakeReference( @"Base\Sprites\Penguin\Animation Jump.component" );
			}
		}
		...
		public bool IsFreePositionToMove( Vector2 position )
		{
			...
			foreach( var sourceVolumeCapsule in volumeCapsules )
			{
				...
				if( scene != null )
				{
					var contactTestItem = new Physics2DContactTestItem( checkCapsule, 32, tainicom.Aether.Physics2D.Dynamics.Category.All, tainicom.Aether.Physics2D.Dynamics.Category.All, 0, Physics2DContactTestItem.ModeEnum.All );
					ParentScene.Physics2DContactTest( contactTestItem );
		...
		[Browsable( false )]
		public Component_RigidBody2D GroundBody
		{
		...
		public void ItemTake( IComponent_Item2D item )
		{
		...
		public void ItemDrop( IComponent_Item2D item, Transform newTransform = null )
		{
			var item2 = (Component_ObjectInSpace)item;
		...
		/// </summary>
		/// <param name="item"></param>
		public void ItemActivate( IComponent_Item2D item )
		{
			var item2 = (Component_ObjectInSpace)item;
			item2.Enabled = true;
		}
		...
		/// </summary>
		/// <param name="item"></param>
		public void ItemDeactivate( IComponent_Item2D item )
		{
			var item2 = (Component_ObjectInSpace)item;
			item2.Enabled = false;
		}
		...
		/// </summary>
		/// <returns></returns>
		public IComponent_Item2D ItemGetEnabledFirst()
		{
			foreach( var c in Components )
				if( c.Enabled && c is IComponent_Item2D item )
					return item;
			return null;
		}
