...
//			set
//			{
//				if( _door1OpenOffset.BeginSet( this, ref value ) )
//				{
//					try
//					{
...
//			set
//			{
//				if( _door1ClosedOffset.BeginSet( this, ref value ) )
//				{
//					try
//					{
...
//			set
//			{
//				if( _door2OpenOffset.BeginSet( this, ref value ) )
//				{
//					try
//					{
...
//			set
//			{
//				if( _door2ClosedOffset.BeginSet( this, ref value ) )
//				{
//					try
//					{
...
//			set { if( _openingTime.BeginSet( this, ref value ) ) { try { OpeningTimeChanged?.Invoke( this ); } finally { _openingTime.EndSet(); } } }
//		}
...
//			if( meshResult != null )
//				return new Box( meshResult.SpaceBounds.BoundingBox, tr.Position, tr.Rotation.ToMatrix3() * Matrix3.FromScale( tr.Scale ) );
//			else
//				return new Box( tr.Position );
//		}
//	}
//}
