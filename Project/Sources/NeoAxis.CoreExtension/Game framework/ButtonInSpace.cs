...
#if !DEPLOY
	[Editor.SettingsCell( typeof( Editor.ButtonInSpaceSettingsCell ) )]
#endif
	public class ButtonInSpace : MeshInSpace, InteractiveObject
	{
		bool clicking;
		...
		public event Action<ButtonInSpace> ActivatedChanged;
		...
		public event Action<ButtonInSpace> SwitchActivateOnClickChanged;
		...
		public event Action<ButtonInSpace> AllowInteractChanged;
		...
		public event Action<ButtonInSpace> ClickingTotalTimeChanged;
		...
		public event Action<ButtonInSpace> ClickingClickTimeChanged;
		...
		public event Action<ButtonInSpace> SoundClickingBeginChanged;
		...
		public event Action<ButtonInSpace> SoundClickChanged;
		...
		public event Action<ButtonInSpace> SoundClickingEndChanged;
		...
		public delegate void CanClickDelegate( ButtonInSpace sender, ref bool canClick );
		...
		public delegate void ClickDelegate( ButtonInSpace sender );
		...
		public event Action<ButtonInSpace> ClickingBeginEvent;
		public event Action<ButtonInSpace> ClickingEndEvent;
