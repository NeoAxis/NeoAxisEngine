...
#if !DEPLOY
	[Editor.EditorControl( typeof( Editor.CharacterEditor ), true )]
	[Editor.Preview( typeof( Editor.CharacterPreview ) )]
	[Editor.PreviewImage( typeof( Editor.CharacterPreviewImage ) )]
#endif
	public class Character : ObjectInSpace
	{
		RigidBody mainBody;
		...
		public event Action<Character> HeightChanged;
		...
		public event Action<Character> RadiusChanged;
		...
		public event Action<Character> WalkUpHeightChanged;
		...
		public event Action<Character> PositionToGroundHeightChanged;
		...
		public event Action<Character> MassChanged;
		...
		public event Action<Character> MaxSlopeAngleChanged;
		...
		public event Action<Character> EyePositionChanged;
		...
		public event Action<Character> ApplyGroundVelocityChanged;
		...
		public event Action<Character> MinSpeedToSleepBodyChanged;
		...
		public event Action<Character> LinearDampingOnGroundIdleChanged;
		...
		public event Action<Character> LinearDampingOnGroundChanged;
		...
		public event Action<Character> LinearDampingFlyChanged;
		...
		public event Action<Character> WalkForwardMaxSpeedChanged;
		...
		public event Action<Character> WalkBackwardMaxSpeedChanged;
		...
		public event Action<Character> WalkSideMaxSpeedChanged;
		...
		public event Action<Character> WalkForceChanged;
		...
		public event Action<Character> RunSupportChanged;
		...
		public event Action<Character> RunForwardMaxSpeedChanged;
		...
		public event Action<Character> RunBackwardMaxSpeedChanged;
		...
		public event Action<Character> RunSideMaxSpeedChanged;
		...
		public event Action<Character> RunForceChanged;
		...
		public event Action<Character> TurningSpeedChanged;
		...
		public event Action<Character> FlyControlSupportChanged;
		...
		public event Action<Character> FlyControlMaxSpeedChanged;
		...
		public event Action<Character> FlyControlForceChanged;
		...
		public event Action<Character> JumpSupportChanged;
		...
		public event Action<Character> JumpSpeedChanged;
		...
		public event Action<Character> JumpSoundChanged;
		...
		public event Action<Character> CrouchingSupportChanged;
		...
		public event Action<Character> CrouchingHeightChanged;
		...
		public event Action<Character> CrouchingWalkUpHeightChanged;
		...
		public event Action<Character> CrouchingPositionToGroundHeightChanged;
		...
		public event Action<Character> CrouchingMaxSpeedChanged;
		...
		public event Action<Character> CrouchingForceChanged;
		...
		public event Action<Character> AnimateChanged;
		...
		public event Action<Character> IdleAnimationChanged;
		...
		public event Action<Character> WalkAnimationChanged;
		...
		public event Action<Character> WalkAnimationSpeedChanged;
		...
		public event Action<Character> RunAnimationChanged;
		...
		public event Action<Character> RunAnimationSpeedChanged;
		...
		public event Action<Character> FlyAnimationChanged;
		...
		public event Action<Character> JumpAnimationChanged;
		...
		public event Action<Character> LeftTurnAnimationChanged;
		ReferenceField<Animation> _leftTurnAnimation = null;
		...
		public event Action<Character> RightTurnAnimationChanged;
		ReferenceField<Animation> _rightTurnAnimation = null;
		...
		//public event Action<Character> TorsoBoneChanged;
		...
		public event Action<Character> LeftHandBoneChanged;
		...
		//public event Action<Character> LeftHandPositionChanged;
		...
		//public event Action<Character> LeftHandRotationChanged;
		...
		public event Action<Character> RightHandBoneChanged;
		...
		//public event Action<Character> RightHandPositionChanged;
		...
		//public event Action<Character> RightHandRotationChanged;
		...
		public event Action<Character> HeadBoneChanged;
		...
		public void SetTransform( Transform value, bool updateInputProcessingLookDirection )
		{
			...
			if( updateInputProcessingLookDirection )
			{
				var inputProcessing = GetComponent<CharacterInputProcessing>();
				if( inputProcessing != null )
					inputProcessing.LookDirection = SphericalDirection.FromVector( TransformV.Rotation.GetForward() );
			}
		}

		public RigidBody GetCollisionBody()
		{
			return GetComponent<RigidBody>( "Collision Body" );
		}

		public delegate void UpdateCollisionBodyEventDelegate( Character sender );
		...
		public void UpdateCollisionBody()
		{
			...
			if( body == null )
			{
				body = CreateComponent<RigidBody>( enabled: false );
			...
			var capsuleShape = body.GetComponent<CollisionShape_Capsule>();
			if( capsuleShape == null )
			{
				body.Enabled = false;
				capsuleShape = body.CreateComponent<CollisionShape_Capsule>();
		...
		public void UpdateRotation()// bool allowUpdateOldRotation )
		{
			...
			if( !tr.Rotation.Equals( rot, epsilon ) )
			{
				...
				SetTransform( tr.UpdateRotation( rot ), false );
				//Rotation = rot;
		...
		void TickMovement()
		{
			...
			if( mainBody.Active || !IsOnGround() )
			{
				...
				{
					if( groundBody.MotionType.Value != RigidBody.MotionTypeEnum.Static && groundBody.Active )
					{
		...
		bool VolumeCheckGetFirstNotFreePlace( Capsule[] sourceVolumeCapsules, Vector3 destVector, bool firstIteration, float step,
			out List<RigidBody> collisionBodies, out float collisionDistance, out bool collisionOnFirstCheck )
		{
			collisionBodies = new List<RigidBody>();
			collisionDistance = 0;
		...
		void CalculateMainBodyGroundDistanceAndGroundBody()//out Vector3 addForceOnBigSlope )
		{
			...
			if( scene != null )
			{
				...
				List<RigidBody> collisionBodies;
				...
				if( collisionBodies.Count != 0 )
				{
					...
					RigidBody foundBodyWithGoodAngle = null;
		...
		Capsule GetWorldCapsule( CollisionShape_Capsule shape )
		{
			var scaleFactor = GetScaleFactor();
		...
		Capsule[] _cachedVolumeCapsulesArray;
		//need array?
		Capsule[] GetVolumeCapsules()
		{
			if( _cachedVolumeCapsulesArray == null )
				_cachedVolumeCapsulesArray = new Capsule[ 1 ];

			var volumeCapsules = _cachedVolumeCapsulesArray;// new Capsule[ 1 ];

			var capsuleShape = mainBody?.GetComponent<CollisionShape_Capsule>();
			if( capsuleShape != null )
		...
		void TickJump( bool ignoreTicks )
		{
			...
			if( IsOnGround() && onGroundTime > Time.SimulationDelta && jumpInactiveTime == 0 && jumpDisableRemainingTime != 0 && mainBody != null )
			{
				Vector3 vel = mainBody.LinearVelocity;
		...
		public MeshInSpaceAnimationController GetAnimationController()
		{
			var meshInSpace = GetComponent<MeshInSpace>( onlyEnabledInHierarchy: true );
			if( meshInSpace != null )
				return meshInSpace.GetComponent<MeshInSpaceAnimationController>( onlyEnabledInHierarchy: true );
			return null;
		}
		...
		void GetHandTransform( HandEnum hand, out double factor, out Transform transform )
		{
			...
			if( item != null )
			{
				...
				if( obj != null )
				{
					...
					if( weapon != null )
					{
						var tr = hand == HandEnum.Left ? weapon.LeftHandTransform.Value : weapon.RightHandTransform.Value;
			...
			for( var hand = HandEnum.Left; hand <= HandEnum.Right; hand++ )
			{
				...
				if( factor > 0 )
				{
					...
					if( updateIteration == 1 )
					{
						...
						var handBoneIndex = controller.GetBoneIndex( hand == HandEnum.Left ? LeftHandBone : RightHandBone );
			...
			if( Animate )
			{
				...
				if( controller != null )
				{
					...
					if( IsOnGroundWithLatency() )
					{
						...
						if( RunSupport )
						{
							var running = Math.Abs( linearSpeedNoScale ) > RunForwardMaxSpeed * 0.6;
							if( running )
							{
		...
		public override void NewObjectSetDefaultConfiguration( bool createdFromNewObjectWindow = false )
		{
			if( Components.Count == 0 )
			{
				...
				meshInSpace.Mesh = new Reference<Mesh>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh" );
				meshInSpace.Transform = new Reference<Transform>( NeoAxis.Transform.Identity, "this:$Transform Offset\\Result" );

				var controller = meshInSpace.CreateComponent<MeshInSpaceAnimationController>();
				...
				JumpSupport = true;
				Animate = true;
				IdleAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Idle" );
				WalkAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Walk" );
				RunAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Run" );
				FlyAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Fly" );
				JumpAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Jump" );
				LeftTurnAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Left Turn" );
				RightTurnAnimation = new Reference<Animation>( null, "Content\\Characters\\Default\\Human.fbx|$Mesh\\$Animations\\$Right Turn" );
		...
		public void ItemDrop( IGameFrameworkItem item, Transform newTransform = null )
		{
			var item2 = (ObjectInSpace)item;
		...
		void RotateWeaponIfCollided( Weapon weapon, TransformOffset offset, Degree rotationOffsetVertical )
		{
			...
			////mesh length + offset
			var meshLength = mesh.Result.SpaceBounds.CalculatedBoundingBox.Maximum.X;// * 1.5;// + 0.1;
			if( meshLength <= 0 )
				return;
			...
			{
				if( mainBody != null && resultItem.Body == mainBody )
					continue;
				//what else to skip
				...
				if( item != null )
				{
					...
					if( obj != null )
					{
						...
						if( offset != null )
						{
							...
							if( weapon != null )
							{
								var rotationOffet = CurrentTurnToDirection.Vertical + weapon.RotationOffsetWhenAttached.Value.InRadians();

								offset.PositionOffset = weapon.PositionOffsetWhenAttached;
			...
			if( item != null )
			{
				...
				if( obj != null )
				{
					...
					if( offset != null )
					{
						...
						if( weapon != null )
						{
							var positionOffset = weapon.PositionOffsetWhenAttachedFirstPerson.Value;
							var rotationOffset = weapon.RotationOffsetWhenAttachedFirstPerson.Value;
