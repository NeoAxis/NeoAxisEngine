...
namespace NeoAxis
{
	class ScriptCompilerImpl : ScriptCompiler
	{
		//!!!!can work when false?
		...
		public override void SettingsAddReferences( List<string> references )
		{
			Settings = Settings.AddReferences( references );
		}
		...
		public override Assembly CompileCode( string scriptText, string writeToDllOptional )
		{
		...
		public override string ScriptCodeGenerator_GenerateWrappedScript( IEnumerable<string> methods, IEnumerable<string> usingNamespaces, string inheritFrom )
		{
			return ScriptCodeGenerator.GenerateWrappedScript( methods, usingNamespaces, inheritFrom );
		}

		public override void ScriptCodeGenerator_CheckForSyntaxErrors( string code )
		{
			ScriptCodeGenerator.CheckForSyntaxErrors( code );
		}

		public override object/*Document*/  ScriptCodeGenerator_AddMethodToClass( object/*Document*/  document, object/*MethodDeclarationSyntax*/ method )
		{
			return ScriptCodeGenerator.AddMethodToClass( (Document)document, (MethodDeclarationSyntax)method );
		}

		public override object/*MethodDeclarationSyntax*/  ScriptCodeGenerator_GenerateMethodFromReflection( string methodName, ParameterInfo[] parameters )
		{
			return ScriptCodeGenerator.GenerateMethodFromReflection( methodName, parameters );
		}
	}
}