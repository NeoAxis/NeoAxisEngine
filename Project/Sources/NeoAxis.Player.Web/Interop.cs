...
internal static partial class Interop
{
	...
	[JSExport]
	public static void OnKeyDown( int code, string character, int modifiers, bool repeat )
	{
		Engine.inputEventQueue.Enqueue( new Engine.KeyEventItem()
		{
			Code = (EKeys)code,
			Type = repeat ? Engine.KeyEventType.Repeat : Engine.KeyEventType.Down
		} );
	...
	[JSExport]
	public static void OnKeyUp( int code, int modifiers )
	{
		Engine.inputEventQueue.Enqueue( new Engine.KeyEventItem()
		{
			Code = (EKeys)code,
			Type = Engine.KeyEventType.Up
		} );
	}
