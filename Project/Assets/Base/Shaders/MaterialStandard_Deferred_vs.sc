...
void main()
{
	...
	#define CODE_BODY_TEXTURE2D(_sampler, _uv) texture2DBias(_sampler, _uv, u_mipMap)
	VERTEX_CODE_BODY
	...
	v_worldNormal = normalize(mul(worldMatrix3, normalLocal));
