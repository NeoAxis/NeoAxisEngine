...
namespace BrightIdeasSoftware {
    ...
    public class BaseRenderer : AbstractRenderer {
        public const TextFormatFlags NormalTextFormatFlags = TextFormatFlags.NoPrefix |
        ...
        /// </summary>
        [Browsable(false)]
        public virtual HorizontalAlignment CellHorizontalAlignment
        {
        ...
        public virtual Color GetForegroundColor() {
            ...
            if( this.SubItem == null || this.ListItem.UseItemStyleForSubItems )
            {
                if( this.ListItem.ShowDisabled || !ListView.Enabled )
        ...
        {
            //!!!!betauser
            if( this.ListView.Focused && this.ListItem.ShowDisabled )
                return Color.FromArgb( 128, 128, 128 );
        ...
        protected virtual void DrawBackground(Graphics g, Rectangle r) {
            ...
            using (Brush brush = new SolidBrush(backgroundColor)) {
                //!!!! BUG: the background is not completely erased.  (tested at height=32)
        ...
        protected bool ColumnIsPrimary {
