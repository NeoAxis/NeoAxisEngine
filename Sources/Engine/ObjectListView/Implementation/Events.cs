...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView
    {
        ...
        public event EventHandler<Rectangle> OnBoundsChanging;
        ...
        {
            if (this.OnBoundsChanging != null)
                this.OnBoundsChanging(this, new Rectangle(x, y, width, height));
        ...
        protected override void OnEnabledChanged(EventArgs e)
        {
            ...
            BackColor = Enabled ? SystemColors.Window : Color.White;
        }
