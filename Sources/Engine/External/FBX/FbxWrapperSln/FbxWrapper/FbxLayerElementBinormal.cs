...
public class FbxLayerElementBinormal : FbxLayerElementTemplateFbxVector4 {
  ...
  internal FbxLayerElementBinormal(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FbxWrapperNativePINVOKE.FbxLayerElementBinormal_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public static FbxLayerElementBinormal Create(FbxLayerContainer pOwner, string pName) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxLayerElementBinormal_Create(FbxLayerContainer.getCPtr(pOwner), pName);
