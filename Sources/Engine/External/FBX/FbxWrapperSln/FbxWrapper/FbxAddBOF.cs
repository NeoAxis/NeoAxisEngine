...
public class FbxAddBOF : FbxBindingOperator.Function {
  ...
  internal FbxAddBOF(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FbxWrapperNativePINVOKE.FbxAddBOF_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          FbxWrapperNativePINVOKE.delete_FbxAddBOF(swigCPtr);
        }
  ...
  public static string FunctionName {
    set {
      FbxWrapperNativePINVOKE.FbxAddBOF_FunctionName_set(value);
    } 
    get {
      string ret = FbxWrapperNativePINVOKE.FbxAddBOF_FunctionName_get();
      return ret;
    } 
  }
  ...
  public FbxAddBOF() : this(FbxWrapperNativePINVOKE.new_FbxAddBOF(), true) {
  }
