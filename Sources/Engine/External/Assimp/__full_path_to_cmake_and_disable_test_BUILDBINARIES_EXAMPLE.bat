...
:: "C:\Program Files\CMake\bin\cmake" . -G "%GENERATOR%" -A Win32 -S %SOURCE_DIR% -B %BINARIES_DIR%
:: "C:\Program Files\CMake\bin\cmake" --build %BINARIES_DIR% --config debug
:: "C:\Program Files\CMake\bin\cmake" --build %BINARIES_DIR% --config release

SET BINARIES_DIR="./build/x64"
"C:\Program Files\CMake\bin\cmake" . -G "%GENERATOR%" -A x64 -S %SOURCE_DIR% -B %BINARIES_DIR% -DASSIMP_BUILD_TESTS=off
::"C:\Program Files\CMake\bin\cmake" . -G "%GENERATOR%" -A x64 -S %SOURCE_DIR% -B %BINARIES_DIR%
:: "C:\Program Files\CMake\bin\cmake" --build %BINARIES_DIR% --config debug
:: "C:\Program Files\CMake\bin\cmake" --build %BINARIES_DIR% --config release
