...
//betauser
vorbis_comment *vorbis_comment_create()
{
	return (vorbis_comment *)_ogg_malloc(sizeof(vorbis_comment));
}

//betauser
int vorbis_comment_destroy(vorbis_comment *obj)
{
	_ogg_free(obj);
	return 0;
}
...
//betauser
vorbis_info *vorbis_info_create()
{
	return (vorbis_info *)_ogg_malloc(sizeof(vorbis_info));
}

//betauser
int vorbis_info_destroy(vorbis_info *obj)
{
	_ogg_free(obj);
	return 0;
}
