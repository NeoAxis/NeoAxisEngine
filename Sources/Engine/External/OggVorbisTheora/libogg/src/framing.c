...
//!!!!betauser. from os_types.h
#if defined(ANDROID)
void* _ogg_calloc2(size_t num, size_t size, char* fileName, int line)
{
...
//betauser
ogg_stream_state *ogg_stream_create()
{
	return (ogg_stream_state *)_ogg_malloc(sizeof(ogg_stream_state));
}
...
//betauser
extern ogg_page *ogg_page_create()
{
	return (ogg_page *)_ogg_calloc(1, sizeof(ogg_page));
}

//betauser
extern int ogg_page_destroy( ogg_page *og )
{
	_ogg_free(og);
	return 0;
}
...
{
	return (ogg_sync_state *)_ogg_malloc(sizeof(ogg_sync_state));
}
...
{
	return (ogg_packet *)_ogg_calloc(1, sizeof(ogg_packet));
}

//betauser
int ogg_packet_destroy( ogg_packet *op )
{
	_ogg_free(op);
	return 0;
}
