...
//betauser
extern theora_info *theora_info_create();
extern int theora_info_destroy( theora_info *c );
extern ogg_uint32_t theora_info_get_width( theora_info *c );
extern ogg_uint32_t theora_info_get_height( theora_info *c );
extern ogg_uint32_t theora_info_get_fps_numerator( theora_info *c );
extern ogg_uint32_t theora_info_get_fps_denominator( theora_info *c );
...
//betauser
extern theora_state *theora_create();
extern int theora_destroy( theora_state *t );
extern ogg_int64_t theora_get_granulepos( theora_state *t );
...
//betauser
extern theora_comment *theora_comment_create();
extern int theora_comment_destroy( theora_comment *tc );
...
//betauser
extern yuv_buffer *theora_yuv_buffer_create();
extern int theora_yuv_buffer_destroy( yuv_buffer *b );
extern int theora_yuv_buffer_get_data( yuv_buffer *b,
	int *y_width, int *y_height, int *y_stride,
	int *uv_width, int *uv_height, int *uv_stride,
