...
//betauser
theora_info *theora_info_create()
{
	return (theora_info *)_ogg_malloc(sizeof(theora_info));
}

//betauser
int theora_info_destroy( theora_info *c )
{
	_ogg_free(c);
	return 0;
}
...
//betauser
ogg_uint32_t theora_info_get_width( theora_info *c )
{
	return c->width;
}

//betauser
ogg_uint32_t theora_info_get_height( theora_info *c )
{
	return c->height;
}

//betauser
ogg_uint32_t theora_info_get_fps_numerator( theora_info *c )
{
	return c->fps_numerator;
}

//betauser
ogg_uint32_t theora_info_get_fps_denominator( theora_info *c )
{
	return c->fps_denominator;
}
...
//betauser
theora_state *theora_create()
{
	return (theora_state *)_ogg_calloc(1, sizeof(theora_state));
}

//betauser
int theora_destroy( theora_state *t )
{
	_ogg_free(t);
	return 0;
}
...
//betauser
ogg_int64_t theora_get_granulepos( theora_state *t )
{
	return t->granulepos;
}
...
//betauser
theora_comment *theora_comment_create()
{
	return (theora_comment *)_ogg_malloc(sizeof(theora_comment));
}

//betauser
int theora_comment_destroy( theora_comment *tc )
{
	_ogg_free(tc);
	return 0;
}
