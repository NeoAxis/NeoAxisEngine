...
#define BGFX_FRAME_FLUSH                          UINT8_C(0x04) //!< Execute all rendering commands without presenting the backbuffer.
...
//!!!!betauser. fixed lines/fonts glitches.
#define DONT_USE_BIG_BUFFER_TEMP_HACK 1
