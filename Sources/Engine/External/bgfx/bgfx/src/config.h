...
//	#define BGFX_CONFIG_RENDERER_OPENGLES 1
//#endif
...
#	define BGFX_CONFIG_MAX_SHADERS 8192
...
#	define BGFX_CONFIG_MIN_RESOURCE_COMMAND_BUFFER_SIZE (64<<12)
...
#	define BGFX_CONFIG_MAX_TEXTURE_SAMPLERS_REAL 16
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_DRAW_CALLS ( (64<<12)-1)
//#	define BGFX_CONFIG_MAX_DRAW_CALLS ( (64<<10)-1)
...
//!!!!betauser
#	define BGFX_CONFIG_SORT_KEY_NUM_BITS_PROGRAM 15
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_VIEWS 1024
//#	define BGFX_CONFIG_MAX_VIEWS 256
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_VERTEX_LAYOUTS 512
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_INDEX_BUFFERS (4<<13)
//#	define BGFX_CONFIG_MAX_INDEX_BUFFERS (4<<10)
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_VERTEX_BUFFERS (4<<13)
//#	define BGFX_CONFIG_MAX_VERTEX_BUFFERS (4<<10)
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_DYNAMIC_INDEX_BUFFERS (4<<13)
//#	define BGFX_CONFIG_MAX_DYNAMIC_INDEX_BUFFERS (4<<10)
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_DYNAMIC_VERTEX_BUFFERS (4<<13)
//#	define BGFX_CONFIG_MAX_DYNAMIC_VERTEX_BUFFERS (4<<10)
...
//!!!!betauser
#	define BGFX_CONFIG_DYNAMIC_INDEX_BUFFER_SIZE (1<<27)
//#	define BGFX_CONFIG_DYNAMIC_INDEX_BUFFER_SIZE (1<<20)
...
//!!!!betauser
#	define BGFX_CONFIG_DYNAMIC_VERTEX_BUFFER_SIZE (3<<27)
//#	define BGFX_CONFIG_DYNAMIC_VERTEX_BUFFER_SIZE (3<<20)
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_SHADERS 32768
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_TEXTURES (4<<13)
//#	define BGFX_CONFIG_MAX_TEXTURES (4<<10)
...
//!!!!betauser
		...
		#define BGFX_CONFIG_MAX_TEXTURE_SAMPLERS 128
	#else
		#define BGFX_CONFIG_MAX_TEXTURE_SAMPLERS 16
	#endif
#endif // BGFX_CONFIG_MAX_TEXTURE_SAMPLERS
#ifndef BGFX_CONFIG_MAX_TEXTURE_SAMPLERS_REAL
#	define BGFX_CONFIG_MAX_TEXTURE_SAMPLERS_REAL 16
#endif // BGFX_CONFIG_MAX_TEXTURE_SAMPLERS_REAL
//#ifndef BGFX_CONFIG_MAX_TEXTURE_SAMPLERS
//#	define BGFX_CONFIG_MAX_TEXTURE_SAMPLERS 16
//#endif // BGFX_CONFIG_MAX_TEXTURE_SAMPLERS
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_FRAME_BUFFERS 1024
//#	define BGFX_CONFIG_MAX_FRAME_BUFFERS 128
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_UNIFORMS 2048
//#	define BGFX_CONFIG_MAX_UNIFORMS 512
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_OCCLUSION_QUERIES 1024
//#	define BGFX_CONFIG_MAX_OCCLUSION_QUERIES 256
...
//!!!!betauser
#	define BGFX_CONFIG_MIN_RESOURCE_COMMAND_BUFFER_SIZE (64<<17)
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_TRANSIENT_VERTEX_BUFFER_SIZE (6<<23)
//#	define BGFX_CONFIG_MAX_TRANSIENT_VERTEX_BUFFER_SIZE (6<<20)
...
//!!!!betauser
#	define BGFX_CONFIG_MAX_TRANSIENT_INDEX_BUFFER_SIZE (2<<21)
//#	define BGFX_CONFIG_MAX_TRANSIENT_INDEX_BUFFER_SIZE (2<<20)
