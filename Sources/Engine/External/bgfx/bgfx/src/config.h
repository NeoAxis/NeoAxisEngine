...
#	define BGFX_CONFIG_MAX_VERTEX_DECLS 128
...
#	define BGFX_CONFIG_MAX_COMMAND_BUFFER_SIZE (64<<12)
...
//!!!!betauser
#	define BGFX_CONFIG_DYNAMIC_INDEX_BUFFER_SIZE (1<<24)
//#	define BGFX_CONFIG_DYNAMIC_INDEX_BUFFER_SIZE (1<<20)
#endif // BGFX_CONFIG_DYNAMIC_INDEX_BUFFER_SIZE

#ifndef BGFX_CONFIG_DYNAMIC_VERTEX_BUFFER_SIZE
//!!!!betauser
#	define BGFX_CONFIG_DYNAMIC_VERTEX_BUFFER_SIZE (3<<24)
//#	define BGFX_CONFIG_DYNAMIC_VERTEX_BUFFER_SIZE (3<<20)
...
//!!!!betauser
#	define BGFX_CONFIG_MIN_RESOURCE_COMMAND_BUFFER_SIZE (64<<15)
