...
namespace bx
{
	...
	{
		const simd32_f32_ref_t result = { _x };
	...
	{
		const simd32_f32_ref_t result = { _a };
		return bitCast<simd32_t>(result);
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_add(simd32_t _a, simd32_t _b)
	{
		...
		const simd32_f32_ref_t result = { a.f32 + b.f32 };
		return bitCast<simd32_t>(result);
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_madd(simd32_t _a, simd32_t _b, simd32_t _c)
	{
		...
		const simd32_f32_ref_t result = { a.f32 * b.f32 + c.f32 };
		return bitCast<simd32_t>(result);
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_nmsub(simd32_t _a, simd32_t _b, simd32_t _c)
	{
		...
		const simd32_f32_ref_t b = bitCast<simd32_f32_ref_t>(_b);
		const simd32_f32_ref_t c = bitCast<simd32_f32_ref_t>(_c);
		const simd32_f32_ref_t result = { c.f32 - a.f32 * b.f32 };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { -a.f32 };
		return bitCast<simd32_t>(result);
	}

	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_abs(simd32_t _a)
	{
		return { _a.u32 & (kFloatExponentMask | kFloatMantissaMask) };
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_min(simd32_t _a, simd32_t _b)
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t b = bitCast<simd32_f32_ref_t>(_b);
		const simd32_f32_ref_t result = { a.f32 < b.f32 ? a.f32 : b.f32 };
		return bitCast<simd32_t>(result);
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_lerp(simd32_t _a, simd32_t _b, simd32_t _s)
	{
		...
		const simd32_f32_ref_t result = { a.f32 + (b.f32 - a.f32) * s.f32 };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { 1.0f / a.f32 };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { sqrt(a.f32) };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { 1.0f / sqrt(a.f32) };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { round(a.f32) };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { ceil(a.f32) };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t result = { floor(a.f32) };
		return bitCast<simd32_t>(result);
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_f32_cmpeq(simd32_t _a, simd32_t _b)
	{
		const simd32_f32_ref_t a = bitCast<simd32_f32_ref_t>(_a);
		const simd32_f32_ref_t b = bitCast<simd32_f32_ref_t>(_b);
		return { a.f32 == b.f32 ? UINT32_MAX : 0 };
	}
	...
	{
		return { _a.u32 < _b.u32 ? _a.u32 : _b.u32 };
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_i32_add(simd32_t _a, simd32_t _b)
	{
		...
		const simd32_i32_ref_t result = { a.i32 + b.i32 };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_i32_ref_t a = bitCast<simd32_i32_ref_t>(_a);
		const simd32_i32_ref_t result = { -a.i32 };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_i32_ref_t a = bitCast<simd32_i32_ref_t>(_a);
		const simd32_i32_ref_t result = { a.i32 < 0 ? -a.i32 : a.i32 };
		return bitCast<simd32_t>(result);
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_i32_min(simd32_t _a, simd32_t _b)
	{
		const simd32_i32_ref_t a = bitCast<simd32_i32_ref_t>(_a);
		const simd32_i32_ref_t b = bitCast<simd32_i32_ref_t>(_b);
		const simd32_i32_ref_t result = { a.i32 < b.i32 ? a.i32 : b.i32 };
		return bitCast<simd32_t>(result);
	}
	...
	{
		return { uint32_t(uint16_t(int16_t(_a.u32) + int16_t(_b.u32)))
	...
	{
		return { uint32_t(int16_t(_a.u32) == int16_t(_b.u32) ? uint16_t(0xffff) : uint16_t(0))
	...
	{
		return { uint32_t(uint16_t(uint16_t(_a.u32) << _count))
	...
	{
		return { uint32_t(uint8_t(int8_t(_a.u32      ) + int8_t(_b.u32      ) ) )
	...
	{
		const simd32_i32_ref_t a = bitCast<simd32_i32_ref_t>(_a);
		const simd32_i32_ref_t result = { a.i32 >> int32_t(_count.u32 & 31u) };
		return bitCast<simd32_t>(result);
	}

	inline BX_CONSTEXPR_FUNC simd32_t simd32_selb(simd32_t _mask, simd32_t _a, simd32_t _b)
	{
		return { (_a.u32 & _mask.u32) | (_b.u32 & ~_mask.u32) };
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_sels(simd32_t _test, simd32_t _a, simd32_t _b)
	{
		...
		return { (_a.u32 & mask) | (_b.u32 & ~mask) };
	}
	...
	{
		return { (_a.u32 << _count) | (_a.u32 >> (32 - _count)) };
	}
	...
	inline BX_CONSTEXPR_FUNC simd32_t simd32_u32_testpow2(simd32_t _a)
	{
		...
		return { uint32_t(-(int32_t( (_a.u32 ^ dec) >> 1 == dec) ) ) };
	}
	...
	{
		return { _a.u32 * (_b.u32 / simd32_u32_gcd(_a, _b).u32) };
	}
	...
	{
		const simd32_f32_ref_t a      = bitCast<simd32_f32_ref_t>(_a);
		const simd32_i32_ref_t result = { int32_t(a.f32) };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_f32_ref_t a      = bitCast<simd32_f32_ref_t>(_a);
		const simd32_i32_ref_t result = { int32_t(round(a.f32) ) };
		return bitCast<simd32_t>(result);
	}
	...
	{
		const simd32_i32_ref_t a      = bitCast<simd32_i32_ref_t>(_a);
		const simd32_f32_ref_t result = { float(a.i32) };
		return bitCast<simd32_t>(result);
	}
