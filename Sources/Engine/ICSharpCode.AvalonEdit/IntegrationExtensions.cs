...
namespace ICSharpCode.AvalonEdit
{
	...
	public static class IntegrationExtensions
	{
		...
		#region Specific window - IntPtr/Form

		/// <summary>
		/// Sets the owner window of a specific window via the form.
		/// </summary>
		/// <param name="window"></param>
		/// <param name="owner"></param>
		public static void SetOwnerWindow(this Window window, Form owner)
		{
			// Set owner without forcing
			SetOwnerWindow(window, owner.Handle, false, false);
		}
		...
		public static bool IsActive(this Form form)
		{
			if (form == null)
				return false;
			return form == System.Windows.Forms.Form.ActiveForm;
		}
