...
//#include "OgreSkeletonManager_Wrapper.h"
//#include "OgrePose_Wrapper.h"
...
EXPORT void OgreNativeWrapper_CheckNativeBridge( int parameterTypeTextureCubeValue )
{
	...
	//if(sizeof(GpuProgramParameters::AutoConstantType) != 4)
	//	Fatal("OgreNativeWrapper: sizeof(GpuProgramParameters::AutoConstantType) != 4");
	...
	//if(sizeof(ProjectionType) != 4)
	//	Fatal("OgreNativeWrapper: sizeof(ProjectionType) != 4");

	//if(sizeof(Light::LightTypes) != 4)
	//	Fatal("OgreNativeWrapper: sizeof(Light::LightTypes) != 4");

	if(sizeof(Capabilities) != 4)
		Fatal("OgreNativeWrapper: sizeof(Capabilities) != 4");

	//if(sizeof(TextureUnitState::TextureAddressingMode) != 4)
	//	Fatal("OgreNativeWrapper: sizeof(TextureUnitState::TextureAddressingMode) != 4");

	//if(sizeof(TextureUnitState::ContentType) != 4)
	//	Fatal("OgreNativeWrapper: sizeof(TextureUnitState::ContentType) != 4");

	//if(sizeof(SkeletonAnimationBlendMode) != 4)
	//	Fatal("OgreNativeWrapper: sizeof(SkeletonAnimationBlendMode) != 4");
}
