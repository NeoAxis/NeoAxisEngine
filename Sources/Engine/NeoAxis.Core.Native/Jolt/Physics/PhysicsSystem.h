...
public:
	...
	//!!!!betauser
	/// Get a list of all constraints without lock
	const Constraints&			GetConstraintsNoLock() const { return mConstraintManager.GetConstraintsNoLock(); }
	...
	{
		return mBodyManager.GetBody(inID);
	}
