...
void JobSystemThreadPool::QueueJobs(Job **inJobs, uint inNumJobs)
{
	...
	static void SetThreadName(const char* inName)
	{
		...
		//!!!!betauser UWP
		static SetThreadDescriptionFunc SetThreadDescription = NULL;// reinterpret_cast<SetThreadDescriptionFunc>(GetProcAddress(GetModuleHandleW(L"Kernel32.dll"), "SetThreadDescription"));
