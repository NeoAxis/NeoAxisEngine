...
namespace ComponentFactory.Krypton.Toolkit
{
...

    {
        ...
        private class InternalComboBox : ComboBox, IContentValues
        {
            ...
            {
                //!!!! modern sizing logic dont require custom ItemHeight calc
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    catch (ArgumentException)
                                    {
                                        ...
                                        AccurateText.DrawString(g, Text, _kryptonComboBox.GetComboBoxTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled),
                                            new Rectangle(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top), ForeColor, stringFormat);
                                    }
                                }
