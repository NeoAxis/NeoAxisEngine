...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public class ViewDrawForm : ViewDrawDocker
    {
		...
		/// 
		/// </summary>
		/// <param name="paletteBack"></param>
		/// <param name="paletteBorder"></param>
		/// <param name="paletteMetric"></param>
		public ViewDrawForm(IPaletteBack paletteBack,
							  IPaletteBorder paletteBorder,
							  IPaletteMetric paletteMetric)
			: base(paletteBack, paletteBorder, paletteMetric, PaletteMetricBool.None, 
				  PaletteMetricPadding.HeaderButtonPaddingCustom1, VisualOrientation.Top)
		{
			// Create a status strip we can position for rendering
			_renderStrip = new StatusStrip();
		}
            ...
            if (_statusStrip != null)
            {
                ...
                if (_statusStrip.RenderMode == ToolStripRenderMode.ManagerRenderMode)
                {
                    ...
                    if (form != null)
                    {
                        ...
                        Padding borders = form.WindowMargin;
