...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public class ViewDrawTrackBar : ViewDrawPanel
    {
        ...
        private static readonly Size _positionSizeSmallH = DpiHelper.Default.ScaleValue(new Size(11, 16));
        private static readonly Size _positionSizeSmallV = DpiHelper.Default.ScaleValue(new Size(16, 11));
        private static readonly Size _positionSizeMediumH = DpiHelper.Default.ScaleValue(new Size(13, 21));
        private static readonly Size _positionSizeMediumV = DpiHelper.Default.ScaleValue(new Size(21, 13));
        private static readonly Size _positionSizeLargeH = DpiHelper.Default.ScaleValue(new Size(17, 27));
        private static readonly Size _positionSizeLargeV = DpiHelper.Default.ScaleValue(new Size(27, 17));
        private static readonly Size _trackSizeSmall = DpiHelper.Default.ScaleValue(new Size(2, 2));
        private static readonly Size _trackSizeSmallV = DpiHelper.Default.ScaleValue(new Size(6, 6));
        private static readonly Size _trackSizeMedium = DpiHelper.Default.ScaleValue(new Size(4, 4));
        private static readonly Size _trackSizeMediumV = DpiHelper.Default.ScaleValue(new Size(11, 11));
        private static readonly Size _trackSizeLarge = DpiHelper.Default.ScaleValue(new Size(5, 5));
        private static readonly Size _trackSizeLargeV = DpiHelper.Default.ScaleValue(new Size(16, 16));
        private static readonly Size _tickSizeSmall = DpiHelper.Default.ScaleValue(new Size(5, 5));
        private static readonly Size _tickSizeMedium = DpiHelper.Default.ScaleValue(new Size(6, 6));
        private static readonly Size _tickSizeLarge = DpiHelper.Default.ScaleValue(new Size(7, 7));
        ...
        private bool _testForFocusCues = true;
        ...
        public override void RenderBefore(RenderContext context)
        {
            ...
            //!!!!: We do not use a krypton system of states and palettes to determine whether to draw a focus.
            // we just use Control.Focused and this is not very correct.
            // alternatively, we can use ViewDrawContent.
            DrawFocus(context, ClientRectangle, context.Control.Focused, allowFocusRect);
        }
        #endregion
        ...
        private void DrawFocus(RenderContext context,
                         Rectangle displayRect,
                         bool drawFocus,
                         bool allowFocusRect)
        {
            // Do we need to show this content has the focus?
            if (allowFocusRect && drawFocus)
            {
