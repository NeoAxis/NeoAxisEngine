...
namespace ComponentFactory.Krypton.Ribbon
{
                                         ...
                                         IRibbonViewGroupSize
    {
        ...
        private static readonly int MINIMUM_GROUP_WIDTH = DpiHelper.Default.ScaleValue(32);
        private static readonly int NORMAL_BORDER_TOPLEFT2007 = DpiHelper.Default.ScaleValue(2);
        private static readonly int NORMAL_BORDER_RIGHT2007 = DpiHelper.Default.ScaleValue(4);
        private static readonly int NORMAL_BORDER_TOP2010 = DpiHelper.Default.ScaleValue(3);
        private static readonly int NORMAL_BORDER_LEFT2010 = DpiHelper.Default.ScaleValue(3);
        private static readonly int NORMAL_BORDER_RIGHT2010 = DpiHelper.Default.ScaleValue(6);
        private static readonly int TOTAL_LEFT_RIGHT_BORDERS_2007 = DpiHelper.Default.ScaleValue(7);
        private static readonly int TOTAL_LEFT_RIGHT_BORDERS_2010 = DpiHelper.Default.ScaleValue(10);
        private static readonly int VERT_OFFSET_2007 = 0;
        private static readonly int VERT_OFFSET_2010 = DpiHelper.Default.ScaleValue(2);
        private static readonly Padding COLLAPSED_PADDING = DpiHelper.Default.ScaleValue(new Padding(2));
        private static readonly Padding COLLAPSED_IMAGE_PADDING_2007 = DpiHelper.Default.ScaleValue(new Padding(3, 3, 3, 4));
        private static readonly Padding COLLAPSED_IMAGE_PADDING_2010 = DpiHelper.Default.ScaleValue(new Padding(3, 1, 5, 5));
        #endregion
