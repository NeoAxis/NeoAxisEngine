...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    internal class ViewDrawRibbonQATExtraButton : ViewLeaf
    {
        ...
        private static readonly Size _viewSize = new Size(
            DpiHelper.Default.ScaleValue(13), DpiHelper.Default.ScaleValue(22));
        private static readonly Size _imageSize = new Size(5, 6);
        #endregion

        #region Instance Fields
        protected KryptonRibbon _ribbon;
