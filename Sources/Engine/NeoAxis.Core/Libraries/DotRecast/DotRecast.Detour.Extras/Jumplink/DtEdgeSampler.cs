...
namespace Internal.DotRecast.Detour.Extras.Jumplink
{
    ...
    {
        public readonly DtGroundSegment start = new DtGroundSegment();
        public readonly List<DtGroundSegment> end = new List<DtGroundSegment>();
        ...
        public DtEdgeSampler(DtJumpEdge edge, IDtTrajectory trajectory)
        {
