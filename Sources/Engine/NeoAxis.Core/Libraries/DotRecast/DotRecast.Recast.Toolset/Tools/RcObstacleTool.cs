...
namespace Internal.DotRecast.Recast.Toolset.Tools
{
	public class RcObstacleTool : IRcToolable
	{
		...
		//!!!!betauser
		public IRcInputGeomProvider _geom;
		public RcNavMeshBuildSettings _setting;
		public int _tileCountW;
		public int _tileCountH;
		...
		public DtTileCache CreateTileCache( IRcInputGeomProvider geom, RcNavMeshBuildSettings setting, int tw, int th, RcByteOrder order, bool cCompatibility )
		{
			...
			//!!!!betauser
			navMeshParams.maxTiles = 10000; //256; // ..
			navMeshParams.maxPolys = 100000;// 16384;
