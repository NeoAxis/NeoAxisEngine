...
namespace Internal.ComponentFactory.Krypton.Navigator
{
    ...
    public class NavigatorBar : Storage
    {
        ...
        private static readonly int _defaultBarMinimumHeight = DpiHelper.Default.ScaleValue(21);
        private const int _defaultBarFirstItemInset = 0;
        private const int _defaultBarLastItemInset = 0;
        private static readonly Size _defaultItemMinimumSize = DpiHelper.Default.ScaleValue(new Size(20, 20));
        private static readonly Size _defaultItemMaximumSize = DpiHelper.Default.ScaleValue(new Size(4000, 4000));
        #endregion
