...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
										...
										IPalette
    {
		...
		/// </summary>
		/// <returns></returns>
		public abstract InheritBool GetAllowOnePixelBorder();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public abstract Padding GetFormMargin();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public abstract int GetFormCaptionHeight();
        #endregion
        ...
        public virtual float BaseFontSize
        {
            get
            {
                if (!_baseFontSize.HasValue)
                    return SystemFontsOverride.BaseFont.SizeInPoints;
                else
        ...
        protected virtual Padding InputControlPadding
        {
            get
            {
                if (!_inputControlPadding.HasValue)
                {
                    ...
                    int yDiff = Math.Max(0, ss.Height - sn.Height /*!!!! - 2 */ - 0);
