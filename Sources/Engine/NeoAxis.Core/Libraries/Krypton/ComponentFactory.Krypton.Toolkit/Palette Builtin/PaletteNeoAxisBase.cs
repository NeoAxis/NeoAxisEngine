...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public abstract class PaletteNeoAxisBase : PaletteBase
    {
        ...
        private static readonly int     _formCaptionHeight = DpiHelper.Default.ScaleValue(31);
        ...
        private static readonly Padding _contentPaddingSuperTip = new Padding(1);
        ...
        private static readonly Padding _contentPaddingContextMenuImage = new Padding(3, 1, 1, 1);
        private static readonly Padding _contentPaddingContextMenuItemText = new Padding(9, 3, 7, 2);
		...
		private static readonly Padding _metricPaddingHeaderCustom = new Padding(8, 4, 4, 0); // for form header.
        private static readonly Padding _metricPaddingHeader = DpiHelper.Default.ScaleValue(new Padding(0, 3, 1, 3)); 
        private static readonly Padding _metricPaddingHeaderFormButton = new Padding(0);
        ...
        private static readonly Image _buttonSpecRibbonMinimize = Properties.Resources.RibbonUp2016;
        private static readonly Image _buttonSpecRibbonExpand = Properties.Resources.RibbonDown2016;
        private static readonly Bitmap _contextMenuChecked = Properties.Resources.Office2016Checked_16;
        private static readonly Bitmap _contextMenuIndeterminate = Properties.Resources.Office2016Indeterminate_16;
        ...
        protected /*private static readonly*/ Color _disabledText = Color.FromArgb(167, 167, 167);
        protected /*private static readonly*/ Color _disabledBack = Color.FromArgb(235, 235, 235);
        ...
        protected/* private static readonly*/ Color _toolTipBack1 = Color.FromArgb(255, 255, 255);
        protected/* private static readonly*/ Color _toolTipBorder = Color.FromArgb(118, 118, 118);
        protected/* private static readonly*/ Color _toolTipText = Color.FromArgb(76, 76, 76);
        protected /*private static readonly*/ Color _contextMenuBack = Color.White;
        protected /*private static readonly*/ Color _contextMenuBorder = Color.FromArgb(134, 134, 134);
        protected /*private static readonly*/ Color _contextMenuHeadingBorder = Color.FromArgb(224, 224, 224);
        //private static readonly Color _contextMenuImageBackChecked = Color.FromArgb(205, 230, 247);
        protected /*private static readonly*/ Color _contextMenuImageBorderChecked = Color.FromArgb(51, 153, 255);
        ...
        private static readonly Color _formCloseTracking1 = Color.FromArgb(231, 17, 34);
        private static readonly Color _formCloseTracking2 = Color.Empty;
        private static readonly Color _formClosePressed1 = Color.FromArgb(240, 111, 121);
        private static readonly Color _formClosePressed2 = Color.Empty;
        private static readonly Color _formCloseChecked1 = Color.Empty;
        private static readonly Color _formCloseChecked2 = Color.Empty;
        private static readonly Color _formCloseCheckedTracking1 = Color.Empty;
        private static readonly Color _formCloseCheckedTracking2 = Color.Empty;
        ...
        protected enum ButtonBorderColors
        {
            Disabled,
            Tracking,
            Tracking2,
        ...
        protected enum ButtonBackColors
        {
            Disabled,
            Disabled2,
            Tracking,
        ...
        protected /*private static readonly*/ Color[] _standaloneButtonBorderColors = new Color[]
        {
            Color.FromArgb(180, 180, 180),  // Button, Disabled, Border
            Color.FromArgb(95, 168, 226),   // Button, Tracking, Border 1
            Color.Empty,				    // Button, Tracking, Border 2
            Color.FromArgb(0, 120, 215),    // Button, Pressed, Border 1
            Color.Empty,				    // Button, Pressed, Border 2
            Color.FromArgb(0, 120, 215),    // Button, Checked, Border 1
            Color.Empty,				    // Button, Checked, Border 2
        };

        protected /*private static readonly*/ Color[] _standaloneButtonBackColors = new Color[]
        {
            ...
            Color.FromArgb(204, 228, 247), // Button, Pressed, Back 1
            Color.Empty,				   // Button, Pressed, Back 2
            Color.FromArgb(204, 228, 247), // Button, Checked, Back 1
            Color.Empty,			       // Button, Checked, Back 2
            Color.FromArgb(204, 228, 247), // Button, Checked Tracking, Back 1
            Color.Empty					   // Button, Checked Tracking, Back 2
        };

        protected /*private static readonly*/ Color[] _buttonBorderColors = new Color[]
        {
            Color.FromArgb(180, 180, 180),  // Button, Disabled, Border
            Color.FromArgb(197, 197, 197),  // Button, Tracking, Border 1
            Color.Empty,				    // Button, Tracking, Border 2
            Color.FromArgb(150, 150, 150),  // Button, Pressed, Border 1
            Color.Empty,				    // Button, Pressed, Border 2
            Color.FromArgb(197, 197, 197),  // Button, Checked, Border 1
            Color.Empty,				    // Button, Checked, Border 2
        };

        protected /*private static readonly*/ Color[] _buttonBackColors = new Color[]
        {
            Color.FromArgb(250, 250, 250), // Button, Disabled, Back 1
            Color.Empty,				   // Button, Disabled, Back 2
            Color.FromArgb(197, 197, 197), // Button, Tracking, Back 1
            Color.Empty,				   // Button, Tracking, Back 2
            Color.FromArgb(174, 174, 174), // Button, Pressed, Back 1
            Color.Empty,				   // Button, Pressed, Back 2
            Color.FromArgb(197, 197, 197), // Button, Checked, Back 1
            Color.Empty,			       // Button, Checked, Back 2
            Color.FromArgb(197, 197, 197), // Button, Checked Tracking, Back 1
            Color.Empty					   // Button, Checked Tracking, Back 2
        };
        #endregion

        #region Instance Fields
        private KryptonColorTable2016 _table;
        protected /*private*/ Color[] _ribbonColors;
        ...
        static PaletteNeoAxisBase()
        {
            ...
            _contextMenuIndeterminate = (Bitmap)RenderStandard.GetImageForDispalyScale(Properties.Resources.Office2016Indeterminate_16,
                Properties.Resources.Office2016Indeterminate_24, 13);
        }
		...
		/// </summary>
		/// <returns></returns>
		public override InheritBool GetAllowOnePixelBorder()
		{
			return InheritBool.True;
		}

        public override Padding GetFormMargin()
        {
            return _formMargin;
        }

        public override int GetFormCaptionHeight()
        {
            return _formCaptionHeight;
        }
        #endregion
		...
		public override PaletteGraphicsHint GetBackGraphicsHint(PaletteBackStyle style, PaletteState state)
		{
            ...
            switch (style)
            {
				...
				case PaletteBackStyle.PanelRibbonActive:
		...
		public override Color GetBackColor1(PaletteBackStyle style, PaletteState state)
		{
			...
			switch (style)
			{
                ...
                case PaletteBackStyle.ContextMenuItemImage:
                    return Color.Red /* _contextMenuImageBackChecked*/;
                case PaletteBackStyle.ButtonForm:
                    switch (state)
                    {
                        case PaletteState.Disabled:
			...
			switch (style)
			{
                ...
                case PaletteBackStyle.HeaderCustom2:
                    if (state == PaletteState.Disabled)
                        ...
                        return _ribbonColors[(int)SchemeOfficeColors.HeaderPrimaryBack2];
                case PaletteBackStyle.HeaderDockInactive: // not used
                    if (state == PaletteState.Disabled)
                        return _disabledBack;
                    else
                        return _ribbonColors[(int)SchemeOfficeColors.HeaderDockInactiveBack2];
                case PaletteBackStyle.HeaderDockActive:   // not used
                    if (state == PaletteState.Disabled)
                        return _disabledBack;
                    else
                        return _buttonBackColors[7];
                ...
                case PaletteBackStyle.ControlToolTip:
                    return Color.Red; // not used  _ribbonColors[(int)SchemeOfficeColors.ToolTipBottom];
                case PaletteBackStyle.ContextMenuOuter:
                    return _contextMenuBack;
                case PaletteBackStyle.ContextMenuSeparator:
                case PaletteBackStyle.ContextMenuItemSplit:
		...
		public override Color GetBorderColor1(PaletteBorderStyle style, PaletteState state)
		{
			...
			switch (style)
			{
                ...
                //            throw new ArgumentOutOfRangeException("state");
                //    }
                case PaletteBorderStyle.ButtonCustom3: // Grid
                case PaletteBorderStyle.ButtonStandalone:
                    switch (state)
                    {
                        case PaletteState.Disabled:
		...
		public override PaletteRelativeAlign GetContentShortTextH(PaletteContentStyle style, PaletteState state)
		{
			...
			switch (style)
			{
                ...
                case PaletteContentStyle.ButtonInputControl:
                    return PaletteRelativeAlign.Center;
                case PaletteContentStyle.ButtonCustom3: //Grid
                    return PaletteRelativeAlign.Near;
                case PaletteContentStyle.ContextMenuItemShortcutText:
		...
		public override Padding GetMetricPadding(PaletteState state, PaletteMetricPadding metric)
		{
            switch (metric)
            {
                ...
                case PaletteMetricPadding.HeaderButtonPaddingForm:
                    return _metricPaddingHeaderFormButton;
                ...
                case PaletteMetricPadding.HeaderButtonPaddingCustom2:
                    return _metricPaddingHeaderCustom;
        ...
        public override PaletteRibbonColorStyle GetRibbonBackColorStyle(PaletteRibbonBackStyle style, PaletteState state)
        {
            switch(style)
            {
                ...
                case PaletteRibbonBackStyle.RibbonGroupCollapsedBorder:
                    switch (state)
                    {
                        ...
                        case PaletteState.ContextTracking:
                            return PaletteRibbonColorStyle.RibbonGroupNormalBorderSep; //PaletteRibbonColorStyle.RibbonGroupNormalBorderSepTrackingLight;
                        case PaletteState.Pressed:
                ...
                case PaletteRibbonBackStyle.RibbonGroupArea:
					return PaletteRibbonColorStyle.RibbonGroupAreaBorder2016;
        ...
        public override Color GetElementColor1(PaletteElement element, PaletteState state)
        {
            ...
            switch (element)
            {
                ...
                case PaletteElement.TrackBarTrack: //border
                    ...
                    {
                        case PaletteState.Disabled:
                            return ControlPaint.LightLight(_trackBarColors[1]);
                        default:
                ...
                case PaletteElement.TrackBarPosition:
                    ...
                    {
                        case PaletteState.Disabled:
                            return ControlPaint.LightLight(_ribbonColors[(int)SchemeOfficeColors.ButtonNormalBorder]);
                        case PaletteState.Normal:
                            return _ribbonColors[(int)SchemeOfficeColors.ButtonNormalBorder];
                        case PaletteState.Tracking:
                        case PaletteState.FocusOverride:
        ...
        public override Color GetElementColor2(PaletteElement element, PaletteState state)
        {
            ...
            switch (element)
            {
                ...
                case PaletteElement.TrackBarTrack:
                    ...
                    {
                        case PaletteState.Disabled:
                            return ControlPaint.LightLight(_trackBarColors[3]);
                        default:
        ...
        public virtual string BaseFontName
        {
            get
            {
                if (string.IsNullOrEmpty(_baseFontName))
                    return SystemFontsOverride.BaseFont.Name;
                else
        ...
        protected override void DefineFonts()
        {
            ...
            _headerFormFont = new Font(baseFontName, SystemFontsOverride.CaptionFont.SizeInPoints, FontStyle.Regular);
            ...
            _buttonFont = new Font(SystemFontsOverride.DefaultFont.Name, 
                SystemFontsOverride.DefaultFont.SizeInPoints, FontStyle.Regular);
            ...
            //!!!!test
            //_ribbonTabFont = new Font( baseFontName, baseFontSize - 1, FontStyle.Regular );
        ...
        public override KryptonColorTable ColorTable
        {
            ...
            {
                if (_table == null)
                    _table = new KryptonColorTable2016(_ribbonColors, this);
