...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
    ...
    public class KryptonPalettePanels : Storage
    {
		...
		private KryptonPalettePanel _panelRibbonActive;
                                      ...
                                      NeedPaintHandler needPaint)
        {
			...
			_panelRibbonActive = new KryptonPalettePanel(redirector, PaletteBackStyle.PanelRibbonActive, needPaint);
			...
			_panelRibbonActive.SetRedirector(redirectCommon);
        ...
        public void PopulateFromBase(KryptonPaletteCommon common)
        {
            ...
            common.StateCommon.BackStyle = PaletteBackStyle.PanelRibbonActive;
            _panelRibbonActive.PopulateFromBase();
		...
		#region PanelRibbonActive
		/// <summary>
		/// Gets access to the ribbon active panel appearance.
		/// </summary>
		[KryptonPersist]
		[Category("Visuals")]
		[Description("Overrides for defining ribbon active panel appearance.")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		public KryptonPalettePanel PanelRibbonActive
		{
			get { return _panelRibbonActive; }
		}

		private bool ShouldSerializePanelRibbonActive()
		{
			return !_panelRibbonActive.IsDefault;
		}
		#endregion
