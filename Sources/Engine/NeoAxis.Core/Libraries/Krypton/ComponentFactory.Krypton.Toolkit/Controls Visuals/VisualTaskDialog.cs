    ...
    public class VisualTaskDialog : KryptonForm
    {
        ...
        private Size UpdateMainTextSizing()
        {
            ...
            using (Graphics g = CreateGraphics())
            {
                ...
                messageMainSize.Width = (int)(messageMainSize.Width * DpiHelper.Default.DpiScaleFactor);
                messageMainSize.Height = (int)(messageMainSize.Height * DpiHelper.Default.DpiScaleFactor);
                messageContentSize.Width = (int)(messageContentSize.Width * DpiHelper.Default.DpiScaleFactor);
                messageContentSize.Height = (int)(messageContentSize.Height * DpiHelper.Default.DpiScaleFactor);
