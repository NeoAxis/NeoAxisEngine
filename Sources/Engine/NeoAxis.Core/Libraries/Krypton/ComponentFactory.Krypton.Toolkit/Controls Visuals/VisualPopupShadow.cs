...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
    ...
    //TODO: fix transparent. issue: shadow last path brightens the background

    /// <summary>
    /// Displays a shadow effect for a visual popup.
    /// </summary>
    public class VisualPopupShadow : Form, IVisualPopupShadow
    {
        ...
        public VisualPopupShadow()
        {
            ...
            if( KryptonDarkThemeUtility.DarkTheme )
                Opacity = 0.25f; //HARDCODED:
            else
                Opacity = 0.18f; //HARDCODED:
            //Opacity = 0.18f; //HARDCODED:
        }
