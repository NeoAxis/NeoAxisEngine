...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
                                              ...
                                              IKryptonDebug
    {
        ...
        ////!!!!betauser
        //[Browsable( false )]
        //public ToolStripRenderer OverrideToolStripRenderer { get; set; }
        ...
        {
            ////!!!!betauser
            //if( OverrideToolStripRenderer != null )
            //    return OverrideToolStripRenderer;
        ...
        protected override void ScaleControl(SizeF factor, BoundsSpecified specified)
        {
            ...
            // EXPERIMENTAL:
            // we need to nc repaint and relayout control after form perform scaling their children
            MarkLayoutDirty();
        }
        ...
        {
            //!!!!betauser, hack to fix KryptonBreadCrumb
            //if( this is KryptonBreadCrumb )
            //{
