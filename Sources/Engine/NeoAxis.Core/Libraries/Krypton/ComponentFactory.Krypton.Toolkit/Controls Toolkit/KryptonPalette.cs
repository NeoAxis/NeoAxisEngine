...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    [Designer("ComponentFactory.Krypton.Toolkit.KryptonPaletteDesigner, ComponentFactory.Krypton.Design, Version=125.0.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
  ...
  //      private InheritBool _allowFormChrome;
		//private InheritBool _allowOnePixelBorder;
        private Padding _formMargin;
        private int _formCaptionHeight;
        ...
        public KryptonPalette()
        {
			...
			//_allowOnePixelBorder = InheritBool.Inherit;
            _formMargin = Padding.Empty;
            _formCaptionHeight = -1;
		...
		//[KryptonPersist(false)]
		//[Category("Visuals")]
		//[Description("Should KryptonForm instances have 1px border.")]
		//[DefaultValue(typeof(InheritBool), "Inherit")]
		//public InheritBool AllowOnePixelBorder
		//{
		//	get { return _allowOnePixelBorder; }

		//	set
		//	{
		//		if (_allowOnePixelBorder != value)
		//		{
		//			_allowOnePixelBorder = value;
		//			OnAllowOnePixelBorderChanged(this, EventArgs.Empty);
		//		}
		//	}
		//}

		//private bool ShouldSerializeAllowOnePixelBorder()
		//{
		//	return (AllowOnePixelBorder != InheritBool.Inherit);
		//}
        ...
        [KryptonPersist(false)]
        [Category("Visuals")]
        [Description("FormMargin.")]
        [DefaultValue(typeof(Padding), "0,0,0,0")]
        public Padding FormMargin
        {
            get { return _formMargin; }
            set
            {
                if (_formMargin != value)
                {
                    _formMargin = value;
                    OnFormMarginChanged(this, EventArgs.Empty);
                }
            }
        }

        private bool ShouldSerializeFormMargin()
        {
            return _formMargin != Padding.Empty;
        }
        ...
        [KryptonPersist(false)]
        [Category("Visuals")]
        [Description("FormCaptionHeight.")]
        [DefaultValue(typeof(int), "-1")]
        public int FormCaptionHeight
        {
            get { return _formCaptionHeight; }
            set
            {
                if (_formCaptionHeight != value)
                {
                    _formCaptionHeight = value;
                    OnFormCaptionHeightChanged(this, EventArgs.Empty);
                }
            }
        }

        private bool ShouldSerializeFormCaptionHeight()
        {
            return _formCaptionHeight != -1;
        }
        #endregion
		...
		///// </summary>
		///// <returns></returns>
		//public InheritBool GetAllowOnePixelBorder()
		//{
		//	if (AllowOnePixelBorder == InheritBool.Inherit)
		//		return _basePalette.GetAllowOnePixelBorder();
		//	else
		//		return AllowOnePixelBorder;
		//}
        ...
        /// </summary>
        /// <returns></returns>
        public Padding GetFormMargin()
        {
            if (FormMargin == Padding.Empty)
                return _basePalette.GetFormMargin();
            else
                return FormMargin;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int GetFormCaptionHeight()
        {
            if (FormCaptionHeight == -1)
                return _basePalette.GetFormCaptionHeight(); 
            else
                return FormCaptionHeight;
        }
        #endregion
		...
		/// <param name="e"></param>
		protected virtual void OnAllowOnePixelBorderChanged(object sender, EventArgs e)
		{
			// Can only generate change events if not suspended
			if (_suspendCount == 0)
			{
				//if (AllowOnePixelBorderChanged != null)
				//	AllowOnePixelBorderChanged(this, e);
			}
		}
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void OnFormMarginChanged(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void OnFormCaptionHeightChanged(object sender, EventArgs e)
        {
   ...
   //         _allowFormChrome = _basePalette.GetAllowFormChrome();
			//_allowOnePixelBorder = _basePalette.GetAllowOnePixelBorder();
            _formMargin = _basePalette.GetFormMargin();
            _formCaptionHeight = _basePalette.GetFormCaptionHeight();
        ...
        private IPaletteBack GetPaletteBack(PaletteBackStyle style, PaletteState state)
        {
            ...
            switch (style)
            {
				...
				case PaletteBackStyle.PanelRibbonActive:
					return GetPalettePanel(PanelStyles.PanelRibbonActive, state);
