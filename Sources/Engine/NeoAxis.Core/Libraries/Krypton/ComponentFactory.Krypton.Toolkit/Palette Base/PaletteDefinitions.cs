...
namespace ComponentFactory.Krypton.Toolkit
{
	...
	public interface IPalette
	{
        ...
        ///// </summary>
        ///// <returns></returns>
        //InheritBool GetAllowOnePixelBorder();
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        Padding GetFormMargin();
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        int GetFormCaptionHeight();
        #endregion
    ...
    public interface IPaletteContent
    {
        ...
        /// <returns></returns>
        bool GetContentShortTextCompatiblePadding(PaletteState state);
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        bool GetContentLongTextCompatiblePadding(PaletteState state);
    ...
    public enum PaletteBackStyle
	{
		...
		/// <summary>
		/// Specifies a background style appropriate for an active ribbon.
		/// </summary>
		PanelRibbonActive,
    ...
    public enum PaletteRibbonColorStyle
    {
		...
		/// <summary>
		/// Specifies using colors to draw a groups area border, variantion 2016.
		/// </summary>
		RibbonGroupAreaBorder2016,
