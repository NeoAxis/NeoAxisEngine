...
namespace Internal.ComponentFactory.Krypton.Ribbon
{
                                       ...
                                       IContentValues
    {
        ...
        private static Padding _preferredBorder2007 = DpiHelper.Default.ScaleValue(new Padding(12, 3, 12, 1));
        private static Padding _preferredBorder2010 = DpiHelper.Default.ScaleValue(new Padding(8, 4, 8, 3));
        private static Padding _layoutBorder2007 = DpiHelper.Default.ScaleValue(new Padding(4, 3, 4, 1));
        private static Padding _layoutBorder2010 = DpiHelper.Default.ScaleValue(new Padding(1, 4, 0, 3));
                                 ...
                                 NeedPaintHandler needPaint)
        {
            ...
            Add(new ViewDrawContent(_contentProvider, this, VisualOrientation.Top, DWM.IsCompositionEnabled, false));
