...
namespace Internal.ComponentFactory.Krypton.Ribbon
{
    ...
    internal class ViewDrawRibbonQATBorder  : ViewComposite
    {
        ...
        private static readonly Padding _minibarBorderPaddingOverlap = new Padding(8, 2, 11, 2); // scale ?
        private static readonly Padding _minibarBorderPaddingNoOverlap = new Padding(17, 2, 11, 2); // scale ?
        ...
        private static readonly Padding _fullbarBorderPadding_2016 = DpiHelper.Default.ScaleValue(new Padding(2, 3, 2, 0));
        private static readonly Padding _noBorderPadding = new Padding(1, 0, 1, 0);
		private static readonly int QAT_BUTTON_WIDTH = DpiHelper.Default.ScaleValue(22);
        private static readonly int QAT_HEIGHT_MINI = DpiHelper.Default.ScaleValue(26);
        private static readonly int QAT_HEIGHT_FULL = DpiHelper.Default.ScaleValue(25);
		private static readonly int QAT_MINIBAR_LEFT = DpiHelper.Default.ScaleValue(6);
		#endregion
        ...
        public override void Layout(ViewLayoutContext context)
        {
            ...
            if (_minibar)
            {
				...
				clientRect.Y = clientRect.Bottom - QAT_HEIGHT_MINI - (clientRect.Height - QAT_HEIGHT_MINI) / 2;
        ...
        public override void RenderBefore(RenderContext context)
        {
            ...
            bool composition = false;// (OwnerForm != null) ? OwnerForm.ApplyComposition && OwnerForm.ApplyCustomChrome : false;
