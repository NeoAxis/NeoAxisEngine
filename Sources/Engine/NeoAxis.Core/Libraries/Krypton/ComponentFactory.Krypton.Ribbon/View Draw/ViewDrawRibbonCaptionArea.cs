...
namespace ComponentFactory.Krypton.Ribbon
{
    ...
    internal class ViewDrawRibbonCaptionArea : ViewDrawDocker
    {
        ...
        private static readonly int MIN_INTEGRATED_HEIGHT = 
			DpiHelper.Default.ScaleValue(26);    // MiniBar, 16 image + 2 * (2 gap + 1 border + 2 border) 
        private static readonly int CAPTION_TEXT_GAPS =
			DpiHelper.Default.ScaleValue(10);    // 4 below and 6 above
        private static readonly int MIN_SELF_HEIGHT =
			DpiHelper.Default.ScaleValue(28);    // Min height to show application button and the mini bar and context tabs
        #endregion
        ...
        private ViewLayoutRibbonContextTitles _contextTitles;
            ...
            if (disposing)
            {
                ...
                if (_kryptonForm != null)
                {
                    ...
                    if (_integrated)
                    {
                        ...
                        _kryptonForm.RevokeViewElement(_contextTitles, ViewDockStyle.Fill);
        ...
        public void UpdateVisible()
        {
            ...
            {
                var parentForm = _ribbon.Parent as KryptonForm;
                if( parentForm != null && !parentForm.AllowFormChrome )
                {
                    Visible = false;
                    return;
                }
        ...
        public void UpdateQAT()
        {
            ...
            _captionQAT.Visible = _ribbon.Visible && !_ribbon.IsOpenBackstageStateEnabled && (_ribbon.QATLocation == QATLocation.Above);
            _nonCaptionQAT.Visible = _ribbon.Visible && !_ribbon.IsOpenBackstageStateEnabled && (_ribbon.QATLocation == QATLocation.Above);
            UpdateVisible();
        ...
        {
            get { return false; }// UsingCustomChrome && KryptonForm.ApplyComposition; }
        }
        #endregion
        ...
        public Padding RealWindowBorders
        {
            ...
            {
                if (_kryptonForm != null)
                    return _kryptonForm.WindowMargin;
                else
        ...
        public bool DoesCurrentMouseDownEndAllTracking(Point pt)
        {
            ...
            if (UsingCustomChrome)
            {
                ...
                Padding formPadding =_kryptonForm.WindowMargin;
        ...
        private void CreateViewElements()
        {
            ...
            _contextTitles = new ViewLayoutRibbonContextTitles(_ribbon, this);
            _contextTitles.ReverseRenderOrder = true;

            _contextTitles.CenterLayout = true;
            ...
            Add(_contextTitles, ViewDockStyle.Fill);
        ...
        private void OnRibbonParentChanged(object sender, EventArgs e)
        {
            ...
            if (_kryptonForm != null)
            {
                _kryptonForm.ApplyCustomChromeChanged -= new EventHandler(OnFormChromeCheck);
                _kryptonForm.ClientSizeChanged -= new EventHandler(OnFormChromeCheck);
                _kryptonForm.PaletteChanged -= new EventHandler(OnFormChromeCheck);
                _kryptonForm.WindowActiveChanged -= new EventHandler(OnWindowActiveChanged);
                KryptonManager.GlobalPaletteChanged -= new EventHandler(OnFormChromeCheck);
                _kryptonForm = null;
            }
        ...
        private void OnFormChromeCheck(object sender, EventArgs e)
        {
            ...
            if ((_kryptonForm != null) && _kryptonForm.ApplyCustomChrome)
            {
                ...
                if (_ribbon.Location == Point.Empty)
                {
                    ...
                    int height = _kryptonForm.WindowMargin.Top;
                    ...
                    int SEPARATOR = DpiHelper.Default.ScaleValue(8);
                    _spaceInsteadOfAppButton.SeparatorSize = new Size(SEPARATOR /*_kryptonForm.RealWindowBorders.Left*/ , 0);
                }
            }
            ...
            if (_kryptonForm != null)
            {
                ...
                if (overrideIntegrated != _integrated)
                {
                    ...
                    if (!_integrated)
                    {
                        ...
                        _kryptonForm.InjectViewElement(_contextTitles, ViewDockStyle.Fill );
                    }
                    else
                    {
                        _captionAppButton.OwnerForm = null;
                ...
                bool newAllowIconDisplay = !_integrated || !_ribbon.RibbonAppButton.AppButtonVisible ||
                  true;// _kryptonForm.IsModernForm;

                if (_ribbon.IsOpenBackstageStateEnabled)
                    newAllowIconDisplay = false;
