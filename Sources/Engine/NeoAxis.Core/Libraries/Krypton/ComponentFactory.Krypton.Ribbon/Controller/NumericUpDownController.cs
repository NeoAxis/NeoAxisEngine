...
namespace Internal.ComponentFactory.Krypton.Ribbon
{
                                             ...
                                             IRibbonKeyTipTarget
	{
        ...
        {
            if ((_numericUpDown.LastNumericUpDown != null) &&
                (_numericUpDown.LastNumericUpDown.NumericUpDown != null) &&
                (_numericUpDown.LastNumericUpDown.NumericUpDown.CanFocus))
            {
        ...
        public void KeyTipSelect(KryptonRibbon ribbon)
        {
            ...
            if (_numericUpDown.LastNumericUpDown.CanFocus)
            {
                ...
                if (_numericUpDown.LastParentControl is VisualPopupGroup)
                {
                    ...
                    VisualPopupGroup popupGroup = (VisualPopupGroup)_numericUpDown.LastParentControl;
