...
namespace ComponentFactory.Krypton.Docking
{
    ...
    public class KryptonFloatingWindow : KryptonForm, ControlDoubleBufferComposited.IDoubleBufferComposited
    {
        ...
        protected override void OnResize( EventArgs e )
        {
            ...
            //!!!!betauser
            //if( _floatspace != null )
            //    _floatspace.SetBounds( ClientRectangle.X, ClientRectangle.Y, 2000, 2000 );
            //if( _floatspace != null )
            //    _floatspace.SetBounds( ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width, ClientRectangle.Height );
        }
