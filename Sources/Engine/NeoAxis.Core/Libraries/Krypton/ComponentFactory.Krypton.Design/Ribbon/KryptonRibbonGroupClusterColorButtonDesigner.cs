    ...
    internal class KryptonRibbonGroupClusterColorButtonDesigner : ComponentDesigner
    {
        ...
        private void UpdateVerbStatus()
        {
            ...
            if (_verbs == null)
            {
                ...
                _moveFirstVerb = new DesignerVerb("Move Cluster Color Button First", new EventHandler(OnMoveFirst));
                _movePrevVerb = new DesignerVerb("Move Cluster Color Button Previous", new EventHandler(OnMovePrevious));
                _moveNextVerb = new DesignerVerb("Move Cluster Color Button Next", new EventHandler(OnMoveNext));
                _moveLastVerb = new DesignerVerb("Move Cluster Color Button Last", new EventHandler(OnMoveLast));
                _deleteButtonVerb = new DesignerVerb("Delete Cluster Color Button", new EventHandler(OnDeleteButton));
        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonColorButton != null) && (_ribbonColorButton.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Cluster Color Button First", ComponentFactory.Krypton.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Cluster Color Button Previous", ComponentFactory.Krypton.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Cluster Color Button Next", ComponentFactory.Krypton.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Cluster Color Button Last", ComponentFactory.Krypton.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteButtonMenu = new ToolStripMenuItem("Delete Cluster Color Button", ComponentFactory.Krypton.Design.Properties.Resources.delete2, new EventHandler(OnDeleteButton));
