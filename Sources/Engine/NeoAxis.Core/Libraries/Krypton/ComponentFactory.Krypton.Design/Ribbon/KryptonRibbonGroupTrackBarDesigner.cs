        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonTrackBar != null) && (_ribbonTrackBar.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move TrackBar First", ComponentFactory.Krypton.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move TrackBar Previous", ComponentFactory.Krypton.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move TrackBar Next", ComponentFactory.Krypton.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move TrackBar Last", ComponentFactory.Krypton.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteTrackBarMenu = new ToolStripMenuItem("Delete TrackBar", ComponentFactory.Krypton.Design.Properties.Resources.delete2, new EventHandler(OnDeleteTrackBar));
