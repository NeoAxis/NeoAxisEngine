...
namespace ComponentFactory.Krypton.Ribbon
{
    internal class KryptonRibbonGroupButtonDesigner : ComponentDesigner
    {
        ...
        private ToolStripMenuItem _showArrowMenu;
        ...
        private void OnShowArrow(object sender, EventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                _changeService.OnComponentChanged(_ribbonButton, null, _ribbonButton.ShowArrow, !_ribbonButton.ShowArrow);
                _ribbonButton.ShowArrow = !_ribbonButton.ShowArrow;
            }
        }
        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _showArrowMenu = new ToolStripMenuItem("ShowArrow", null, new EventHandler(OnShowArrow));
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Button First", ComponentFactory.Krypton.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Button Previous", ComponentFactory.Krypton.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Button Next", ComponentFactory.Krypton.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Button Last", ComponentFactory.Krypton.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteButtonMenu = new ToolStripMenuItem("Delete Button", ComponentFactory.Krypton.Design.Properties.Resources.delete2, new EventHandler(OnDeleteButton));
                    _cms.Items.AddRange(new ToolStripItem[] { _toggleHelpersMenu, new ToolStripSeparator(),
                                                              _visibleMenu, _enabledMenu, _checkedMenu, _showArrowMenu, _typeMenu, new ToolStripSeparator(),
                ...
                _showArrowMenu.Checked = _ribbonButton.ShowArrow;
        ...
        private TypedRestrictCollection<KryptonRibbonGroupItem> ParentItems
        {
            get
            {
                ...
                {
                    KryptonRibbonGroupTriple triple = (KryptonRibbonGroupTriple)_ribbonButton.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonButton.RibbonContainer is KryptonRibbonGroupLines)
                {
                    KryptonRibbonGroupLines lines = (KryptonRibbonGroupLines)_ribbonButton.RibbonContainer;
                    return lines.Items;
                }
                else
                {
