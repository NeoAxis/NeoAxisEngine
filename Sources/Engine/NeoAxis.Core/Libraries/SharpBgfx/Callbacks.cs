...
namespace Internal.SharpBgfx
{
    ...
    unsafe struct CallbackShim
    {
        ...
        internal IntPtr reportError;
        internal IntPtr reportDebug;
        internal IntPtr profilerBegin;
        internal IntPtr profilerBeginLiteral;
        internal IntPtr profilerEnd;
        internal IntPtr getCachedSize;
        internal IntPtr getCacheEntry;
        internal IntPtr setCacheEntry;
        internal IntPtr saveScreenShot;
        internal IntPtr captureStarted;
        internal IntPtr captureFinished;
        internal IntPtr captureFrame;
        ...
        public static IntPtr CreateShim( ICallbackHandler handler )
        {
            ...
            {
                saver = new DelegateSaver( handler, shim );
            }
    ...
    unsafe class DelegateSaverWeb
    {
        ...
        public DelegateSaverWeb( ICallbackHandler handler, CallbackShim* shim )
        {
            DelegateSaverWeb.handler = handler;
