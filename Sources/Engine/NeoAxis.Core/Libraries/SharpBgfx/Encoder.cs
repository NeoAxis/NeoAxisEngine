...
//        /// <returns>The number of draw calls.</returns>
//		public void Submit( ushort id, Program program, int depth, DiscardFlags flags )
//        {
//			NativeMethods.bgfx_encoder_submit( ptr, id, program.handle, depth, flags );
//        }
//        ///// <summary>
//        ///// Submits the current batch of primitives for rendering.
//        ///// </summary>
...
//        /// <param name="preserveState"><c>true</c> to preserve internal draw state after the call.</param>
//        /// <returns>The number of draw calls.</returns>
//		public void Submit( ushort id, Program program, OcclusionQuery query, int depth, DiscardFlags flags )
//        {
//			NativeMethods.bgfx_encoder_submit_occlusion_query( ptr, id, program.handle, query.handle, depth, flags );
//        }
//        ///// <summary>
//        ///// Submits the current batch of primitives for rendering.
//        ///// </summary>
...
//        /// <param name="preserveState"><c>true</c> to preserve internal draw state after the call.</param>
//        /// <returns>The number of draw calls.</returns>
//		public void Submit( ushort id, Program program, IndirectBuffer indirectBuffer, int startIndex, int count, int depth, DiscardFlags flags )
//        {
//			NativeMethods.bgfx_encoder_submit_indirect( ptr, id, program.handle, indirectBuffer.handle, (ushort)startIndex, (ushort)count, depth, flags );
//        }
//        ///// <summary>
//        ///// Submits an indirect batch of drawing commands to be used for rendering.
//        ///// </summary>
