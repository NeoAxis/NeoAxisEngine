...
namespace NeoAxis.Editor
{
    partial class ObjectSettingsWindow
	{
        ...
        private void InitializeComponent()
        {
			...
			this.kryptonButtonApply = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			...
			this.objectsBrowser1.ListViewModeOverride = null;
   ...
   //         | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.kryptonSplitContainer1.Panel1.StateCommon.ImageStyle = Internal.ComponentFactory.Krypton.Toolkit.PaletteImageStyle.Inherit;
			// 
			...
			this.kryptonSplitContainer1.Panel2.StateCommon.ImageStyle = Internal.ComponentFactory.Krypton.Toolkit.PaletteImageStyle.Inherit;
			...
			this.kryptonSplitContainer1.StateNormal.Back.ImageStyle = Internal.ComponentFactory.Krypton.Toolkit.PaletteImageStyle.Inherit;
		...
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton kryptonButtonApply;
	}
}
