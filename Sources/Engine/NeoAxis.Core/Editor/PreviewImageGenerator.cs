	...
	public abstract class PreviewImageGenerator
	{
		...
		public Scene CreateScene( bool enable )
		{
			...
			//rendering pipeline
			{
				...
				////antialiasing
				//var toLDRType = MetadataManager.GetType( "NeoAxis.RenderingEffect_ToLDR" );
				//var antialiasingType = MetadataManager.GetType( "NeoAxis.RenderingEffect_Antialiasing" );
		...
		protected virtual void Scene_ViewportUpdateGetCameraSettings( Scene scene, Viewport viewport, ref bool processed )
		{
			if( !cameraMode2D )
			{
				...
				camera.FarClipPlane = Math.Max( 1000, cameraDistance * 5 );
		...
		////!!!!!так? везде так
		//public void AddTextWithShadow( Font font, double fontSize, string text, Vector2 position, EHorizontalAlignment horizontalAlign, EVerticalAlignment verticalAlign, ColorValue color )
		//{
		//	var renderer = Viewport.CanvasRenderer;
		...
		//public void AddTextLinesWithShadow( Font font, double fontSize, IList<string> lines, Rectangle rectangle, EHorizontalAlignment horizontalAlign, EVerticalAlignment verticalAlign, ColorValue color )
		//{
		//	if( lines.Count == 0 )
		//		return;
		...
		//public int AddTextWordWrapWithShadow( Font font, double fontSize, string text, Rectangle rectangle, EHorizontalAlignment horizontalAlign, EVerticalAlignment verticalAlign, ColorValue color )
		//{
		//	var renderer = Viewport.CanvasRenderer;
