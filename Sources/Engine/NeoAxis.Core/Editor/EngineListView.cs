	...
	public class EngineListView : EUserControl
	{
		...
		public class DefaultListMode : ModeClass
		{
				...
				: base( owner )
			{
				...
				var imageSize2 = (int)( (float)imageSize * EditorAPI.DPIScale );
			...
			public override void PaintItem( PaintEventArgs e, int itemIndex )
			{
				...
				if( DisplayImages || Owner.CheckBoxes )
				{
					...
					if( Owner.CheckBoxes && image == null )
					{
						if( item.Checked )
						{
							var color = EditorAPI.DarkTheme ? Color.FromArgb( 230, 230, 230 ) : Color.FromArgb( 50, 50, 50 );
		...
		protected override void OnPaint( PaintEventArgs e )
		{
			...
			//background
			{
				...
				var backColor = EditorAPI.DarkTheme ? Color.FromArgb( 40, 40, 40 ) : Color.FromArgb( 255, 255, 255 );
			...
			if( scrollBarVertical != null && scrollBarVertical.Visible )
			{
				...
				var backColor = EditorAPI.DarkTheme ? Color.FromArgb( 47, 47, 47 ) : Color.FromArgb( 240, 240, 240 );
				using( var brush = new SolidBrush( backColor ) )
					e.Graphics.FillRectangle( brush, rect );
			}
