...
namespace NeoAxis.Editor
{
	public class PaintLayerSettingsCell : SettingsCellProcedureUI
	{
		...
		{
			buttonImportMask = ProcedureForm.CreateButton( EditorLocalization.Translate( "PaintLayer", "Import Mask" ), ProcedureUI.Button.SizeEnum.Long );
			buttonImportMask.Click += ButtonImportMask_Click;
			buttonExportMask = ProcedureForm.CreateButton( EditorLocalization.Translate( "PaintLayer", "Export Mask" ), ProcedureUI.Button.SizeEnum.Long );
			...
			buttonFillMask = ProcedureForm.CreateButton( EditorLocalization.Translate( "PaintLayer", "Fill Mask" ), ProcedureUI.Button.SizeEnum.Long );
