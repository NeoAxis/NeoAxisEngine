	...
	public static class EditorStandardActions
	{
		...
		static void RegisterGeneral()
		{
			...
			//Project settings
			{
				...
				a.Click += delegate ( EditorAction.ClickContext context )
				{
					...
					EditorAPI.NeedShowProjectSettings();
			...
			if( EngineInfo.EngineMode == EngineInfo.EngineModeEnum.CloudClient )
			{
				//Cloud Project Get
				{
					...
					a.CommonType = EditorAction.CommonTypeEnum.General;
					a.Description = "Gets updated files from the server.";
					...
					{
						if( EngineInfo.EngineMode == EngineInfo.EngineModeEnum.CloudClient )
							RepositoryActionsWithServer.Get( new string[] { VirtualFileSystem.Directories.Assets }, new string[ 0 ] );
					};
					EditorActions.Register( a );
				}
				...
				//Cloud Project Commit
				{
					...
					a.CommonType = EditorAction.CommonTypeEnum.General;
					a.Description = "Uploads updated files to the server.";
					...
					{
						if( EngineInfo.EngineMode == EngineInfo.EngineModeEnum.CloudClient )
							RepositoryActionsWithServer.Commit( new string[] { VirtualFileSystem.Directories.Project }, new string[ 0 ] );
					};
					EditorActions.Register( a );
				}
			}
				...
				a.Click += delegate ( EditorAction.ClickContext context )
				{
					...
					if( sceneDocumentWindow != null )
					{
						if( sceneDocumentWindow.WorkareaModeName != "Simulate Physics" )
						{
							...
							sceneDocumentWindow.transformToolModeRestore = sceneDocumentWindow.TransformTool.Mode;
							sceneDocumentWindow.TransformTool.Mode = TransformTool.ModeEnum.Undefined;
						}
						else
						{
							sceneDocumentWindow.WorkareaModeSet( "" );
							sceneDocumentWindow.TransformTool.Mode = sceneDocumentWindow.transformToolModeRestore;
						}
					}
				};
				EditorActions.Register( a );
		...
		static void RegisterMesh()
		{
			...
			//Mesh Play Animation
			{
				...
				a.DropDownContextMenu.Opening += delegate ( object sender, CancelEventArgs e )
				{
					...
					var tuple = ((DocumentInstance, Mesh))menu.Tag;
		...
		static void RegisterScripting()
		{
			...
			//Build Project's Solution
			{
				...
				a.Click += delegate ( EditorAction.ClickContext context )
				{
					EditorAPI.BuildProjectSolution( true );// false );
				};
				EditorActions.Register( a );
			}
		...
		static void RegisterUI()
		{
			...
			void GetStateHorizontal( EditorAction.GetStateContext context, EHorizontalAlignment alignment )
			{
			...
			void ClickHorizontal( EditorAction.ClickContext context, EHorizontalAlignment alignment )
			{
				if( context.ObjectsInFocus.DocumentWindow as UIControlEditor != null )
				{
			...
			void GetStateVertical( EditorAction.GetStateContext context, EVerticalAlignment alignment )
			{
				if( context.ObjectsInFocus.DocumentWindow as UIControlEditor != null )
				{
					var controls = context.ObjectsInFocus.Objects.OfType<UIControl>().ToArray();
			...
			void ClickVertical( EditorAction.ClickContext context, EVerticalAlignment alignment )
			{
				if( context.ObjectsInFocus.DocumentWindow as UIControlEditor != null )
				{
					var controls = context.ObjectsInFocus.Objects.OfType<UIControl>();
			...
			//Align Left
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Left", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateHorizontal( context, EHorizontalAlignment.Left ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickHorizontal( context, EHorizontalAlignment.Left ); };
				EditorActions.Register( a );
			}
			...
			//Align Center Horizontal
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Center", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateHorizontal( context, EHorizontalAlignment.Center ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickHorizontal( context, EHorizontalAlignment.Center ); };
				EditorActions.Register( a );
			}
			...
			//Align Right
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Right", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateHorizontal( context, EHorizontalAlignment.Right ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickHorizontal( context, EHorizontalAlignment.Right ); };
				EditorActions.Register( a );
			}
			...
			//Align Stretch Horizontal
			{
				...
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateHorizontal( context, EHorizontalAlignment.Stretch ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickHorizontal( context, EHorizontalAlignment.Stretch ); };
				EditorActions.Register( a );
			}
			...
			//Align Top
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Top", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateVertical( context, EVerticalAlignment.Top ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickVertical( context, EVerticalAlignment.Top ); };
				EditorActions.Register( a );
			}
			...
			//Align Center Vertical
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Center", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateVertical( context, EVerticalAlignment.Center ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickVertical( context, EVerticalAlignment.Center ); };
				EditorActions.Register( a );
			}
			...
			//Align Bottom
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Bottom", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateVertical( context, EVerticalAlignment.Bottom ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickVertical( context, EVerticalAlignment.Bottom ); };
				EditorActions.Register( a );
			}
			...
			//Align Stretch Vertical
			{
				...
				a.QatSupport = true;
				a.RibbonText = ("Stretch", "");
				a.GetState += delegate ( EditorAction.GetStateContext context ) { GetStateVertical( context, EVerticalAlignment.Stretch ); };
				a.Click += delegate ( EditorAction.ClickContext context ) { ClickVertical( context, EVerticalAlignment.Stretch ); };
				EditorActions.Register( a );
			}
