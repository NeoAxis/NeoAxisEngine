...
namespace NeoAxis.Editor
{
	partial class ComponentTypeSettingsForm
	{
		...
		{
			this.kryptonButtonCancel = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			this.kryptonButtonOK = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			...
			this.labelEx1.LabelStyle = Internal.ComponentFactory.Krypton.Toolkit.LabelStyle.NormalControl;
			...
			this.labelEx1.StateCommon.Border.Draw = Internal.ComponentFactory.Krypton.Toolkit.InheritBool.False;
			this.labelEx1.StateCommon.Border.DrawBorders = ((Internal.ComponentFactory.Krypton.Toolkit.PaletteDrawBorders)((((Internal.ComponentFactory.Krypton.Toolkit.PaletteDrawBorders.Top | Internal.ComponentFactory.Krypton.Toolkit.PaletteDrawBorders.Bottom) 
		...
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton kryptonButtonCancel;
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton kryptonButtonOK;
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton kryptonButtonReset;
