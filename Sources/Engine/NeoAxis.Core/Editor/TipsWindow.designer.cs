namespace NeoAxis.Editor
{
	partial class TipsWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.kryptonCheckBoxShowTipsAtStartup = new ComponentFactory.Krypton.Toolkit.KryptonCheckBox();
			...
			this.tipNumberLabel = new ComponentFactory.Krypton.Toolkit.KryptonLabel();
		...
		private ComponentFactory.Krypton.Toolkit.KryptonCheckBox kryptonCheckBoxShowTipsAtStartup;
		...
		private ComponentFactory.Krypton.Toolkit.KryptonLabel tipNumberLabel;
