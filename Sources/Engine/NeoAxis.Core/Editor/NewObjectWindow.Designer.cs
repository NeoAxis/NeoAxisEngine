...
namespace NeoAxis.Editor
{
    partial class NewObjectWindow
	{
        ...
        private void InitializeComponent()
        {
			...
			this.buttonCreate = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			...
			this.buttonCreateAndClose = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
   ...
   //         | System.Windows.Forms.AnchorStyles.Right)));
        ...
        private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton buttonCreate;
		...
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton buttonCreateAndClose;
