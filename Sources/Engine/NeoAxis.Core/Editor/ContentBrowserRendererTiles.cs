...
namespace NeoAxis.Editor
{
	...
	///
	/// </summary>
	internal class ContentBrowserRendererTiles : ContentBrowserRendererBase
	{
		// image size + side padding + two lines of text for height
		internal static readonly Size TilePadding = DpiHelper.Default.ScaleValue( new Size( 30, 40 ) );

		public ContentBrowserRendererTiles( ContentBrowserImageHelper imageHelper, int size )
		...
		{
			const int ImageVertPadding = 6; //TODO: dpi scale?
