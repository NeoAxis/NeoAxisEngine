...
namespace NeoAxis.Editor
{
	public partial class SettingsHeader_ObjectInfo : SettingsHeader
	{
		...
		void UpdateInfoControls()
		{
			...
			{
				text1 = string.Format( EditorLocalization.Translate( "SettingsWindow", "{0} objects" ), objs.Length );
				text2 = "";
			}
		...
		private void buttonTypeSettings_Click( object sender, EventArgs e )
		{
			...
			if( component != null )
			{
				var form = new ComponentTypeSettingsForm( SettingsPanel.documentWindow.Document, component );
