...
namespace NeoAxis.Editor
{
	class HCItemProjectRibbonAndToolbarActions : HCItemProperty
	{
		...
		class ContentBrowserItem_Group : ContentBrowserItem_Virtual
		{
			...
			EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem, ContentBrowserItem_Virtual> items = new EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem, ContentBrowserItem_Virtual>();

			//

			public ContentBrowserItem_Group( ContentBrowser owner, ContentBrowser.Item parent, string text, HCItemProjectRibbonAndToolbarActions hcItem, HCItemProjectRibbonAndToolbarActionsForm control, Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem group )
			...
			public override IList<ContentBrowser.Item> GetChildren( bool onlyAlreadyCreated )
			{
				...
				{
					var newItems = new EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem, ContentBrowserItem_Virtual>( items.Count );
					...
					foreach( var actionItem in actions )
					{
						...
						if( !items.TryGetValue( actionItem, out var item ) )
						{
							...
							if( action != null && actionItem.Type == Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem.TypeEnum.Action )
							{
							...
							else if( actionItem.Type == Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem.TypeEnum.SubGroupOfActions )
							{
								//!!!!impl
		...
		class ContentBrowserItem_Tab : ContentBrowserItem_Virtual
		{
			...
			EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem, ContentBrowserItem_Virtual> items = new EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem, ContentBrowserItem_Virtual>();

			//

			public ContentBrowserItem_Tab( ContentBrowser owner, ContentBrowser.Item parent, string text, HCItemProjectRibbonAndToolbarActions hcItem, HCItemProjectRibbonAndToolbarActionsForm control, Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem tabItem )
				: base( owner, parent, text )
			{
				this.hcItem = hcItem;
				this.control = control;
			...
			public override IList<ContentBrowser.Item> GetChildren( bool onlyAlreadyCreated )
			{
				...
				if( !onlyAlreadyCreated )
				{
					var newItems = new EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem, ContentBrowserItem_Virtual>( items.Count );
		...
		class ContentBrowserItem_Ribbon : ContentBrowserItem_Virtual
		{
			...
			EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem, ContentBrowserItem_Virtual> items = new EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem, ContentBrowserItem_Virtual>();
			...
			public override IList<ContentBrowser.Item> GetChildren( bool onlyAlreadyCreated )
			{
				...
				if( !onlyAlreadyCreated )
				{
					var newItems = new EDictionary<Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem, ContentBrowserItem_Virtual>( items.Count );
		...
		private void ContentBrowserProject_KeyDownOverride( ContentBrowser browser, object sender, KeyEventArgs e, ref bool handled )
		{
			//Delete
			{
		...
		Component_ProjectSettings.RibbonAndToolbarActionsClass GetSettings()
		{
			var control = (HCItemProjectRibbonAndToolbarActionsForm)CreatedControlInsidePropertyItemControl;
			...
			if( values == null || values.Length != 1 )
				return null;
			return values[ 0 ] as Component_ProjectSettings.RibbonAndToolbarActionsClass;
		}
		...
		private void ContentBrowserProject_ShowContextMenuEvent( ContentBrowser sender, List<KryptonContextMenuItemBase> items )
		{
			var settings = GetSettings();
			if( settings == null )
				return;
		...
		public bool CanDeleteObjects( out List<ContentBrowser.Item> resultItemsToDelete )
		{
			...
			{
				var actionItem = item.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem;
				if( actionItem != null )
				{
				...
				var groupItem2 = item.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem;
				if( groupItem2 != null )
					resultItemsToDelete.Add( item );

				var tabItem = item.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem;
				if( tabItem != null )
					resultItemsToDelete.Add( item );
			}
		...
		public void TryDeleteObjects()
		{
			...
			foreach( var item in itemsToDelete )
			{
				...
				{
					var tabItem2 = item.Parent.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem;
					if( tabItem2 != null )
		...
		bool GetSelectedDestinationGroupToAdd( out Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem destinationGroup )
		{
			var control = (HCItemProjectRibbonAndToolbarActionsForm)CreatedControlInsidePropertyItemControl;
		...
		public void TryAddAction()
		{
			...
			{
				var item = new Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem();
		...
		bool CanMoveUp( out Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem tab, out Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem group, out Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem actionItem )
		{
			var control = (HCItemProjectRibbonAndToolbarActionsForm)CreatedControlInsidePropertyItemControl;
			var settings = GetSettings();
			...
			if( items.Length == 1 )
			{
				var actionItem2 = items[ 0 ].Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem;
				if( actionItem2 != null )
				{
					var groupItem2 = items[ 0 ].Parent.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem;
				...
				var groupItem3 = items[ 0 ].Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem;
				if( groupItem3 != null )
				{
					var tab2 = items[ 0 ].Parent?.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem;
					if( tab2 != null )
					{
				...
				var tabItem2 = items[ 0 ].Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem;
				if( tabItem2 != null )
				{
		...
		bool CanMoveDown( out Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem tab, out Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem group, out Component_ProjectSettings.RibbonAndToolbarActionsClass.ActionItem actionItem )
		{
			var control = (HCItemProjectRibbonAndToolbarActionsForm)CreatedControlInsidePropertyItemControl;
			var settings = GetSettings();
		...
		private void ToolStripButtonEnabled_Click( object sender, EventArgs e )
		{
			TrySetEnabled();
		}
		...
		public bool CanSetEnabled( out List<ContentBrowser.Item> itemsToUpdate, out bool newValue )
		{
			...
			foreach( var item in control.contentBrowserProject.SelectedItems )
			{
				...
				var groupItem = item.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem;
				if( groupItem != null )
				{
		...
		public void TryRename()
		{
			...
			var groupItem = itemToRename.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem;
			if( groupItem != null )
			{
			...
			var tabItem = itemToRename.Tag as Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem;
			if( tabItem != null )
			{
		...
		public void TryNewGroup()
		{
			...
			if( destinationTab == null )
			{
				...
				var tab = new Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem();
				tab.Name = "My Tab";
				tab.Type = Component_ProjectSettings.RibbonAndToolbarActionsClass.TabItem.TypeEnum.Additional;
			...
			else
			{
				...
				var group = new Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem();
				group.Name = "My Group";
				group.Type = Component_ProjectSettings.RibbonAndToolbarActionsClass.GroupItem.TypeEnum.Additional;
