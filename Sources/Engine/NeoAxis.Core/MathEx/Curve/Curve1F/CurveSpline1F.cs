...
namespace NeoAxis
{
	...
	/// </summary>
	public class CurveSpline1F : Curve1F
	{
		protected float GetValueForIndex( int index )
		{
		...
		protected float GetTimeForIndex( int index )
		{
			int n = points.Count - 1;
		...
		protected float GetClampedTime( float t )
		{
			return t;
		}
	}
