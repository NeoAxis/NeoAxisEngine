...
namespace NeoAxis
{
	...
	public struct Box
	{
		...
		/// </summary>
		public static readonly Box Zero = new Box( Vector3.Zero, Vector3.Zero, Matrix3.Identity );

		/// <summary>
		/// Not initialized box.
		/// </summary>
		public static readonly Box Cleared = new Box(
			Vector3.Zero, new Vector3( double.MinValue, double.MinValue, double.MinValue ), Matrix3.Identity );
		...
		/// <summary>
		/// Determines whether the specified object is equal to the current instance of <see cref="Box"/>.
		/// </summary>
		...
		/// <summary>
		/// Determines whether the specified box is equal to the current instance of <see cref="Box"/>
		...
		/// <summary>
		/// Determines whether the current instance of <see cref="Box"/> contains a given point.
		/// </summary>
		...
		/// <summary>
		/// Determines whether the current instance of <see cref="Box"/> contains given bounds.
		/// </summary>
		...
		/// <summary>
		/// Determines whether the current instance of <see cref="Box"/> contains the given sphere.
		/// </summary>
		...
		/// <summary>
		/// Determines whether the current instance of <see cref="Box"/> contains another instance of <see cref="Box"/>.
		/// </summary>
		...
		/// <summary>
		/// Determines whether the given ray intersects the current instance of <see cref="Box"/>.
		/// </summary>
		...
		/// <summary>
		/// Determines whether another instance of <see cref="Box"/> intersects the current instance of <see cref="Box"/>.
		/// </summary>
		/// <param name="box">The box to check.</param>
		...
		/// <summary>
		/// Determines whether the given bounds intersect the current instance of <see cref="Box"/>.
		/// </summary>
		...
		/// <summary>
		/// Calculates the distance between the current instance of <see cref="Box"/> and the given plane.
		/// </summary>
		...
		/// <summary>
		/// Calculates the squared distance between the current instance of <see cref="Box"/> and the given point.
		/// </summary>
		...
		/// <summary>
		/// Calculates the distance between the current instance of <see cref="Box"/> and the given point.
		/// </summary>
