...
namespace NeoAxis
{
	...
	public abstract class PlatformSpecificUtility
	{
		...
		/// <summary>
		/// Gets the instance of the <see cref="PlatformSpecificUtility"/> class. To initialize on desktop platforms call Platforms.Initialize() from NeoAxis.Platforms.dll.
		/// </summary>
	...
	public static class PlatformSpecificRegistryUtility
	{
		class Impl
		{
		...
		public static object GetRegistryValue( string keyName, string valueName, object defaultValue )
		{
			if( SystemSettings.CurrentPlatform == SystemSettings.Platform.Windows )
				return Impl.Registry.GetValue( keyName, valueName, defaultValue );
			else
				return null;
		...
		{
			if( SystemSettings.CurrentPlatform == SystemSettings.Platform.Windows )
				Impl.Registry.SetValue( keyName, valueName, value );
