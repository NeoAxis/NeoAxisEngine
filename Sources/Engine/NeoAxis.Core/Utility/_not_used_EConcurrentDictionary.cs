...
//	public class EConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>
//	{
//		ConcurrentDictionary<TKey, int> baseDictionary;
//		zzzz;
...
//		{
//			EConcurrentDictionary<TKey, TValue> dictionary;
//			int version;
//			int orderedIndex;
...
//			public Enumerator( EConcurrentDictionary<TKey, TValue> dictionary )
//			{
...
//		public EConcurrentDictionary()
//			: this( 0, null )
//		{
//		}

//		public EConcurrentDictionary( IEqualityComparer<TKey> comparer )
//			: this( 0, comparer )
//		{
//		}

//		public EConcurrentDictionary( int capacity )
//			: this( capacity, null )
//		{
//		}

//		public EConcurrentDictionary( IDictionary<TKey, TValue> dictionary )
//			: this( dictionary, null )
//		{
//		}

//		[MethodImpl( MethodImplOptions.AggressiveInlining | (MethodImplOptions)512 )]
//		public EConcurrentDictionary( int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer )
//		{
//			baseDictionary = new ConcurrentDictionary<TKey, int>( concurrencyLevel, capacity, comparer );
//			ordered = new List<OrderedItem>( capacity );
//		}

//		[MethodImpl( MethodImplOptions.AggressiveInlining | (MethodImplOptions)512 )]
//		public EConcurrentDictionary( int concurrencyLevel, IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer )
//		{
//			baseDictionary = new ConcurrentDictionary<TKey, int>( concurrencyLevel, dictionary.Count, comparer );
...
//			baseDictionary.TryRemove( key, out orderedIndex );
