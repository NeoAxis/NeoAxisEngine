...
rd /s /q "..\obj"
dotnet build "..\NeoAxis.Core.NETStandard21.csproj" -c Release -p:TargetFramework=netstandard2.1 -p:OutputPath=".\NETStandard21" -p:AppendTargetFrameworkToOutputPath=false -p:UseSharedCompilation=false --no-incremental
rd /s /q "..\obj"
