...
namespace NeoAxis//Accord.Video
{
    ...
    /// 
    class AVIWriterVideoException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AVIWriterVideoException"/> class.
        /// </summary>
        /// 
        /// <param name="message">Exception's message.</param>
        /// 
        public AVIWriterVideoException( string message ) :
            base( message ) { }
    }
}
