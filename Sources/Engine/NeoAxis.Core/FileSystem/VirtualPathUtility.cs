...
namespace NeoAxis
{
	...
	public static class VirtualPathUtility
	{
		...
		{
			GetVirtualPathByReal( realPath, out string virtualPath );
			return virtualPath;
			...
			//realPath = NormalizePath( realPath );
			//if( !Path.IsPathRooted( realPath ) )
			//	realPath = Path.Combine( VirtualFileSystem.Directories.Executables, realPath );

			////project data
			//{
			//	string dir = VirtualFileSystem.Directories.ProjectData;
			//	if( realPath.Length >= dir.Length )
			//	{
			//		if( string.Equals( realPath, dir, StringComparison.OrdinalIgnoreCase ) )
			//			return "";
			//		else if( string.Equals( realPath.Substring( 0, dir.Length ), dir, StringComparison.OrdinalIgnoreCase ) )
			//			return realPath.Substring( dir.Length + 1, realPath.Length - dir.Length - 1 );
			//	}
			//}
			...
			//			return "user:";
			//		else if( string.Equals( realPath.Substring( 0, dir.Length ), dir, StringComparison.OrdinalIgnoreCase ) )
			//			return "user:" + realPath.Substring( dir.Length + 1, realPath.Length - dir.Length - 1 );
			//	}
			//}
