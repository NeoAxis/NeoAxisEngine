...
namespace NeoAxis
{
	...
	struct FreeType
	{
		...
		[DllImport( OgreWrapper.library, EntryPoint = "FreeType_GetGlyphContours", CallingConvention = OgreWrapper.convention ), SuppressUnmanagedCodeSecurity]
		[return: MarshalAs( UnmanagedType.U1 )]
		public static unsafe extern bool GetGlyphContoursWeb( IntPtr/*FT_Library*/ library, IntPtr/*FT_Face*/ face, int character, void*/*GetGlyphContoursDelegate*/ callback, out int drawOffsetX, out int drawOffsetY, out int advance );
	}
}
