...
namespace NeoAxis
{
	...
	public class ResultCompile<T> : Component where T : class
	{
		T result;
		...
		/// </summary>
		public void PerformResultCompile()
		{
		...
		/// </summary>
		public event Action<ResultCompile<T>> ResultCompileBegin;
		/// <summary>
		/// Occurs after the completion of the compilation of the result.
		/// </summary>
		public event Action<ResultCompile<T>> ResultCompileEnd;
		...
		public event Action<ResultCompile<T>> ResultChanged;
