...
{
	abstract class OpenALSound : Sound
	{
	...
	sealed class OpenALSampleSound : OpenALSound
	{
	...
	class OpenALDataBufferSound : OpenALSound
	{
	...
	sealed class OpenALFileStreamSound : OpenALDataBufferSound
	{
	...
	sealed class OpenALDataStreamSound : OpenALDataBufferSound
	{
	...
	sealed class OpenALCaptureSound : OpenALSound
	{
