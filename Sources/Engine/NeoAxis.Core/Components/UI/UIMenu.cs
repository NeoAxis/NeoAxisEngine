...
namespace NeoAxis
{
	...
	public class UIMenu : UIControl
	{
		...
		//{
		//	public delegate void ClickDelegate( UIMenu sender, Item item );
		...
		//public static UIMenu Show( UIControl parent, ICollection<ItemBase> items, Vector2 screenPosition )
		//{
		...
		//	var menu = backControl.CreateComponent<UIMenu>();
		...
		//public static UIMenu Show( UIControl parent, ICollection<ItemBase> items )
		//{
		...
		//{
		//	var menu = sender.GetComponent<UIMenu>();
