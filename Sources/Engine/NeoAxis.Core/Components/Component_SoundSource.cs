...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_SoundSource : Component_ObjectInSpace
	{
		Sound sound;
		...
		[Serialize]
		//[Category( "General" )]
		public Reference<Component_Sound> Sound
		{
		...
		public event Action<Component_SoundSource> SoundChanged;
		ReferenceField<Component_Sound> _sound;
		...
		public event Action<Component_SoundSource> VolumeChanged;
		...
		public event Action<Component_SoundSource> PitchChanged;
		...
		public event Action<Component_SoundSource> RolloffModeChanged;
		...
		public event Action<Component_SoundSource> RolloffLogarithmicFactorChanged;
		...
		public event Action<Component_SoundSource> AttenuationNearChanged;
		...
		public event Action<Component_SoundSource> AttenuationFarChanged;
		...
		public event Action<Component_SoundSource> ReplayDelayChanged;
		...
		public event Action<Component_SoundSource> StreamingChanged;
		...
		public event Action<Component_SoundSource> PriorityChanged;
		...
		public delegate void BeforePlayEventDelegate( Component_SoundSource sender );
