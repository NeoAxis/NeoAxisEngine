...
namespace NeoAxis
{
	...
	public class Item3D : MeshInSpace, Item3DInterface, InteractiveObjectInterface
	{
		...
		public Reference<Item3DType> ItemType
		{
		...
		public event Action<Item3D> ItemTypeChanged;
		ReferenceField<Item3DType> _itemType;// = new Reference<ItemType>( null, TypeDefault );
		...
		public event Action<Item3D> ItemCountChanged;
		...
		public delegate void ObjectInteractionGetInfoEventDelegate( Item3D sender, GameMode gameMode, Component initiator, ref InteractiveObjectObjectInfo info );
