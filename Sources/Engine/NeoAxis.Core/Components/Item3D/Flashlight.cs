...
namespace NeoAxis
{
	...
	/// </summary>
	[AddToResourcesWindow( @"Addons\Item 3D\Flashlight", 550 )]
	[NewObjectDefaultName( "Flashlight" )]
	public class Flashlight : Item3D
	{
		Light lightCached;
		...
		public override void NewObjectSetDefaultConfiguration( bool createdFromNewObjectWindow = false )
		{
			...
			ItemType = new ReferenceNoValue( @"Content\Items 3D\NeoAxis\Flashlight\Flashlight.itemtype" );
		}
