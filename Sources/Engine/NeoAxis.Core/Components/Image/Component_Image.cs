...
namespace NeoAxis
{
	...
	public class Component_Image : Component_ResultCompile<GpuTexture>
	{
		...
		public event Action<Component_Image> LoadFileChanged;
		...
		public event Action<Component_Image> LoadCubeNegativeXChanged;
		...
		public event Action<Component_Image> LoadCubeNegativeYChanged;
		...
		public event Action<Component_Image> CreateFormatChanged;
		...
		public event Action<Component_Image> CreateTypeChanged;
		...
		public event Action<Component_Image> CreateSizeChanged;
		...
		public event Action<Component_Image> CreateDepthChanged;
		...
		public event Action<Component_Image> CreateArrayLayersChanged;
		...
		public event Action<Component_Image> CreateMipmapsChanged;
		...
		//	}
		//}
		//public event Action<Component_Texture> CreateMipmapsChanged;
		...
		public event Action<Component_Image> CreateUsageChanged;
		...
		public event Action<Component_Image> CreateFSAAChanged;
		...
		//						//!!!!slow
		//						EngineThreading.ExecuteFromMainThreadWait( delegate ( Component_Texture _this )
		//						{
		//							if( loadFromOneFile != null )
		//							{
		//								//2D, Cube, etc
		...
		//								//	Log.Fatal( "Component_Texture: Loading image failed ({0}).", error );
		//								//}
