...
namespace NeoAxis
{
	...
	public class VirtualProperty : VirtualMember
	{
		...
		public event Action<VirtualProperty> TypeChanged;
		...
		public event Action<VirtualProperty> ReferenceSupportChanged;
		...
		////Indexers
		//List<MemberParameter> indexers = new List<MemberParameter>();
		///// <summary>
		///// The indexers of the property.
		///// </summary>
		//[Serialize]
		//public virtual List<MemberParameter> Indexers
		//{
		//	get { return indexers; }
		//}
		...
		//xx xx;
		//public delegate void InputChangedDelegate( FloatingSum sender, int index );
		//public event InputChangedDelegate IndexerChanged;


		//public event Action<Property> IndexersChanged;

		//Reference<List<MemberParameter>> indexers = new List<MemberParameter>();
		//[Serialize]
		//public virtual Reference<List<MemberParameter>> Indexers
		//{
		//	get
		//	{
		...
		public event Action<VirtualProperty> ReadOnlyChanged;
		...
		public event Action<VirtualProperty> BrowsableChanged;
		...
		public event Action<VirtualProperty> CategoryChanged;
		...
		public event Action<VirtualProperty> SerializableChanged;
		...
		public event Action<VirtualProperty> CloneableChanged;

		////GetAccessor
		//ReferenceField<MethodBody> _getAccessor;
		///// <summary>
		///// The get accessor method of the property.
		///// </summary>
		//[Serialize]
		//public Reference<MethodBody> GetAccessor
		//{
		//	get
		//	{
		...
		//	}
		//}
		//public event Action<Property> GetAccessorChanged;

		////SetAccessor
		//ReferenceField<MethodBody> _setAccessor;
		///// <summary>
		///// The set accessor method of the property.
		///// </summary>
		//[Serialize]
		//public Reference<MethodBody> SetAccessor
		//{
		//	get
		//	{
		...
		//	}
		//}
		//public event Action<Property> SetAccessorChanged;
		...
		//!!!!
		//public event Action<Property> ChangedEventChanged;
		...
		public event Action<VirtualProperty> DefaultValueSpecifiedChanged;
		...
		//	}
		//}
		//public event Action<Property> DefaultValueChanged;

		/////////////////////////////////////

		class PropertyImpl : Metadata.Property
		{
			VirtualProperty creator;
			string category;
			bool referenceSupport;

			//

			public PropertyImpl( object owner, string name, bool isStatic, Metadata.TypeInfo type, Metadata.TypeInfo typeUnreferenced, Metadata.Parameter[] indexers, bool readOnly, VirtualProperty creator, string category, bool referenceSupport )
		...
		//	{
		//		var property = (Property)context.newObject;

		//		if( CreateFlowGraphWithGetSetAccessors )
		//		{
		//			var graph = property.CreateComponent<FlowGraph>();
		...
		//				bodyGet = node.CreateComponent<MethodBody>();
		//				bodyGet.Name = "Method Body Get";
		//				bodyGet.PropertyAccessorType = MethodBody.PropertyAccessorTypeEnum.Get;
		...
		//			MethodBodyEnd bodyEndGet;
		//			{
		//				var node = graph.CreateComponent<FlowGraphNode>();

		//				bodyEndGet = node.CreateComponent<MethodBodyEnd>();
		...
		//				bodySet = node.CreateComponent<MethodBody>();
		//				bodySet.Name = "Method Body Set";
		//				bodySet.PropertyAccessorType = MethodBody.PropertyAccessorTypeEnum.Set;
		...
		//			property.GetAccessor = new Reference<MethodBody>( null, ReferenceUtility.CalculateThisReference( property, bodyGet ) );
		//			property.SetAccessor = new Reference<MethodBody>( null, ReferenceUtility.CalculateThisReference( property, bodySet ) );

		//			bodyGet.Definition = new Reference<Member>( null, ReferenceUtility.CalculateThisReference( bodyGet, property ) );
		//			bodyGet.BodyEnd = new Reference<MethodBodyEnd>( null, ReferenceUtility.CalculateThisReference( bodyGet, bodyEndGet ) );
		//			bodyEndGet.Body = new Reference<MethodBody>( null, ReferenceUtility.CalculateThisReference( bodyEndGet, bodyGet ) );

		//			bodySet.Definition = new Reference<Member>( null, ReferenceUtility.CalculateThisReference( bodySet, property ) );
		...
		{
			//!!!!
			List<VirtualMemberParameter> indexers = new List<VirtualMemberParameter>();
			//List<MemberParameter> indexers = Indexers;
			...
			//{
			//	if( Cache == null )
			//		Log.Fatal( "Property: CreateMetadataMember: Cache == null." );
