...
//	/// </summary>
//	public class VirtualEvent : VirtualMember
//	{
...
//		public event Action<VirtualEvent> EventHandlerTypeChanged;
//		ReferenceField<Metadata.TypeInfo> _eventHandlerType = null;

//		////!!!!!может делегат?
//		////!!!!сбрасывать кеш
//		//Reference<List<MemberParameter>> parameters = new List<MemberParameter>();
//		//[Serialize]
//		//public virtual Reference<List<MemberParameter>> Parameters
//		//{
//		//	get
//		//	{
...
//		//	}
//		//}
//		//public event Action<Event> ParametersChanged;
...
//		{
//			VirtualEvent creator;

//			public EventImpl( object owner, string name, bool isStatic, Metadata.TypeInfo eventHandlerType, VirtualEvent creator )
...
//		public VirtualEvent()
//		{
//			ComponentsChanged += Event_ComponentsChanged;
//		}

//		void Event_ComponentsChanged( Component obj )
//		{
//			NeedUpdateCreatedMembers();
//		}
...
//				//var parameters = new List<MemberParameter>();
//				//foreach( var p in GetComponents<MemberParameter>( false, false ) )
//				//{
//				//	if( p.Enabled )
//				//		parameters.Add( p );
//				//}
