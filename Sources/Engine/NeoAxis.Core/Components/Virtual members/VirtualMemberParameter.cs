...
namespace NeoAxis
{
	...
	/// </summary>
	public class VirtualMemberParameter : Component
	{
		//Type
		...
		public event Action<VirtualMemberParameter> TypeChanged;
		...
		public event Action<VirtualMemberParameter> ByReferenceChanged;
		...
		//	}
		//}
		//public event Action<MemberParameter> InChanged;
		...
		public event Action<VirtualMemberParameter> OutputChanged;
		...
		public event Action<VirtualMemberParameter> ReturnValueChanged;
		...
		public event Action<VirtualMemberParameter> OptionalChanged;
		...
		public event Action<VirtualMemberParameter> DefaultValueChanged;
		...
		public virtual void NeedUpdateParent()
		{
			...
			var parent = Parent as VirtualMember;
			if( parent != null )
