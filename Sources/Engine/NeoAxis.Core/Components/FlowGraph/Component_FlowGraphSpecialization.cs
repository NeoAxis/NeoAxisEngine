...
namespace NeoAxis
{
	...
	/// </summary>
	public abstract class Component_FlowGraphSpecialization : Component
	{
		//!!!!
		/// <summary>
		/// Represents a drag and drop data for creation <see cref="Component_FlowGraphSpecialization"/> component.
		/// </summary>
