...
namespace NeoAxis
{
	...
	public abstract class FlowGraphNodeStyle : Component
	{
		...
		public abstract void RenderNodeReferences( FlowGraphEditor window, FlowGraphNode node,
		...
		public abstract void RenderNode( FlowGraphEditor window, FlowGraphNode node,
			RenderSelectionState selectionStateNode, RenderSelectionState selectionStateControlledObject, object mouseOverObject,
			FlowGraphNode.Representation.Connector referenceCreationSocketFrom, DragDropSetReferenceData dragDropSetReferenceData );
	...
	public class FlowGraphNodeStyle_Rectangle : FlowGraphNodeStyle
	{
		...
		public override void RenderNodeReferences( FlowGraphEditor window, FlowGraphNode node,
			Dictionary<Component, List<FlowGraphNode>> objectToNodes,
			Dictionary<FlowGraphNode.Representation.Item, RenderSelectionState> referenceSelectionStates,
			out FlowGraphNode.Representation.Item outMouseOverReference )
		{
		...
		public override void RenderNode( FlowGraphEditor window, FlowGraphNode node,
			RenderSelectionState selectionStateNode, RenderSelectionState selectionStateControlledObject, object mouseOverObject,
			FlowGraphNode.Representation.Connector referenceCreationSocketFrom, DragDropSetReferenceData dragDropSetReferenceData )
		{
			var representation = node.GetRepresentation();
		...
		public override object GetMouseOverObject( FlowGraphEditor window, FlowGraphNode node )
		{
			var representation = node.GetRepresentation();
			var viewport = window.ViewportControl.Viewport;
			var mouse = viewport.MousePosition;
		...
		public override bool IsIntersectsWithRectangle( FlowGraphEditor window, FlowGraphNode node, Rectangle rectInUnits )
		{
			//!!!!slowly?
