...
namespace NeoAxis
{
	...
	/// </summary>
	public class FlowGraphNode : Component
	{
		//!!!!Reference support?
		Vector2I position;
		//!!!!Reference support?
		...
		public event Action<FlowGraphNode> ControlledObjectChanged;
		...
		public event Action<FlowGraphNode> ModeChanged;


		//Style
		ReferenceField<FlowGraphNodeStyle> _style;
		/// <summary>
		/// The style of the node.
		/// </summary>
		[Serialize]
		public Reference<FlowGraphNodeStyle> Style
		{
			get
			{
				if( _style.BeginGet() )
		...
		public event Action<FlowGraphNode> StyleChanged;


		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

		/// <summary>
		/// Represents a cached data for visualization of <see cref="FlowGraphNode"/> in the editor.
		/// </summary>
		public class Representation
		{
			...
			/// <summary>
			/// Represents a connection slot of <see cref="FlowGraphNode"/>.
			/// </summary>
			...
			public Representation( FlowGraphNode owner )
			{
				this.owner = owner;
			}

			[Browsable( false )]
			public FlowGraphNode Owner
			{
				get { return owner; }
			}
		...
		//	public Settings_Old( FlowchartNode owner, string title, Pin[] inputs, Pin[] outputs, string[] buttons, string[] texts, string error )
		//	{
		//		this.owner = owner;
		//		this.title = title;
		//		this.inputs = inputs;
		...
		//	public Settings_Old( FlowchartNode owner, string title, Pin[] inputs, Pin[] outputs, string[] buttons, string[] texts )
		//	{
		//		this.owner = owner;
		//		this.title = title;
		//		this.inputs = inputs;
		...
		//	public Settings_Old( FlowchartNode owner, string title, Pin[] inputs, Pin[] outputs, string[] buttons )
		//	{
		//		this.owner = owner;
		//		this.title = title;
		//		this.inputs = inputs;
		...
		//	public Pin( FlowchartNode owner, string name, string type, string displayName = null )
		//	{
		//		this.owner = owner;
		//		this.name = name;
		//		this.type = type;
		...
		//	//!!!!было
		//	//public Link( FlowchartNode owner )
		//	//{
		//	//	this.owner = owner;
		//	//}
		...
		//!!!!!
		[Browsable( false )]
		public FlowGraph ParentFlowGraph
		{
			get { return Parent as FlowGraph; }
		}
		...
		//public void AddLink( string thisNodeOutputPin, FlowchartNode nodeTo, string pinTo )
		//{
		...
		//		Log.Fatal( "FlowchartNode: IsInternalParameterDefined: The name can't be empty." );
		...
		//{
		//	if( string.IsNullOrEmpty( name ) )
		//		Log.Fatal( "FlowchartNode: GetInternalParameter: The name can't be empty." );
		...
		//{
		//	if( string.IsNullOrEmpty( name ) )
		//		Log.Fatal( "FlowchartNode: SetInternalParameter: The name can't be empty." );
		...
		//{
		//	if( string.IsNullOrEmpty( name ) )
		//		Log.Fatal( "FlowchartNode: ResetInternalParameter: The name can't be empty." );
		...
		//!!!!было
		//public bool GetFirstValidOutputLink( string outputPinName, out Link link, out FlowchartNode inputNode, out int inputPinIndex )
		//{
		//	foreach( Link link2 in links )
		//	{
		//		if( link2.OutputName == outputPinName )
		//		{
		//			var inputNode2 = ParentFlowchart.GetComponent( link2.InputNode ) as FlowchartNode;
		//			if( inputNode2 != null )
		//			{
		...
		//{
		//	Log.Fatal( "FlowchartNode: Graph: ExecuteBegin: No implementation for \"{0}\".7", ToString() );
		//	return null;
		//}
		...
		//{
		//	Log.Fatal( "FlowchartNode: Graph: Node: ExecuteContinue: No implementation for \"{0}\".", ToString() );
		//	return null;
		//}
		...
		//{
		//	Log.Fatal( "FlowchartNode: Graph: Node: Calculate: No implementation for \"{0}\".", ToString() );
		//	return null;
		//}
