...
namespace NeoAxis
{
	...
	public class FlowGraphStyle_Default : FlowGraphStyle
	{
		...
		public override void RenderBackground( FlowGraphEditor window )
		{
		...
		public override void RenderForeground( FlowGraphEditor window )
		{
		...
		public virtual void RenderBackgroundGrid( FlowGraphEditor window )
		{
		...
		public virtual void RenderSpecializationName( FlowGraphEditor window )
		{
			var viewport = window.ViewportControl.Viewport;
		...
		public override void RenderReference( FlowGraphEditor window, Vector2 from, bool fromInput, Vector2 to, ColorValue color, out bool mouseOver )
		{
			var viewport = window.ViewportControl.Viewport;
