...
namespace NeoAxis
{
	...
	/// </summary>
	[EditorSettingsCell( typeof( Component_ComputeUsingThreads_SettingsCell ) )]
	[AddToResourcesWindow( @"Base\Common\Advanced\Compute Using Threads", 0 )]
	public class Component_ComputeUsingThreads : Component
	{
		bool started;
		...
		public event Action<Component_ComputeUsingThreads> ThreadCountChanged;
		...
		public event Action<Component_ComputeUsingThreads> AutoStartChanged;
		...
		{
			//public Component_ComputeUsingThreads Owner;
		...
		public delegate void BeforeComputeDelegate( Component_ComputeUsingThreads sender );
		...
		public delegate void ComputeThreadDelegate( Component_ComputeUsingThreads sender, int threadIndex );
		...
		public delegate void ComputeEndDelegate( Component_ComputeUsingThreads sender );
