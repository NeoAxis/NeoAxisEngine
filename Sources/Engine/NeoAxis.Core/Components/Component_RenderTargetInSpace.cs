...
namespace NeoAxis
{
	...
	/// </summary>
	//because sorting is added from ResourcesWindowItems.cs [Editor.AddToResourcesWindow( @"Base\Scene objects\Render Target In Space", 0 )]
	public class Component_RenderTargetInSpace : Component_MeshInSpace, IComponent_InteractiveObject
	{
		...
		public bool ObjectInteractionInputMessage( UIControl playScreen, IComponent_GameMode gameMode, InputMessage message )
		{
			if( createdViewport != null )
			{
