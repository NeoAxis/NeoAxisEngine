...
namespace NeoAxis
{
	...
	public class PipeType : Component
	{
		...
		public Reference<double> OutsideDiameter
		{
			...
			set { if( _outsideDiameter.BeginSet( this, ref value ) ) { try { OutsideDiameterChanged?.Invoke( this ); DataWasChanged(); } finally { _outsideDiameter.EndSet(); } } }
		}
		...
		//	set { if( _visibilityDistance.BeginSet( this, ref value ) ) { try { VisibilityDistanceChanged?.Invoke( this ); DataWasChanged(); } finally { _visibilityDistance.EndSet(); } } }
		//}
		...
		public Reference<Mesh> OpenHole
		{
			...
			set { if( _openHole.BeginSet( this, ref value ) ) { try { OpenHoleChanged?.Invoke( this ); DataWasChanged(); } finally { _openHole.EndSet(); } } }
		}
		...
		public Reference<Mesh> Cap
		{
			...
			set { if( _cap.BeginSet( this, ref value ) ) { try { CapChanged?.Invoke( this ); DataWasChanged(); } finally { _cap.EndSet(); } } }
		}
		...
		public Reference<Mesh> Socket
		{
			...
			set { if( _socket.BeginSet( this, ref value ) ) { try { SocketChanged?.Invoke( this ); DataWasChanged(); } finally { _socket.EndSet(); } } }
		}
		...
		public Reference<Mesh> Holder
		{
			...
			set { if( _holder.BeginSet( this, ref value ) ) { try { HolderChanged?.Invoke( this ); DataWasChanged(); } finally { _holder.EndSet(); } } }
		}
		...
		public Reference<Mesh> Elbow90
		{
			...
			set { if( _elbow90.BeginSet( this, ref value ) ) { try { Elbow90Changed?.Invoke( this ); DataWasChanged(); } finally { _elbow90.EndSet(); } } }
		}
		...
		//	set { if( _elbow135.BeginSet( this, ref value ) ) { try { Elbow135Changed?.Invoke( this ); DataWasChanged(); } finally { _elbow135.EndSet(); } } }
		//}
		...
		//	set { if( _tee45.BeginSet( this, ref value ) ) { try { Tee45Changed?.Invoke( this ); DataWasChanged(); } finally { _tee45.EndSet(); } } }
		//}
		...
		public Reference<Mesh> Tee90
		{
			...
			set { if( _tee90.BeginSet( this, ref value ) ) { try { Tee90Changed?.Invoke( this ); DataWasChanged(); } finally { _tee90.EndSet(); } } }
		}
		...
		public Reference<Mesh> Cross
		{
			...
			set { if( _cross.BeginSet( this, ref value ) ) { try { CrossChanged?.Invoke( this ); DataWasChanged(); } finally { _cross.EndSet(); } } }
		}
