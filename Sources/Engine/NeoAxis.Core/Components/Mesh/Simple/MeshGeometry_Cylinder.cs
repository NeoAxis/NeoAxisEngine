...
namespace NeoAxis
{
	...
	/// </summary>
	public class MeshGeometry_Cylinder : MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<MeshGeometry_Cylinder> AxisChanged;
		...
		public event Action<MeshGeometry_Cylinder> RadiusChanged;
		...
		public event Action<MeshGeometry_Cylinder> HeightChanged;
		...
		public event Action<MeshGeometry_Cylinder> SegmentsChanged;
		...
		public event Action<MeshGeometry_Cylinder> InsideOutChanged;
