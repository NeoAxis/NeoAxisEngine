...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Sphere : Component_MeshGeometry_Procedural
	{
		...
		public event Action<Component_MeshGeometry_Sphere> SphereTypeChanged;
		...
		public event Action<Component_MeshGeometry_Sphere> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Sphere> SegmentsHorizontalChanged;
		...
		public event Action<Component_MeshGeometry_Sphere> SegmentsVerticalChanged;
		...
		public event Action<Component_MeshGeometry_Sphere> SubdivisionsChanged;
		...
		public event Action<Component_MeshGeometry_Sphere> InsideOutChanged;
