...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Torus : Component_MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<Component_MeshGeometry_Torus> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Torus> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Torus> SegmentsChanged;
		...
		public event Action<Component_MeshGeometry_Torus> CircumferenceChanged;
		...
		public Reference<double> TubeRadius
		{
			...
			set
			{
				if( value < 0 )
					value = new Reference<double>( 0, value.GetByReference );
				if( _tubeRadius.BeginSet( ref value ) )
				{
					try
					{
		...
		public event Action<Component_MeshGeometry_Torus> TubeRadiusChanged;
		...
		public Reference<int> TubeSegments
		{
			...
			set
			{
				if( value < 3 )
					value = new Reference<int>( 3, value.GetByReference );
				if( _tubeSegments.BeginSet( ref value ) )
				{
					try
					{
		...
		public event Action<Component_MeshGeometry_Torus> TubeSegmentsChanged;
		...
		public Reference<Degree> TubeCircumference
		{
			...
			set
			{
				...
				if( value.Value > 360 )
					value = new Reference<Degree>( 360, value.GetByReference );
				if( _tubeCircumference.BeginSet( ref value ) )
				{
					try
					{
		...
		public event Action<Component_MeshGeometry_Torus> TubeCircumferenceChanged;
		...
		//public event Action<Component_MeshGeometry_Torus> SmoothChanged;
		...
		public event Action<Component_MeshGeometry_Torus> InsideOutChanged;
