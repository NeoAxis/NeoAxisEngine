...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Capsule : Component_MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<Component_MeshGeometry_Capsule> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Capsule> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Capsule> HeightChanged;
		...
		public event Action<Component_MeshGeometry_Capsule> SegmentsHorizontalChanged;
		...
		public event Action<Component_MeshGeometry_Capsule> SegmentsVerticalChanged;
		...
		public event Action<Component_MeshGeometry_Capsule> InsideOutChanged;
