...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Door : Component_MeshGeometry_Procedural
	{
		//!!!!дескрипшены
		...
		public event Action<Component_MeshGeometry_Door> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Door> WidthChanged;
		...
		public event Action<Component_MeshGeometry_Door> HeightChanged;
		...
		public event Action<Component_MeshGeometry_Door> DepthChanged;
		...
		public Reference<double> DoorWidth
		{
			...
			set
			{
				if( value < 0 )
					value = new Reference<double>( 0, value.GetByReference );
				if( _doorWidth.BeginSet( ref value ) )
				{
					try
					{
		...
		public event Action<Component_MeshGeometry_Door> DoorWidthChanged;
		...
		public Reference<double> DoorHeight
		{
			...
			set
			{
				if( value < 0 )
					value = new Reference<double>( 0, value.GetByReference );
				if( _doorHeight.BeginSet( ref value ) )
				{
					try
					{
		...
		public event Action<Component_MeshGeometry_Door> DoorHeightChanged;
		...
		public event Action<Component_MeshGeometry_Door> InsideOutChanged;
