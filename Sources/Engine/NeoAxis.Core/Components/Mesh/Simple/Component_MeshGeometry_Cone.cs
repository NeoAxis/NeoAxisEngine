...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Cone : Component_MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<Component_MeshGeometry_Cone> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Cone> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Cone> HeightChanged;
		...
		public event Action<Component_MeshGeometry_Cone> SegmentsChanged;
		...
		public event Action<Component_MeshGeometry_Cone> InsideOutChanged;
