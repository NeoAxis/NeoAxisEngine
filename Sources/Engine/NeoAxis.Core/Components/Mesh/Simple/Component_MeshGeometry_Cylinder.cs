...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Cylinder : Component_MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<Component_MeshGeometry_Cylinder> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Cylinder> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Cylinder> HeightChanged;
		...
		public event Action<Component_MeshGeometry_Cylinder> SegmentsChanged;
		...
		public event Action<Component_MeshGeometry_Cylinder> InsideOutChanged;
