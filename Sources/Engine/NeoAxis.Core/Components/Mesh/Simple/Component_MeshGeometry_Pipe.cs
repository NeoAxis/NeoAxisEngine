...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Pipe : Component_MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<Component_MeshGeometry_Pipe> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Pipe> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Pipe> HeightChanged;
		...
		public event Action<Component_MeshGeometry_Pipe> ThicknessChanged;
		...
		public event Action<Component_MeshGeometry_Pipe> SegmentsChanged;
		...
		public Reference<int> SegmentsHeight
		{
			...
			set
			{
				...
				if( _segmentsHeight.BeginSet( ref value ) )
				{
					try
					{
		...
		public event Action<Component_MeshGeometry_Pipe> SegmentsHeightChanged;
		...
		public event Action<Component_MeshGeometry_Pipe> InsideOutChanged;
