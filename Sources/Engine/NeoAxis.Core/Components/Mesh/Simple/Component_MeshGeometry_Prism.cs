...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MeshGeometry_Prism : Component_MeshGeometry_Procedural
	{
		/// <summary>
		...
		public event Action<Component_MeshGeometry_Prism> AxisChanged;
		...
		public event Action<Component_MeshGeometry_Prism> RadiusChanged;
		...
		public event Action<Component_MeshGeometry_Prism> HeightChanged;
		...
		public event Action<Component_MeshGeometry_Prism> SegmentsChanged;
		...
		public event Action<Component_MeshGeometry_Prism> InsideOutChanged;
