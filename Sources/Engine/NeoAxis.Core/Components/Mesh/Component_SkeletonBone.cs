...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_SkeletonBone : Component
	{
		Component_Skeleton getCachedBoneIndex_Skeleton;
		...
		public event Action<Component_SkeletonBone> TransformChanged;
		...
		//}
		//public event Action<Component_Bone> OffsetMatrixChanged;
		//ReferenceField<Mat4F> _offsetMatrix;

		//!!!!надо ли
		//[Browsable( false )]
		//public Component_Bone ParentNode
		//{
		//	get { return Parent as Component_Bone; }
		//}
		...
		//}
		//public event Action<Component_Bone> BoneIndexChanged;
