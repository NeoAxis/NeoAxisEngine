...
namespace NeoAxis
{
	...
	[EditorSettingsCell( typeof( Component_CSharpScript_SettingsCell ) )]
	[EditorDocumentWindow( "NeoAxis.Editor.Component_CSharpScript_DocumentWindow" )]
	[EditorPreviewControl( "NeoAxis.Editor.Component_CSharpScript_PreviewControl" )]
	public class Component_CSharpScript : Component, IFlowGraphRepresentationData, IFlowExecutionComponent
	{
		//!!!!is not used
...
";
		...
		public event Action<Component_CSharpScript> CodeChanged;
		...
		//}
		//public event Action<Component_Script> AddMembersToParentChanged;
		...
		public event Action<Component_CSharpScript> FlowSupportChanged;
		...
		public event Action<Component_CSharpScript> ExitChanged;
		...
		internal class PropertyImpl : Metadata.Property
		{
			...
			{
				var script = (Component_CSharpScript)Owner;
