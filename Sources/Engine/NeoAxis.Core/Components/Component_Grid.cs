...
namespace NeoAxis
{
	...
	/// </summary>
	[Editor.AddToResourcesWindow( @"Base\Scene objects\Additional\Grid", 0 )]
	public class Component_Grid : Component_ObjectInSpace
	{
		/// <summary>
		...
		public event Action<Component_Grid> StepChanged;
		...
		public event Action<Component_Grid> ThickStepChanged;
		...
		public event Action<Component_Grid> ColorChanged;
		...
		public event Action<Component_Grid> ColorInvisibleChanged;
		...
		public event Action<Component_Grid> VisibilityDistanceChanged;
		...
		public event Action<Component_Grid> DisplayInSimulationChanged;
