...
//{
//	public class Component_CurveInSpacePoint_SettingsCell : SettingsCellProcedureUI
//	{
...
//		{
//			return EditorLocalization.Translate( "Component_CurveInSpacePoint_SettingsCell", text );
//		}
...
//		public Component_CurveInSpacePoint[] Points
//		{
//			get { return GetObjects<Component_CurveInSpacePoint>(); }
//		}
...
//			{
//				var handleCount = point.GetComponents<Component_CurveInSpacePointHandle>().Length;
//				if( handleCount == 0 )
//					allowAdd = true;
//				if( handleCount != 0 )
//					allowRemove = true;
