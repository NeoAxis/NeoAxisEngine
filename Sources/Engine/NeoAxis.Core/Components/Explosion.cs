...
//			set { if( _impulse.BeginSet( this, ref value ) ) { try { ImpulseChanged?.Invoke( this ); } finally { _impulse.EndSet(); } } }
//		}
...
//			set { if( _damage.BeginSet( this, ref value ) ) { try { DamageChanged?.Invoke( this ); } finally { _damage.EndSet(); } } }
//		}
...
//		public event Action<Explosion> WhoFiredChanged;
...
//		//	set { if( _originalCreator.BeginSet( this, ref value ) ) { try { OriginalCreatorChanged?.Invoke( this ); } finally { _originalCreator.EndSet(); } } }
//		//}
...
//						if( body != null && body.MotionType.Value == PhysicsMotionType.Dynamic )
//						{
...
//					{
//						var writer = BeginNetworkMessageToEveryone( "SoundExplode" );
