...
namespace NeoAxis
{
	...
	public class Import3D : Component
	{
		...
		public bool IsNeedUpdate()
		{
			if( EngineApp.IsEditor )
			{
				if( Parent == null )
				{
					...
					//!!!!хот€ провер€ть тоже долго ведь. варианты: в дейплойменте сорцы удалить (сделать пустые файлы)
				}
			}
			return false;
		}
		...
		//				//!!!!может дл€ генерации лодов применить VerticesExtractStandardVertex. или еще где-то
