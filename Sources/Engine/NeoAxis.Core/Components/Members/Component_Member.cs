...
namespace NeoAxis
{
	...
	/// </summary>
	public abstract class Component_Member : Component
	{
		...
		public event Action<Component_Member> DescriptionChanged;
		...
		public event Action<Component_Member> StaticChanged;
