...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_MethodBodyEnd : Component, IFlowGraphRepresentationData
	{
		...
		public event Action<Component_MethodBodyEnd> BodyChanged;
		...
		internal class PropertyImpl : Metadata.Property
		{
			...
			public override object GetValue( object obj, object[] index )
			{
				...
				//always obj == Owner
				var c = (Component_MethodBodyEnd)obj;
