...
namespace NeoAxis
{
	...
	public class Constraint2D_Prismatic : Constraint2D
	{
		/// <summary>
		...
		public event Action<Constraint2D_Prismatic> LimitEnabledChanged;
		...
		public event Action<Constraint2D_Prismatic> LimitLowChanged;
		...
		public event Action<Constraint2D_Prismatic> LimitHighChanged;
		...
		public event Action<Constraint2D_Prismatic> MotorEnabledChanged;
		...
		public event Action<Constraint2D_Prismatic> MotorSpeedChanged;
		...
		public event Action<Constraint2D_Prismatic> MotorMaxForceChanged;
