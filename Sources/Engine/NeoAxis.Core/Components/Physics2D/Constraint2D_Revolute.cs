...
namespace NeoAxis
{
	...
	public class Constraint2D_Revolute : Constraint2D
	{
		/// <summary>
		...
		public event Action<Constraint2D_Revolute> LimitEnabledChanged;
		...
		public event Action<Constraint2D_Revolute> LimitLowChanged;
		...
		public event Action<Constraint2D_Revolute> LimitHighChanged;
		...
		public event Action<Constraint2D_Revolute> MotorEnabledChanged;
		...
		public event Action<Constraint2D_Revolute> MotorSpeedChanged;
		...
		public Reference<double> MotorMaxTorque
		{
			...
			set
			{
				if( _motorMaxTorque.BeginSet( this, ref value ) )
				{
					try
					{
		...
		public event Action<Constraint2D_Revolute> MotorMaxTorqueChanged;
