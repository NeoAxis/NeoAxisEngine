...
namespace NeoAxis
{
	...
	/// </summary>
	public abstract class CollisionShape2D : Component
	{
		...
		public event Action<CollisionShape2D> TransformRelativeToParentChanged;
		...
		public event Action<CollisionShape2D> FrictionChanged;
		...
		public event Action<CollisionShape2D> RestitutionChanged;
		...
		public event Action<CollisionShape2D> CollisionCategoriesChanged;
		...
		public event Action<CollisionShape2D> CollidesWithChanged;
		...
		public event Action<CollisionShape2D> CollisionGroupChanged;
		...
		static RigidBody2D GetRigidBody( Component start )
		{
			var p = start;
			while( p != null )
			{
				var body = p as RigidBody2D;
				if( body != null )
					return body;
				p = p.Parent;
			}
