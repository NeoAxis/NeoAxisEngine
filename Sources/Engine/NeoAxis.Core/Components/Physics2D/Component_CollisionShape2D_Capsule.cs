...
namespace NeoAxis
{
	...
	public class Component_CollisionShape2D_Capsule : Component_CollisionShape2D
	{
		/// <summary>
		...
		public event Action<Component_CollisionShape2D_Capsule> AxisChanged;
		...
		public event Action<Component_CollisionShape2D_Capsule> RadiusChanged;
		...
		public event Action<Component_CollisionShape2D_Capsule> HeightChanged;
		...
		public event Action<Component_CollisionShape2D_Capsule> EdgesChanged;
