...
namespace NeoAxis
{
	...
	public class Component_Constraint2D_Weld : Component_Constraint2D
	{
		/// <summary>
		...
		public event Action<Component_Constraint2D_Weld> FrequencyChanged;
		...
		public event Action<Component_Constraint2D_Weld> DampingRatioChanged;
