...
namespace NeoAxis
{
	...
	public class Component_Constraint2D_Distance : Component_Constraint2D
	{
		/// <summary>
		...
		public event Action<Component_Constraint2D_Distance> FrequencyChanged;
		...
		public event Action<Component_Constraint2D_Distance> DampingRatioChanged;
