...
namespace NeoAxis
{
	...
	public class Component_CollisionShape2D_Mesh : Component_CollisionShape2D
	{
		...
		public event Action<Component_CollisionShape2D_Mesh> MeshChanged;
		...
		public event Action<Component_CollisionShape2D_Mesh> VerticesChanged;
		...
		public event Action<Component_CollisionShape2D_Mesh> IndicesChanged;
		...
		public event Action<Component_CollisionShape2D_Mesh> ShapeTypeChanged;
