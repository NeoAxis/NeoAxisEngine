...
namespace NeoAxis
{
	...
	/// </summary>
	public abstract class Component_Constraint2D : Component_ObjectInSpace, Component_IPhysicalObject
	{
		bool created;
		Component_PhysicalBody2D creationBodyA;
		Component_PhysicalBody2D creationBodyB;
		...
		public Reference<Component_PhysicalBody2D> BodyA
		{
		...
		public event Action<Component_Constraint2D> BodyAChanged;
		ReferenceField<Component_PhysicalBody2D> _bodyA;

		/// <summary>
		/// The second physical body used.
		/// </summary>
		[Category( "Constraint 2D" )]
		public Reference<Component_PhysicalBody2D> BodyB
		{
		...
		public event Action<Component_Constraint2D> BodyBChanged;
		ReferenceField<Component_PhysicalBody2D> _bodyB;
		...
		public event Action<Component_Constraint2D> CollisionsBetweenLinkedBodiesChanged;
		...
		public event Action<Component_Constraint2D> BreakpointChanged;
