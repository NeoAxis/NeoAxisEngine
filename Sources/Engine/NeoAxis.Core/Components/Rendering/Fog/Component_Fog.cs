...
namespace NeoAxis
{
	...
	public class Component_Fog : Component
	{
		...
		public event Action<Component_Fog> ModeChanged;
		...
		public event Action<Component_Fog> ColorChanged;
		...
		public Reference<double> StartDistance
		{
			...
			set { if( _startDistance.BeginSet( ref value ) ) { try { StartDistanceChanged?.Invoke( this ); } finally { _startDistance.EndSet(); } } }
		}
		/// <summary>Occurs when the <see cref="StartDistance"/> property value changes.</summary>
		public event Action<Component_Fog> StartDistanceChanged;
		...
		public event Action<Component_Fog> DensityChanged;
		...
		public event Action<Component_Fog> HeightChanged;
		...
		public Reference<double> HeightScale
		{
			...
			set { if( _heightScale.BeginSet( ref value ) ) { try { HeightScaleChanged?.Invoke( this ); } finally { _heightScale.EndSet(); } } }
		}
		/// <summary>Occurs when the <see cref="HeightScale"/> property value changes.</summary>
		public event Action<Component_Fog> HeightScaleChanged;
		...
		public Reference<double> AffectBackground
		{
			...
			set { if( _affectBackground.BeginSet( ref value ) ) { try { AffectBackgroundChanged?.Invoke( this ); } finally { _affectBackground.EndSet(); } } }
		}
		/// <summary>Occurs when the <see cref="AffectBackground"/> property value changes.</summary>
		public event Action<Component_Fog> AffectBackgroundChanged;
