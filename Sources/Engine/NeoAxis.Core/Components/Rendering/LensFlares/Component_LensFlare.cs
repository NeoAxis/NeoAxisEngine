...
namespace NeoAxis
{
	...
	/// One lens flare.
	/// </summary>
	public class Component_LensFlare : Component
	{
		/// <summary>
		...
		public event Action<Component_LensFlare> ImageChanged;
		...
		public event Action<Component_LensFlare> BlendingChanged;
		...
		public event Action<Component_LensFlare> ColorChanged;
		...
		public event Action<Component_LensFlare> PositionChanged;
		...
		public event Action<Component_LensFlare> SizeChanged;
