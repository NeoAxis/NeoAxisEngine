...
namespace NeoAxis
{
	...
	public class Skybox : Sky
	{
		...
		public event Action<Skybox> CubemapChanged;
		...
		//	}
		//}
		//public event Action<Skybox> CubemapPositiveXChanged;
		...
		//	}
		//}
		//public event Action<Skybox> CubemapNegativeXChanged;
		...
		//	}
		//}
		//public event Action<Skybox> CubemapPositiveYChanged;
		...
		//	}
		//}
		//public event Action<Skybox> CubemapNegativeYChanged;
		...
		//	}
		//}
		//public event Action<Skybox> CubemapPositiveZChanged;
		...
		//	}
		//}
		//public event Action<Skybox> CubemapNegativeZChanged;
		...
		public event Action<Skybox> RotationChanged;
		...
		public event Action<Skybox> StretchChanged;
		...
		public event Action<Skybox> MultiplierChanged;
		...
		public event Action<Skybox> AffectLightingChanged;
		...
		public event Action<Skybox> LightingCubemapChanged;
		...
		public event Action<Skybox> LightingCubemapRotationChanged;
		...
		public event Action<Skybox> LightingMultiplierChanged;
		...
		public event Action<Skybox> AlwaysUseProcessedCubemapChanged;
		...
		public event Action<Skybox> AllowProcessEnvironmentCubemapChanged;
		...
		static GpuMaterialPass GetMaterialPass( bool cube )
		{
			if( cube && materialPassCube == null || !cube && materialPass2D == null )
			{
				...
				GpuProgram vertexProgram = GpuProgramManager.GetProgram( $"Skybox_Vertex_", GpuProgramType.Vertex,
					$@"Base\Shaders\Skybox_vs.sc", generalDefines, true, out var error );
				...
				GpuProgram fragmentProgram = GpuProgramManager.GetProgram( $"Skybox_Fragment_", GpuProgramType.Fragment,
					$@"Base\Shaders\Skybox_fs.sc", generalDefines, true, out error );
				if( !string.IsNullOrEmpty( error ) )
				{
					Log.Warning( error );
					return null;
		...
		public override bool GetEnvironmentTextureData( out RenderingPipeline.EnvironmentTextureData environmentCubemap, out RenderingPipeline.EnvironmentIrradianceData irradianceHarmonics )
		{
