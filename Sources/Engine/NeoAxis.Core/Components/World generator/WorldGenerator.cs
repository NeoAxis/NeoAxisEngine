...
namespace NeoAxis
{
	...
	public class WorldGenerator : Component
	{
		...
		public Reference<Range> HeightRange
		{
			...
			set { if( _heightRange.BeginSet( this, ref value ) ) { try { HeightRangeChanged?.Invoke( this ); } finally { _heightRange.EndSet(); } } }
		}
		...
		public Reference<double> Curvature
		{
			...
			set { if( _curvature.BeginSet( this, ref value ) ) { try { CurvatureChanged?.Invoke( this ); } finally { _curvature.EndSet(); } } }
		}
		...
		public Reference<Material> BaseMaterial
		{
			...
			set { if( _baseMaterial.BeginSet( this, ref value ) ) { try { BaseMaterialChanged?.Invoke( this ); } finally { _baseMaterial.EndSet(); } } }
		}
		...
		public Reference<ColorValue> BaseMaterialColor
		{
			...
			set { if( _baseMaterialColor.BeginSet( this, ref value ) ) { try { BaseMaterialColorChanged?.Invoke( this ); } finally { _baseMaterialColor.EndSet(); } } }
		}
		...
		public Reference<Surface> BaseSurface
		{
			...
			set { if( _baseSurface.BeginSet( this, ref value ) ) { try { BaseSurfaceChanged?.Invoke( this ); } finally { _baseSurface.EndSet(); } } }
		}
		...
		public Reference<double> BaseSurfacePaintFactor
		{
			...
			set { if( _baseSurfacePaintFactor.BeginSet( this, ref value ) ) { try { BaseSurfacePaintFactorChanged?.Invoke( this ); } finally { _baseSurfacePaintFactor.EndSet(); } } }
		}
		...
		public Reference<ColorValue> BaseSurfaceColor
		{
			...
			set { if( _baseSurfaceColor.BeginSet( this, ref value ) ) { try { BaseSurfaceColorChanged?.Invoke( this ); } finally { _baseSurfaceColor.EndSet(); } } }
		}
		...
		public Reference<bool> BaseSurfaceCollision
		{
			...
			set { if( _baseSurfaceCollision.BeginSet( this, ref value ) ) { try { BaseSurfaceCollisionChanged?.Invoke( this ); } finally { _baseSurfaceCollision.EndSet(); } } }
		}
		...
		public Reference<Surface> Surface1
		{
			...
			set { if( _surface1.BeginSet( this, ref value ) ) { try { Surface1Changed?.Invoke( this ); } finally { _surface1.EndSet(); } } }
		}
		...
		public Reference<double> Surface1PaintFactor
		{
			...
			set { if( _surface1PaintFactor.BeginSet( this, ref value ) ) { try { Surface1PaintFactorChanged?.Invoke( this ); } finally { _surface1PaintFactor.EndSet(); } } }
		}
		...
		public Reference<double> Surface1Distribution
		{
			...
			set { if( _surface1Distribution.BeginSet( this, ref value ) ) { try { Surface1DistributionChanged?.Invoke( this ); } finally { _surface1Distribution.EndSet(); } } }
		}
		...
		public Reference<ColorValue> Surface1Color
		{
			...
			set { if( _surface1Color.BeginSet( this, ref value ) ) { try { Surface1ColorChanged?.Invoke( this ); } finally { _surface1Color.EndSet(); } } }
		}
		...
		public Reference<bool> Surface1Collision
		{
			...
			set { if( _surface1Collision.BeginSet( this, ref value ) ) { try { Surface1CollisionChanged?.Invoke( this ); } finally { _surface1Collision.EndSet(); } } }
		}
		...
		public Reference<Surface> Surface2
		{
			...
			set { if( _surface2.BeginSet( this, ref value ) ) { try { Surface2Changed?.Invoke( this ); } finally { _surface2.EndSet(); } } }
		}
		...
		public Reference<ColorValue> Surface2Color
		{
			...
			set { if( _surface2Color.BeginSet( this, ref value ) ) { try { Surface2ColorChanged?.Invoke( this ); } finally { _surface2Color.EndSet(); } } }
		}
		...
		public Reference<double> Surface2PaintFactor
		{
			...
			set { if( _surface2PaintFactor.BeginSet( this, ref value ) ) { try { Surface2PaintFactorChanged?.Invoke( this ); } finally { _surface2PaintFactor.EndSet(); } } }
		}
		...
		public Reference<double> Surface2Distribution
		{
			...
			set { if( _surface2Distribution.BeginSet( this, ref value ) ) { try { Surface2DistributionChanged?.Invoke( this ); } finally { _surface2Distribution.EndSet(); } } }
		}
		...
		public Reference<bool> Surface2Collision
		{
			...
			set { if( _surface2Collision.BeginSet( this, ref value ) ) { try { Surface2CollisionChanged?.Invoke( this ); } finally { _surface2Collision.EndSet(); } } }
		}
		...
		public Reference<Surface> Surface3
		{
			...
			set { if( _surface3.BeginSet( this, ref value ) ) { try { Surface3Changed?.Invoke( this ); } finally { _surface3.EndSet(); } } }
		}
		...
		public Reference<ColorValue> Surface3Color
		{
			...
			set { if( _surface3Color.BeginSet( this, ref value ) ) { try { Surface3ColorChanged?.Invoke( this ); } finally { _surface3Color.EndSet(); } } }
		}
		...
		public Reference<double> Surface3PaintFactor
		{
			...
			set { if( _surface3PaintFactor.BeginSet( this, ref value ) ) { try { Surface3PaintFactorChanged?.Invoke( this ); } finally { _surface3PaintFactor.EndSet(); } } }
		}
		...
		public Reference<double> Surface3Distribution
		{
			...
			set { if( _surface3Distribution.BeginSet( this, ref value ) ) { try { Surface3DistributionChanged?.Invoke( this ); } finally { _surface3Distribution.EndSet(); } } }
		}
		...
		public Reference<bool> Surface3Collision
		{
			...
			set { if( _surface3Collision.BeginSet( this, ref value ) ) { try { Surface3CollisionChanged?.Invoke( this ); } finally { _surface3Collision.EndSet(); } } }
		}
		...
		public Reference<Surface> Surface4
		{
			...
			set { if( _surface4.BeginSet( this, ref value ) ) { try { Surface4Changed?.Invoke( this ); } finally { _surface4.EndSet(); } } }
		}
		...
		public Reference<ColorValue> Surface4Color
		{
			...
			set { if( _surface4Color.BeginSet( this, ref value ) ) { try { Surface4ColorChanged?.Invoke( this ); } finally { _surface4Color.EndSet(); } } }
		}
		...
		public Reference<double> Surface4PaintFactor
		{
			...
			set { if( _surface4PaintFactor.BeginSet( this, ref value ) ) { try { Surface4PaintFactorChanged?.Invoke( this ); } finally { _surface4PaintFactor.EndSet(); } } }
		}
		...
		public Reference<double> Surface4Distribution
		{
			...
			set { if( _surface4Distribution.BeginSet( this, ref value ) ) { try { Surface4DistributionChanged?.Invoke( this ); } finally { _surface4Distribution.EndSet(); } } }
		}
		...
		public Reference<bool> Surface4Collision
		{
			...
			set { if( _surface4Collision.BeginSet( this, ref value ) ) { try { Surface4CollisionChanged?.Invoke( this ); } finally { _surface4Collision.EndSet(); } } }
		}
		...
		public Reference<Surface> Surface5
		{
			...
			set { if( _surface5.BeginSet( this, ref value ) ) { try { Surface5Changed?.Invoke( this ); } finally { _surface5.EndSet(); } } }
		}
		...
		public Reference<ColorValue> Surface5Color
		{
			...
			set { if( _surface5Color.BeginSet( this, ref value ) ) { try { Surface5ColorChanged?.Invoke( this ); } finally { _surface5Color.EndSet(); } } }
		}
		...
		public Reference<double> Surface5PaintFactor
		{
			...
			set { if( _surface5PaintFactor.BeginSet( this, ref value ) ) { try { Surface5PaintFactorChanged?.Invoke( this ); } finally { _surface5PaintFactor.EndSet(); } } }
		}
		...
		public Reference<double> Surface5Distribution
		{
			...
			set { if( _surface5Distribution.BeginSet( this, ref value ) ) { try { Surface5DistributionChanged?.Invoke( this ); } finally { _surface5Distribution.EndSet(); } } }
		}
		...
		public Reference<bool> Surface5Collision
		{
			...
			set { if( _surface5Collision.BeginSet( this, ref value ) ) { try { Surface5CollisionChanged?.Invoke( this ); } finally { _surface5Collision.EndSet(); } } }
		}
		...
		public Reference<Surface> Surface6
		{
			...
			set { if( _surface6.BeginSet( this, ref value ) ) { try { Surface6Changed?.Invoke( this ); } finally { _surface6.EndSet(); } } }
		}
		...
		public Reference<ColorValue> Surface6Color
		{
			...
			set { if( _surface6Color.BeginSet( this, ref value ) ) { try { Surface6ColorChanged?.Invoke( this ); } finally { _surface6Color.EndSet(); } } }
		}
		...
		public Reference<double> Surface6PaintFactor
		{
			...
			set { if( _surface6PaintFactor.BeginSet( this, ref value ) ) { try { Surface6PaintFactorChanged?.Invoke( this ); } finally { _surface6PaintFactor.EndSet(); } } }
		}
		...
		public Reference<double> Surface6Distribution
		{
			...
			set { if( _surface6Distribution.BeginSet( this, ref value ) ) { try { Surface6DistributionChanged?.Invoke( this ); } finally { _surface6Distribution.EndSet(); } } }
		}
		...
		public Reference<bool> Surface6Collision
		{
			...
			set { if( _surface6Collision.BeginSet( this, ref value ) ) { try { Surface6CollisionChanged?.Invoke( this ); } finally { _surface6Collision.EndSet(); } } }
		}
		...
		public Reference<bool> LeveledArea
		{
			...
			set { if( _leveledArea.BeginSet( this, ref value ) ) { try { LeveledAreaChanged?.Invoke( this ); } finally { _leveledArea.EndSet(); } } }
		}
		...
		public Reference<Vector2> LeveledAreaSize
		{
			...
			set { if( _leveledAreaSize.BeginSet( this, ref value ) ) { try { LeveledAreaSizeChanged?.Invoke( this ); } finally { _leveledAreaSize.EndSet(); } } }
		}
		...
		public Reference<LeveledAreaShapeEnum> LeveledAreaShape
		{
			...
			set { if( _leveledAreaShape.BeginSet( this, ref value ) ) { try { LeveledAreaShapeChanged?.Invoke( this ); } finally { _leveledAreaShape.EndSet(); } } }
		}
		...
		public Reference<double> LeveledAreaHeight
		{
			...
			set { if( _leveledAreaHeight.BeginSet( this, ref value ) ) { try { LeveledAreaHeightChanged?.Invoke( this ); } finally { _leveledAreaHeight.EndSet(); } } }
		}
		...
		public Reference<Material> LeveledAreaMaterial
		{
			...
			set { if( _leveledAreaMaterial.BeginSet( this, ref value ) ) { try { LeveledAreaMaterialChanged?.Invoke( this ); } finally { _leveledAreaMaterial.EndSet(); } } }
		}
		...
		public Reference<int> Seed
		{
			...
			set { if( _seed.BeginSet( this, ref value ) ) { try { SeedChanged?.Invoke( this ); } finally { _seed.EndSet(); } } }
		}
		...
		public Reference<bool> AddLayersWithObjects
		{
			...
			set { if( _addLayersWithObjects.BeginSet( this, ref value ) ) { try { AddLayersWithObjectsChanged?.Invoke( this ); } finally { _addLayersWithObjects.EndSet(); } } }
		}
		...
		public delegate void GenerateOverrideDelegate( WorldGenerator sender, Editor.IDocumentInstance document, ref bool handled );
		public event GenerateOverrideDelegate GenerateOverride;

		public virtual void Generate( Editor.IDocumentInstance document )
		{
			var handled = false;
