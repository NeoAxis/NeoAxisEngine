...
{
	/// <summary>
	/// A shape in the form of a sphere of a <see cref="ParticleEmitter">particle system emitter</see>.
	/// </summary>
	[NewObjectDefaultName( "Sphere Shape" )]
	public class ParticleEmitterShape_Sphere : ParticleEmitterShape
	{
		/// <summary>
