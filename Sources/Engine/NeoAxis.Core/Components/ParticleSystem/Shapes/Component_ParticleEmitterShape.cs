...
{
	/// <summary>
	/// Base class of a shape of a <see cref="Component_ParticleEmitter">particle system emitter</see>.
	/// </summary>
	[NewObjectDefaultName( "Shape" )]
	public class Component_ParticleEmitterShape : Component_ParticleModule
	{
		/// <summary>
		...
		public event Action<Component_ParticleEmitterShape> TransformChanged;
		...
		public event Action<Component_ParticleEmitterShape> ProbabilityChanged;
		...
		public delegate void RenderDelegate( Component_ParticleEmitterShape sender, Viewport viewport, Transform bodyTransform, bool solid, ref int verticesRendered );
		...
		protected virtual void OnGetLocalPosition( Random random, out Vector3 value )
		{
			value = Vector3.Zero;
		}

		public delegate void GetLocalPositionDelegate( Component_ParticleEmitterShape sender, ref Vector3 value );
		public event GetLocalPositionDelegate GetLocalPosition;

		public void PerformGetLocalPosition( Random random, out Vector3 value )
		{
