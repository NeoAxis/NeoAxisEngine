...
{
	/// <summary>
	/// A shape in the form of a cylinder of a <see cref="ParticleEmitter">particle system emitter</see>.
	/// </summary>
	[NewObjectDefaultName( "Cylinder Shape" )]
	public class ParticleEmitterShape_Cylinder : ParticleEmitterShape
	{
		/// <summary>
		...
		public event Action<ParticleEmitterShape_Cylinder> RadiusChanged;
		...
		public event Action<ParticleEmitterShape_Cylinder> HeightChanged;
