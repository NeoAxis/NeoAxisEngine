...
{
	/// <summary>
	/// A source of new particles of a <see cref="ParticleSystem">particle system</see>.
	/// </summary>
	...
	public class ParticleEmitter : Component
	{
		...
		public event Action<ParticleEmitter> StartTimeChanged;
		...
		public event Action<ParticleEmitter> DurationChanged;
		...
		public event Action<ParticleEmitter> SpawnRateChanged;
		...
		public event Action<ParticleEmitter> SpawnCountChanged;
		...
		public event Action<ParticleEmitter> DispersionAngleChanged;
		...
		public event Action<ParticleEmitter> SpeedChanged;
		...
		public event Action<ParticleEmitter> RotationChanged;
		...
		public event Action<ParticleEmitter> AngularVelocityChanged;
		...
		public event Action<ParticleEmitter> LifetimeChanged;
		...
		public event Action<ParticleEmitter> SizeChanged;
		...
		public event Action<ParticleEmitter> GravityMultiplierChanged;
		...
		public event Action<ParticleEmitter> ColorChanged;
		...
		public sealed class SingleProperty : Metadata.IMetadataProvider, ICanParseFromAndConvertToString
		{
			...
			[Browsable( false )]
			public ParticleEmitter Owner { get; set; }
			...
			//[Cloneable( CloneType.Deep )]
			//public List<ParticleSystem.CurvePoint> Curve { get; set; } = new List<ParticleSystem.CurvePoint>();
		...
		{
			var particleSystem = Parent as ParticleSystem;
		...
		protected override void OnRemovedFromParent( Component oldParent )
		{
			...
			var system = oldParent.FindThisOrParent<ParticleSystem>();
			if( system != null )
