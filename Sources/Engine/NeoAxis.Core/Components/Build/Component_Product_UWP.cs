...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_Product_UWP : Component_Product
	{
		/// <summary>
		...
		public event Action<Component_Product_UWP> BuildPlatformChanged;
		...
		public event Action<Component_Product_UWP> PatchProjectFilesChanged;
		...
		public event Action<Component_Product_UWP> PackageDisplayNameChanged;
		...
		public event Action<Component_Product_UWP> PackageVersionChanged;
		...
		public event Action<Component_Product_UWP> PackagePublisherChanged;
		...
		//public event Action<Component_Product_UWP> PublisherCertificateFileOverrideChanged;
		...
		public event Action<Component_Product_UWP> PublisherDisplayNameChanged;
		...
		//public event Action<Component_Product_UWP> CreateAppxPackageChanged;
		...
		public event Action<Component_Product_UWP> AppDisplayNameChanged;
		...
		public event Action<Component_Product_UWP> AppDescriptionChanged;
		...
		public event Action<Component_Product_UWP> ApplicationIdChanged;
		...
		public event Action<Component_Product_UWP> EntryPointChanged;
