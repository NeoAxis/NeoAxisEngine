...
namespace NeoAxis
{
	...
	[EditorSettingsCell( typeof( Component_Product_SettingsCell ) )]
	public abstract class Component_Product : Component
	{
		...
		/// <summary>
		/// The list of folders to add from Assets folder. It is specified by the list, list items are separated by semicolon or by return. Example: "Base;Samples\Starter Content;Samples\Simple Game". When the value is empty, the entire Assets folder is included.
		/// </summary>
		[DefaultValue( "" )]
		[Category( "Files" )]
		...
		/// <summary>
		/// The list of folders to remove from Assets folder. It is specified by the list, list items are separated by semicolon or by return. Example: "Base\Models;Base\Environments".
		/// </summary>
		[DefaultValue( "" )]
		[Category( "Files" )]
		[Editor( typeof( HCItemTextBoxDropMultiline ), typeof( object ) )]
		public Reference<string> ExcludedAssets
		{
			get { if( _excludedAssets.BeginGet() ) ExcludedAssets = _excludedAssets.Get( this ); return _excludedAssets.value; }
			set { if( _excludedAssets.BeginSet( ref value ) ) { try { ExcludedAssetsChanged?.Invoke( this ); } finally { _excludedAssets.EndSet(); } } }
		}
		/// <summary>Occurs when the <see cref="ExcludedAssets"/> property value changes.</summary>
		public event Action<Component_Product> ExcludedAssetsChanged;
		ReferenceField<string> _excludedAssets = "";
