...
namespace NeoAxis
{
	...
	public class Component_Product_Android : Component_Product
	{
		...
		//public event Action<Component_Product_Android> BuildPlatformChanged;
		...
		public event Action<Component_Product_Android> CompressDataChanged;
		...
		//public event Action<Component_Product_Android> PatchProjectFilesChanged;
		...
		//public event Action<Component_Product_Android> PackageDisplayNameChanged;
		...
		//public event Action<Component_Product_Android> PackageVersionChanged;
		...
		//public event Action<Component_Product_Android> PackagePublisherChanged;
		...
		//public event Action<Component_Product_Android> PublisherDisplayNameChanged;
		...
		////public event Action<Component_Product_Android> CreateAppxPackageChanged;
		...
		//public event Action<Component_Product_Android> AppDisplayNameChanged;
		...
		//public event Action<Component_Product_Android> AppDescriptionChanged;
		...
		//public event Action<Component_Product_Android> ApplicationIdChanged;
		...
		//public event Action<Component_Product_Android> EntryPointChanged;
