...
namespace NeoAxis
{
	...
	public class Component_Product_Windows : Component_Product
	{
		...
		public event Action<Component_Product_Windows> ImportToolsChanged;
		...
		public event Action<Component_Product_Windows> CubemapProcessingToolsChanged;
		...
		public event Action<Component_Product_Windows> SatelliteResourceLanguagesChanged;
