...
namespace NeoAxis
{
	...
	/// </summary>
	public class FlowSwitch : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		...
		class PropertyImpl : Metadata.Property
		{
			...
			public PropertyImpl( object owner, string name, bool isStatic, Metadata.TypeInfo type, Metadata.TypeInfo typeUnreferenced, Metadata.Parameter[] indexers, bool readOnly, FlowSwitch creator, string category, string displayName, int parameterIndex )
