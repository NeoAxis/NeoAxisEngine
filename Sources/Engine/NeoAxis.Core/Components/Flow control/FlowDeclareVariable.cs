...
namespace NeoAxis
{
	...
	/// </summary>
	public class FlowDeclareVariable : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		...
		public event Action<FlowDeclareVariable> ExitChanged;
		...
		public event Action<FlowDeclareVariable> TypeChanged;
		...
		public event Action<FlowDeclareVariable> VariableNameChanged;
