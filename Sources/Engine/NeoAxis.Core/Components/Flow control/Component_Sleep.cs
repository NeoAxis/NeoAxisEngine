...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_Sleep : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		//Entry
		/// <summary>
		...
		public event Action<Component_Sleep> SecondsChanged;
		...
		public event Action<Component_Sleep> ExitChanged;
