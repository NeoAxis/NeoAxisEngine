...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_EventHandler : Component, IFlowGraphRepresentationData
	{
		bool duringUpdate;
		...
		public event Action<Component_EventHandler> EventChanged;
		...
		public event Action<Component_EventHandler> SenderChanged;
		...
		public event Action<Component_EventHandler> HandlerMethodChanged;
		...
		public event Action<Component_EventHandler> HandlerFlowChanged;
		...
		public event Action<Component_EventHandler> WhenEnableChanged;
		...
		{
			Component_EventHandler creator;
			string category;
			string displayName;
			...
			public PropertyImpl( object owner, string name, bool isStatic, Metadata.TypeInfo type, Metadata.TypeInfo typeUnreferenced, Metadata.Parameter[] indexers, bool readOnly, Component_EventHandler creator, string category, string displayName, int invokeParameterIndex )
