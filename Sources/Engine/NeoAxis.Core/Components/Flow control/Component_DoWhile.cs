...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_DoWhile : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		//Entry
		/// <summary>
		...
		public event Action<Component_DoWhile> ConditionChanged;
		...
		public event Action<Component_DoWhile> LoopBodyChanged;
		...
		public event Action<Component_DoWhile> ExitChanged;
