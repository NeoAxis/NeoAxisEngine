...
namespace NeoAxis
{
	...
	/// </summary>
	public class FlowConvertTo : Component
	{
		...
		{
			FlowConvertTo creator;
			string category;
			string displayName;

			////////////

			public PropertyImpl( object owner, string name, bool isStatic, Metadata.TypeInfo type, Metadata.TypeInfo typeUnreferenced, Metadata.Parameter[] indexers, bool readOnly, FlowConvertTo creator, string category, string displayName )
