...
namespace NeoAxis
{
	...
	/// </summary>
	public class FlowWhile : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		//Entry
		/// <summary>
		...
		public event Action<FlowWhile> ConditionChanged;
		...
		public event Action<FlowWhile> LoopBodyChanged;
		...
		public event Action<FlowWhile> ExitChanged;
