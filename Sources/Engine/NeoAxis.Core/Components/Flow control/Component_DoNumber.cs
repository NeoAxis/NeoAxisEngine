...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_DoNumber : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		//Entry
		/// <summary>
		...
		public event Action<Component_DoNumber> NumberChanged;
		...
		public event Action<Component_DoNumber> LoopBodyChanged;
		...
		public event Action<Component_DoNumber> ExitChanged;
