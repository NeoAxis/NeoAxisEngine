...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_If : Component, IFlowExecutionComponent, IFlowGraphRepresentationData
	{
		//Entry
		/// <summary>
		...
		public event Action<Component_If> ConditionChanged;
		...
		public event Action<Component_If> TrueChanged;
		...
		public event Action<Component_If> FalseChanged;
