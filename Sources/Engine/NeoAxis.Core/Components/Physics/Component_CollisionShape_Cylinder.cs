...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_CollisionShape_Cylinder : Component_CollisionShape
	{
		//Axis
		...
		public event Action<Component_CollisionShape_Cylinder> AxisChanged;
		...
		public event Action<Component_CollisionShape_Cylinder> RadiusChanged;
		...
		public event Action<Component_CollisionShape_Cylinder> HeightChanged;
