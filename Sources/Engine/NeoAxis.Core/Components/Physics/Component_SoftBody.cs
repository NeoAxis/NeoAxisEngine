...
namespace NeoAxis
{
	...
	/// Soft physical body.
	/// </summary>
	public class Component_SoftBody : Component_PhysicalBody
	{
		...
		public event Action<Component_SoftBody> MeshChanged;
		...
		//	}
		//}
		//public event Action<Component_SoftBody> BendingConstraintsChanged;
		...
		public event Action<Component_SoftBody> RandomizeConstraintsChanged;
		...
		public event Action<Component_SoftBody> BendingConstraintDistanceChanged;
		...
		//	}
		//}
		//public event Action<Component_SoftBody> GenerateClustersChanged;
		...
		public event Action<Component_SoftBody> ClustersNumberChanged;
		...
		public event Action<Component_SoftBody> SelfCollisionChanged;
		...
		public event Action<Component_SoftBody> MassChanged;
		...
		public event Action<Component_SoftBody> MassFromFacesChanged;
		...
		public event Action<Component_SoftBody> DampingChanged;
		...
		public event Action<Component_SoftBody> PressureChanged;
		...
		public event Action<Component_SoftBody> DragChanged;
		...
		public event Action<Component_SoftBody> LiftChanged;
		...
		public event Action<Component_SoftBody> AeroModelChanged;
		...
		public event Action<Component_SoftBody> ShapeMatchingChanged;
		...
		public event Action<Component_SoftBody> ShapeCoefficientChanged;
		...
		public event Action<Component_SoftBody> VolumeMatchingChanged;
		...
		public event Action<Component_SoftBody> VolumeCoefficientChanged;
		...
		public event Action<Component_SoftBody> MaxVolumeRatioChanged;
		...
		public Reference<Component_PhysicalMaterial> Material
		{
		...
		public event Action<Component_SoftBody> MaterialChanged;
		ReferenceField<Component_PhysicalMaterial> _material = null;
		...
		public event Action<Component_SoftBody> MaterialFrictionChanged;
		...
		public event Action<Component_SoftBody> MaterialLinearStiffnessChanged;
		...
		public event Action<Component_SoftBody> MaterialAngularStiffnessChanged;
		...
		public event Action<Component_SoftBody> MaterialVolumeStiffnessChanged;
		...
		public event Action<Component_SoftBody> RigidContactHardnessChanged;
		...
		public event Action<Component_SoftBody> SoftRigidContactHardnessChanged;
		...
		public event Action<Component_SoftBody> KineticContactHardnessChanged;
		...
		public event Action<Component_SoftBody> SoftRigidImpulseSplitChanged;
		...
		public event Action<Component_SoftBody> SoftSoftImpulseSplitChanged;
		...
		public event Action<Component_SoftBody> SoftKineticImpulseSplitChanged;
		...
		public event Action<Component_SoftBody> SoftKineticContactHardnessChanged;
		...
		public event Action<Component_SoftBody> SoftSoftContactHardnessChanged;
		...
		public event Action<Component_SoftBody> SoftContactHardnessChanged;
		...
		public event Action<Component_SoftBody> AnchorContactHardnessChanged;
		...
		public event Action<Component_SoftBody> PositionIterationsChanged;
		...
		public event Action<Component_SoftBody> VelocityIterationsChanged;
		...
		public event Action<Component_SoftBody> DriftIterationsChanged;
		...
		public event Action<Component_SoftBody> ClusterIterationsChanged;
		...
		public event Action<Component_SoftBody> CollisionMarginChanged;
		...
		public event Action<Component_SoftBody> VelocityCorrectionFactorChanged;
		...
		public event Action<Component_SoftBody> TimeScaleChanged;
		...
		public event Action<Component_SoftBody> CollisionGroupChanged;
		...
		public event Action<Component_SoftBody> CollisionMaskChanged;
		...
		public event Action<Component_SoftBody> LinearVelocityChanged;
		...
		void CreateMesh()
		{
			...
			var meshCreated = ComponentUtility.CreateComponent<Component_Mesh>( null, false, false );
			meshCreated.DisplayInEditor = false;
			AddComponent( meshCreated, -1 );
			//var meshCreated = CreateComponent<Component_Mesh>( -1, false );
			...
			var geometry = meshCreated.CreateComponent<Component_MeshGeometry>();

			meshCreated.MeshCompileEvent += delegate ( Component_Mesh sender, Component_Mesh.CompiledData compiledData )
			{
				...
				//op.material = ResourceManager.LoadResource<Component_MaterialStandard>( @"Base\Materials\White.material" );
		...
		void CreateBody()
		{
			...
			{
				if( softBody != null )
					Log.Fatal( "Component_SoftBody: CreateBody: softBody != null." );
				if( !EnabledInHierarchy )
					Log.Fatal( "Component_SoftBody: CreateBody: !EnabledInHierarchy." );
		...
		static int FindPose( BulletSharp.Math.Vector3[] srcArr, int srcIndex, double squaredDist = double.Epsilon )
		{
			var i = 0;
			var pos = srcArr[ srcIndex ];
			while( i < srcIndex )
			{
				BulletSharp.Math.Vector3.DistanceSquared( ref srcArr[ i++ ], ref pos, out double dist );
				if( dist <= squaredDist )
					return i - 1;
			}
			return -1;
		...
		internal Vector3 GetNodePosition( int nodeIndex )
		{
			if( softBody != null )
			{
		...
		internal int FindClosestNodeIndex( Vector3 worldPosition )
		{
			var result = -1;
			...
			if( softBody != null )
			{
				...
				{
					var dist = BulletSharp.Math.Vector3.DistanceSquared( nodes[ n ].Position, (BulletSharp.Math.Vector3)worldPosition2 );
					if( dist < minDistance )
					{
						result = n;
						minDistance = dist;
		...
		[Browsable( false )]
		public Component_Mesh MeshCreated
		{
			//!!!!slowly?
			get { return GetComponentByPath( createMeshName ) as Component_Mesh; }
		}

		[Browsable( false )]
		public Component_Mesh MeshOutput
		{
			get
			{
				var m = MeshCreated;
		...
		void SetMaterial( SoftBody b )
		{
			//material settings
			BulletSharp.SoftBody.Config config = b.Cfg;
			//!!!!пока один материал
			BulletSharp.SoftBody.Material bMaterial = b.Materials[ 0 ];
			bMaterial.Flags = MaterialFlags.Default;

			//!!!!disabled until all parameters fixed (SoftRigidContactHardness, etc).
			//Component_PhysicalMaterial material = Material;
			//if( material != null )
			//{
