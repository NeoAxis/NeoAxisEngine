...
namespace NeoAxis
{
	...
	public class Constraint : ObjectInSpace, IPhysicalObject
	{
		bool created;
		PhysicalBody creationBodyA;
		PhysicalBody creationBodyB;
		...
		/// </summary>
		[Serialize]
		public Reference<PhysicalBody> BodyA
		{
		...
		public event Action<Constraint> BodyAChanged;
		ReferenceField<PhysicalBody> _bodyA;

		/// <summary>
		/// The second physical body used.
		/// </summary>
		[Serialize]
		public Reference<PhysicalBody> BodyB
		{
		...
		public event Action<Constraint> BodyBChanged;
		ReferenceField<PhysicalBody> _bodyB;
		...
		public event Action<Constraint> CollisionsBetweenLinkedBodiesChanged;
		...
		protected override void OnSimulationStep()
		{
			...
			if( created && AutoActivateBodies )
			{
					...
					AngularAxisZMotorTargetVelocity != 0 && AngularAxisZMotorMaxForce != 0 )
				{
					...
					if( bodyA != null && bodyA.MotionType.Value == RigidBody.MotionTypeEnum.Dynamic && !bodyA.Active )
						bodyA.Activate();

					var bodyB = creationBodyB as RigidBody;
					if( bodyB != null && bodyB.MotionType.Value == RigidBody.MotionTypeEnum.Dynamic && !bodyB.Active )
						bodyB.Activate();
				}
			}
		}
		...
		public void Render( ViewportRenderingContext context, out int verticesRendered )
		{
			...
			{
				if( InternalConstraintRigid != null && !ParentScene.DisplayPhysicsInternal )
				{
		...
		void DrawLinearLimitedJoint( RenderingContext context, Vector3 p1, Vector3 p2, SoftBody body1, PhysicalBody body2, ref int verticesRendered )
		{
		...
		public void UpdateDebugDrawSize( Viewport viewport )
		{
			if( InternalConstraintRigid != null )
			{
				...
				if( distance < maxDistance )
				{
					...
					InternalConstraintRigid.DebugDrawSize = size2 * scale;
				}
				else
				{
					//!!!!check: внутри не рисуется если 0?
					InternalConstraintRigid.DebugDrawSize = 0;
				}
		...
		public event Action<Constraint> LinearAxisXChanged;
		...
		public event Action<Constraint> LinearAxisXLimitLowChanged;
		...
		public event Action<Constraint> LinearAxisXLimitHighChanged;
		...
		public event Action<Constraint> LinearAxisXMotorChanged;
		...
		public event Action<Constraint> LinearAxisXMotorTargetVelocityChanged;
		...
		public event Action<Constraint> LinearAxisXMotorMaxForceChanged;
		...
		public event Action<Constraint> LinearAxisXMotorRestitutionChanged;
		...
		public event Action<Constraint> LinearAxisXMotorServoChanged;
		...
		public event Action<Constraint> LinearAxisXMotorServoTargetChanged;
		...
		public event Action<Constraint> LinearAxisXSpringChanged;
		...
		public event Action<Constraint> LinearAxisXSpringStiffnessChanged;
		...
		public event Action<Constraint> LinearAxisXSpringDampingChanged;
		...
		public event Action<Constraint> LinearAxisYChanged;
		...
		public event Action<Constraint> LinearAxisYLimitLowChanged;
		...
		public event Action<Constraint> LinearAxisYLimitHighChanged;
		...
		public event Action<Constraint> LinearAxisYMotorChanged;
		...
		public event Action<Constraint> LinearAxisYMotorTargetVelocityChanged;
		...
		public event Action<Constraint> LinearAxisYMotorMaxForceChanged;
		...
		public event Action<Constraint> LinearAxisYMotorRestitutionChanged;
		...
		public event Action<Constraint> LinearAxisYMotorServoChanged;
		...
		public event Action<Constraint> LinearAxisYMotorServoTargetChanged;
		...
		public event Action<Constraint> LinearAxisYSpringChanged;
		...
		public event Action<Constraint> LinearAxisYSpringStiffnessChanged;
		...
		public event Action<Constraint> LinearAxisYSpringDampingChanged;
		...
		public event Action<Constraint> LinearAxisZChanged;
		...
		public event Action<Constraint> LinearAxisZLimitLowChanged;
		...
		public event Action<Constraint> LinearAxisZLimitHighChanged;
		...
		public event Action<Constraint> LinearAxisZMotorChanged;
		...
		public event Action<Constraint> LinearAxisZMotorTargetVelocityChanged;
		...
		public event Action<Constraint> LinearAxisZMotorMaxForceChanged;
		...
		public event Action<Constraint> LinearAxisZMotorRestitutionChanged;
		...
		public event Action<Constraint> LinearAxisZMotorServoChanged;
		...
		public event Action<Constraint> LinearAxisZMotorServoTargetChanged;
		...
		public event Action<Constraint> LinearAxisZSpringChanged;
		...
		public event Action<Constraint> LinearAxisZSpringStiffnessChanged;
		...
		public event Action<Constraint> LinearAxisZSpringDampingChanged;
			...
			set
			{
				if( _angularAxisX.BeginSet( ref value ) )
				{
					try
					{
						...
						if( InternalConstraintRigid != null )
							UpdateAngularLimits( InternalConstraintRigid );
					}
		...
		public event Action<Constraint> AngularAxisXChanged;
		...
		public event Action<Constraint> AngularAxisXLimitLowChanged;
		...
		public event Action<Constraint> AngularAxisXLimitHighChanged;
			...
			set
			{
				if( _angularAxisXMotor.BeginSet( ref value ) )
				{
					try
					{
						...
						if( InternalConstraintRigid != null )
							UpdateAngularMotors( InternalConstraintRigid );
					}
		...
		public event Action<Constraint> AngularAxisXMotorChanged;
		...
		public event Action<Constraint> AngularAxisXMotorTargetVelocityChanged;
		...
		public event Action<Constraint> AngularAxisXMotorMaxForceChanged;
		...
		public event Action<Constraint> AngularAxisXMotorRestitutionChanged;
		...
		public event Action<Constraint> AngularAxisXServoChanged;
		...
		public event Action<Constraint> AngularAxisXServoTargetChanged;
			...
			set
			{
				if( _angularAxisXSpring.BeginSet( ref value ) )
				{
					try
					{
						...
						if( InternalConstraintRigid != null )
							UpdateAngularSprings( InternalConstraintRigid );
					}
		...
		public event Action<Constraint> AngularAxisXSpringChanged;
		...
		public event Action<Constraint> AngularAxisXSpringStiffnessChanged;
		...
		public event Action<Constraint> AngularAxisXSpringDampingChanged;
		...
		public event Action<Constraint> AngularAxisYChanged;
		...
		public event Action<Constraint> AngularAxisYLimitLowChanged;
		...
		public event Action<Constraint> AngularAxisYLimitHighChanged;
		...
		public event Action<Constraint> AngularAxisYMotorChanged;
		...
		public event Action<Constraint> AngularAxisYMotorTargetVelocityChanged;
		...
		public event Action<Constraint> AngularAxisYMotorMaxForceChanged;
		...
		public event Action<Constraint> AngularAxisYMotorRestitutionChanged;
		...
		public event Action<Constraint> AngularAxisYServoChanged;
		...
		public event Action<Constraint> AngularAxisYServoTargetChanged;
		...
		public event Action<Constraint> AngularAxisYSpringChanged;
		...
		public event Action<Constraint> AngularAxisYSpringStiffnessChanged;
		...
		public event Action<Constraint> AngularAxisYSpringDampingChanged;
		...
		public event Action<Constraint> AngularAxisZChanged;
		...
		public event Action<Constraint> AngularAxisZLimitLowChanged;
		...
		public event Action<Constraint> AngularAxisZLimitHighChanged;
		...
		public event Action<Constraint> AngularAxisZMotorChanged;
		...
		public event Action<Constraint> AngularAxisZMotorTargetVelocityChanged;
		...
		public event Action<Constraint> AngularAxisZMotorMaxForceChanged;
		...
		public event Action<Constraint> AngularAxisZMotorRestitutionChanged;
		...
		public event Action<Constraint> AngularAxisZServoChanged;
		...
		public event Action<Constraint> AngularAxisZServoTargetChanged;
		...
		public event Action<Constraint> AngularAxisZSpringChanged;
		...
		public event Action<Constraint> AngularAxisZSpringStiffnessChanged;
		...
		public event Action<Constraint> AngularAxisZSpringDampingChanged;
		...
		/// <summary>
		/// A set of settings for <see cref="Constraint"/> creation in the editor.
		/// </summary>
		public class NewObjectSettingsConstraint : NewObjectSettings
		{
			...
			{
				var c = (Constraint)context.newObject;
		...
		[Browsable( false )]
		public Generic6DofSpring2Constraint InternalConstraintRigid
		{
		...
		void UpdateLinearMotors( Generic6DofSpring2Constraint c )
		{
			...
			c.TranslationalLimitMotor.MaxMotorForce = new Internal.BulletSharp.Math.BVector3( LinearAxisXMotorMaxForce, LinearAxisYMotorMaxForce, LinearAxisZMotorMaxForce );
			c.TranslationalLimitMotor.TargetVelocity = new Internal.BulletSharp.Math.BVector3( LinearAxisXMotorTargetVelocity, LinearAxisYMotorTargetVelocity, LinearAxisZMotorTargetVelocity );
			c.TranslationalLimitMotor.Bounce = new Internal.BulletSharp.Math.BVector3( LinearAxisXMotorRestitution, LinearAxisYMotorRestitution, LinearAxisZMotorRestitution );
