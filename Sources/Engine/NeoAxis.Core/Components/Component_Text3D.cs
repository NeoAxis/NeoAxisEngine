...
namespace NeoAxis
{
	...
	[Editor.AddToResourcesWindow( @"Base\Scene objects\Additional\Text 3D", 0 )]
	public class Component_Text3D : Component_MeshInSpace
	{
		GeneratedData generatedData;
		bool needUpdate;

		//Component_Font.Contour[] _contours;
		...
		public event Action<Component_Text3D> TextChanged;
		...
		//public event Action<Component_Text3D> MultilineChanged;
		...
		//public event Action<Component_Text3D> TextHorizontalAlignmentChanged;
		...
		//}
		//public event Action<Component_Text3D> VerticalIndentionChanged;
		...
		public event Action<Component_Text3D> FontChanged;
		...
		public event Action<Component_Text3D> ThicknessChanged;
		...
		public event Action<Component_Text3D> TesselationChanged;
		...
		public event Action<Component_Text3D> HorizontalAlignmentChanged;
		...
		public event Action<Component_Text3D> VerticalAlignmentChanged;
		...
		class GeneratedData
		{
			public List<Component_Mesh> meshesToDispose = new List<Component_Mesh>();
		}
		...
		GeneratedData GetGeneratedData()
		{
			if( generatedData == null )
			{
				...
				if( contourDatas.Length != 0 )
				{
					...
					//var mesh = CreateComponent<Component_Mesh>( enabled: false );
					//mesh.Name = "Mesh";
		...
		Component_Font.CharacterContourData[] GetContours()
		{
			var font = GetFont();
			if( font != null )
			{
				var result = new List<Component_Font.CharacterContourData>();
				...
				return new Component_Font.CharacterContourData[ 0 ];
		}

		Rectangle GetContoursBounds( Component_Font.CharacterContourData[] contourDatas )
		{
		...
		void GenerateMeshData( Component_Mesh mesh, Component_CollisionShape_Mesh collisionShape, Component_Font.CharacterContourData[] contourDatas )
		{
			//alignment
			...
			//	Log.Fatal( "Component_Text3D: GenerateMeshData: currentIndex != indexCount." );
			foreach( var index in resultIndices )
				if( index < 0 || index >= resultPositions.Count )
					Log.Fatal( "Component_Text3D: GenerateMeshData: index < 0 || index >= positions.Count." );
