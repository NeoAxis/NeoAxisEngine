...
namespace NeoAxis
{
	...
	/// </summary>
	public partial class UIWebBrowser : UIControl, IUIWebBrowser
	{
		...
		[Browsable( false )]
		public event IUIWebBrowser_LoadStartDelegate IUIWebBrowser_LoadStart;
		//public event IUIWebBrowser.IUIWebBrowser_LoadStartDelegate IUIWebBrowser_LoadStart;

#if !NO_UI_WEB_BROWSER
		internal void OnLoadStart( CefFrame frame )
		{
			LoadStart?.Invoke( this, frame );
			IUIWebBrowser_LoadStart?.Invoke( this, frame );
		}
#endif
		...
		[Browsable( false )]
		public event IUIWebBrowser_LoadEndDelegate IUIWebBrowser_LoadEnd;
		//public event IUIWebBrowser.IUIWebBrowser_LoadEndDelegate IUIWebBrowser_LoadEnd;

#if !NO_UI_WEB_BROWSER
		internal void OnLoadEnd( CefFrame frame, int httpStatusCode )
		{
			LoadEnd?.Invoke( this, frame, httpStatusCode );
			IUIWebBrowser_LoadEnd?.Invoke( this, frame, httpStatusCode );
			//needInvalidate = true;
		}
#endif
