...
namespace NeoAxis
{
	public partial class Component_GroupOfObjects
	{
		/// <summary>
		/// Represents data to get items from <see cref="Component_GroupOfObjects"/> object.
		/// </summary>
		...
		//			if( length != current )
		//				Log.Fatal( "Component_Scene: GetObjects_FromOctree_GetResult: length != current." );
