...
//	public class MaterialBlend : Material
//	{
//		//!!!!ReferenceList?
//		//!!!!material Standard?

//		//Material1
//		ReferenceField<MaterialStandard> _material1 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material1
//		{
...
//		}
//		public event Action<MaterialBlend> Material1Changed;

//		//Material2
//		ReferenceField<MaterialStandard> _Material2 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material2
//		{
...
//		}
//		public event Action<MaterialBlend> Material2Changed;
...
//		}
//		public event Action<MaterialBlend> Mask2Changed;

//		//Material3
//		ReferenceField<MaterialStandard> _Material3 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material3
//		{
...
//		}
//		public event Action<MaterialBlend> Material3Changed;
...
//		}
//		public event Action<MaterialBlend> Mask3Changed;

//		//Material4
//		ReferenceField<MaterialStandard> _Material4 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material4
//		{
...
//		}
//		public event Action<MaterialBlend> Material4Changed;
...
//		}
//		public event Action<MaterialBlend> Mask4Changed;

//		//Material5
//		ReferenceField<MaterialStandard> _Material5 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material5
//		{
...
//		}
//		public event Action<MaterialBlend> Material5Changed;
...
//		}
//		public event Action<MaterialBlend> Mask5Changed;

//		//Material6
//		ReferenceField<MaterialStandard> _Material6 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material6
//		{
...
//		}
//		public event Action<MaterialBlend> Material6Changed;
...
//		}
//		public event Action<MaterialBlend> Mask6Changed;

//		//Material7
//		ReferenceField<MaterialStandard> _Material7 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material7
//		{
...
//		}
//		public event Action<MaterialBlend> Material7Changed;
...
//		}
//		public event Action<MaterialBlend> Mask7Changed;

//		//Material8
//		ReferenceField<MaterialStandard> _Material8 = null;
//		[DefaultValue( null )]
//		[Serialize]
//		public Reference<MaterialStandard> Material8
//		{
...
//		}
//		public event Action<MaterialBlend> Material8Changed;
...
//		}
//		public event Action<MaterialBlend> Mask8Changed;
...
//				if( CreateFlowchart )
//				{
//					var flowchart = newObject2.CreateComponent<Flowchart>();
//					flowchart.Name = "Flowchart";
//					flowchart.Specialization = ReferenceUtils.CreateReference<FlowchartSpecialization>( null,
//						MetadataManager.GetTypeOfNetType( typeof( FlowchartSpecialization_Shaders ) ).Name + "|Instance" );

//					var node = flowchart.CreateComponent<FlowchartNode>();
...
//			//public MaterialBlend owner;

//			public MaterialStandard.CompiledDataStandard[] materialsCompiledData;
...
//		MaterialStandard GetMaterialByIndex( int index )
//		{
//			switch( index )
//			{
...
//		//IList<MaterialStandard> GetMaterials()
//		//{
//		//	var result = new List<MaterialStandard>();
//		//	for( int n = 1; n <= 8; n++ )
//		//	{
...
//			var materialsCompiledDataList = new List<MaterialStandard.CompiledDataStandard>();
...
//					var compileMode = materialsCompiledDataList.Count == 0 ? MaterialStandard.CompiledDataStandard.UsageMode.MaterialBlendFirst : MaterialStandard.CompiledDataStandard.UsageMode.MaterialBlendNotFirst;

//					var extensionData = new MaterialStandard.CompileExtensionData();
...
//			xx xx;
//			m.Compile( MaterialStandard.CompiledDataStandard.UsageMode.MaterialBlendFirst );
...
//			//	material2.Compile( MaterialStandard.CompiledDataStandard.CompileMode.MaterialBlendFirst );
//			//}
...
//			//	var newMaterial = (MaterialStandard)material2.Clone( context );
...
//			//		if( lightType != Light.TypeEnum.Ambient && ReceiveShadows.Value )
