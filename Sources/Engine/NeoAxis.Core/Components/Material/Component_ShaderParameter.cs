...
namespace NeoAxis
{
	...
	/// </summary>
	public class Component_ShaderParameter : Component
	{
		...
		public event Action<Component_ShaderParameter> SourceChanged;
		...
		public event Action<Component_ShaderParameter> ManuallySpecifiedReturnTypeChanged;
		...
		class PropertyImpl : Metadata.Property
		{
			...
			public override object GetValue( object obj, object[] index )
			{
				...
				Component_ShaderParameter c = (Component_ShaderParameter)obj;
