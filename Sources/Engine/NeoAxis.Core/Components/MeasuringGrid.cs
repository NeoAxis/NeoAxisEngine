...
namespace NeoAxis
{
	...
	/// </summary>
	[AddToResourcesWindow( @"Base\Scene objects\Additional\Measuring Grid", 0 )]
	public class MeasuringGrid : ObjectInSpace
	{
		/// <summary>
		...
		public event Action<MeasuringGrid> StepChanged;
		...
		public event Action<MeasuringGrid> ThickStepChanged;
		...
		public event Action<MeasuringGrid> ColorChanged;
		...
		public event Action<MeasuringGrid> ColorInvisibleChanged;
		...
		public event Action<MeasuringGrid> VisibilityDistanceChanged;
		...
		public event Action<MeasuringGrid> DisplayInSimulationChanged;
