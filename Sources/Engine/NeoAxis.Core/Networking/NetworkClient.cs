...
//		ClientNetworkService[] servicesByIdentifier = new ClientNetworkService[
...
//		public delegate void ConnectionStatusChangedDelegate( NetworkClient sender,
//			NetworkConnectionStatuses status );
...
//			{
//				ClientNetworkService service = services[ services.Count - 1 ];
//				service.Dispose();
...
//						if( serverConnectedNode != null )
//							serverConnectedNode.status = NetworkConnectionStatuses.Disconnected;
//						disconnectionReason = message;
//						OnConnectionStatusChanged( NetworkConnectionStatuses.Disconnected );
//						Dispose();
//					}
//					break;
...
//							{
//								if( serverConnectedNode == null )
//									serverConnectedNode = new ConnectedNode( this, client.ServerConnection, loginName );

//								beginConnecting = false;

//								NetworkConnectionStatuses realStatus = serverConnectedNode.GetRealStatus();
...
//									if( serverConnectedNode.Status == NetworkConnectionStatuses.Connected )
//									{
//										NetIncomingMessage hailMessage = serverConnectedNode.Connection.RemoteHailMessage;
...
//							ProcessReceivedMessage( serverConnectedNode, incomingMessage,
...
//		protected virtual void OnConnectionStatusChanged( NetworkConnectionStatuses status )
//		{
...
//			{
//				Log.Fatal( "NetworkClient: RegisterService: Invalid service identifier. " +
...
//			{
//				Log.Fatal( "NetworkClient: RegisterService: Invalid service identifier. " +
//					"Max identifier is \"{0}\".", maxServiceIdentifier );
//			}
...
//				{
//					Log.Fatal( "NetworkClient: RegisterService: Service with identifier \"{0}\" " +
...
//				if( checkService != null )
//				{
//					Log.Fatal( "NetworkClient: RegisterService: Service with name \"{0}\" " +
...
//				return;
//			serverConnectedNode.SendFlush( client );
//		}
