...
public class FbxGeometryConverter : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          FbxWrapperNativePINVOKE.delete_FbxGeometryConverter(swigCPtr);
        }
  ...
  public bool Triangulate(FbxScene pScene, bool pReplace, bool pLegacy) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_Triangulate__SWIG_0(swigCPtr, FbxScene.getCPtr(pScene), pReplace, pLegacy);
    return ret;
  }

  public bool Triangulate(FbxScene pScene, bool pReplace) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_Triangulate__SWIG_1(swigCPtr, FbxScene.getCPtr(pScene), pReplace);
    return ret;
  }

  public FbxNodeAttribute Triangulate(FbxNodeAttribute pNodeAttribute, bool pReplace, bool pLegacy) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxGeometryConverter_Triangulate__SWIG_2(swigCPtr, FbxNodeAttribute.getCPtr(pNodeAttribute), pReplace, pLegacy);
  ...
  public bool ComputeGeometryControlPointsWeightedMapping(FbxGeometry pSrcGeom, FbxGeometry pDstGeom, FbxWeightedMapping pSrcToDstWeightedMapping, bool pSwapUV) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ComputeGeometryControlPointsWeightedMapping__SWIG_0(swigCPtr, FbxGeometry.getCPtr(pSrcGeom), FbxGeometry.getCPtr(pDstGeom), FbxWeightedMapping.getCPtr(pSrcToDstWeightedMapping), pSwapUV);
    return ret;
  }
  ...
  public bool ConvertPatchToNurbsInPlace(FbxNode pNode) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ConvertPatchToNurbsInPlace(swigCPtr, FbxNode.getCPtr(pNode));
    return ret;
  }
  ...
  public bool ConvertPatchToNurbsSurfaceInPlace(FbxNode pNode) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ConvertPatchToNurbsSurfaceInPlace(swigCPtr, FbxNode.getCPtr(pNode));
    return ret;
  }

  public FbxNurbsSurface ConvertNurbsToNurbsSurface(FbxNurbs pNurbs) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxGeometryConverter_ConvertNurbsToNurbsSurface(swigCPtr, FbxNurbs.getCPtr(pNurbs));
    FbxNurbsSurface ret = (cPtr == global::System.IntPtr.Zero) ? null : new FbxNurbsSurface(cPtr, false);
    return ret;
  }
  ...
  public bool ConvertNurbsToNurbsSurfaceInPlace(FbxNode pNode) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ConvertNurbsToNurbsSurfaceInPlace(swigCPtr, FbxNode.getCPtr(pNode));
    return ret;
  }

  public bool ConvertNurbsSurfaceToNurbsInPlace(FbxNode pNode) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ConvertNurbsSurfaceToNurbsInPlace(swigCPtr, FbxNode.getCPtr(pNode));
    return ret;
  }

  public FbxNurbs FlipNurbs(FbxNurbs pNurbs, bool pSwapUV, bool pSwapClusters) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxGeometryConverter_FlipNurbs(swigCPtr, FbxNurbs.getCPtr(pNurbs), pSwapUV, pSwapClusters);
    FbxNurbs ret = (cPtr == global::System.IntPtr.Zero) ? null : new FbxNurbs(cPtr, false);
    return ret;
  }
  ...
  public bool ComputeEdgeSmoothingFromNormals(FbxMesh pMesh) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ComputeEdgeSmoothingFromNormals(swigCPtr, FbxMesh.getCPtr(pMesh));
    return ret;
  }

  public bool ComputePolygonSmoothingFromEdgeSmoothing(FbxMesh pMesh, int pIndex) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ComputePolygonSmoothingFromEdgeSmoothing__SWIG_0(swigCPtr, FbxMesh.getCPtr(pMesh), pIndex);
    return ret;
  }

  public bool ComputePolygonSmoothingFromEdgeSmoothing(FbxMesh pMesh) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ComputePolygonSmoothingFromEdgeSmoothing__SWIG_1(swigCPtr, FbxMesh.getCPtr(pMesh));
    return ret;
  }

  public bool ComputeEdgeSmoothingFromPolygonSmoothing(FbxMesh pMesh, int pIndex) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_ComputeEdgeSmoothingFromPolygonSmoothing__SWIG_0(swigCPtr, FbxMesh.getCPtr(pMesh), pIndex);
    return ret;
  }
  ...
  public bool SplitMeshesPerMaterial(FbxScene pScene, bool pReplace) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_SplitMeshesPerMaterial(swigCPtr, FbxScene.getCPtr(pScene), pReplace);
    return ret;
  }
  ...
  public bool RecenterSceneToWorldCenter(FbxScene pScene, double pThreshold) {
    bool ret = FbxWrapperNativePINVOKE.FbxGeometryConverter_RecenterSceneToWorldCenter(swigCPtr, FbxScene.getCPtr(pScene), pThreshold);
    return ret;
  }

  public FbxNode MergeMeshes(SWIGTYPE_p_FbxArrayT_FbxNode_p_t pMeshNodes, string pNodeName, FbxScene pScene) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxGeometryConverter_MergeMeshes(swigCPtr, SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pMeshNodes), pNodeName, FbxScene.getCPtr(pScene));
  ...
  public void RemoveBadPolygonsFromMeshes(FbxScene pScene, SWIGTYPE_p_FbxArrayT_FbxNode_p_t pAffectedNodes) {
    FbxWrapperNativePINVOKE.FbxGeometryConverter_RemoveBadPolygonsFromMeshes__SWIG_0(swigCPtr, FbxScene.getCPtr(pScene), SWIGTYPE_p_FbxArrayT_FbxNode_p_t.getCPtr(pAffectedNodes));
  }

  public void RemoveBadPolygonsFromMeshes(FbxScene pScene) {
    FbxWrapperNativePINVOKE.FbxGeometryConverter_RemoveBadPolygonsFromMeshes__SWIG_1(swigCPtr, FbxScene.getCPtr(pScene));
  }

  public FbxGeometryConverter(FbxManager pManager) : this(FbxWrapperNativePINVOKE.new_FbxGeometryConverter(FbxManager.getCPtr(pManager)), true) {
  }
