...
public class FbxCache : FbxObject {
  ...
  internal FbxCache(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FbxWrapperNativePINVOKE.FbxCache_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public static FbxClassId ClassId {
    set {
      FbxWrapperNativePINVOKE.FbxCache_ClassId_set(FbxClassId.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxCache_ClassId_get();
  ...
  public override FbxClassId GetClassId() {
    FbxClassId ret = new FbxClassId(FbxWrapperNativePINVOKE.FbxCache_GetClassId(swigCPtr), true);
    return ret;
  }
  ...
  public new static FbxCache Create(FbxObject pContainer, string pName) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxCache_Create__SWIG_1(FbxObject.getCPtr(pContainer), pName);
    FbxCache ret = (cPtr == global::System.IntPtr.Zero) ? null : new FbxCache(cPtr, false);
    return ret;
  }

  public void SetCacheFileFormat(FbxCache.EFileFormat pFileFormat, FbxStatus pStatus) {
    FbxWrapperNativePINVOKE.FbxCache_SetCacheFileFormat__SWIG_0(swigCPtr, (int)pFileFormat, FbxStatus.getCPtr(pStatus));
  }
  ...
  public void GetCacheFileName(FbxString pRelativeFileName_UTF8, FbxString pAbsoluteFileName_UTF8) {
    FbxWrapperNativePINVOKE.FbxCache_GetCacheFileName(swigCPtr, FbxString.getCPtr(pRelativeFileName_UTF8), FbxString.getCPtr(pAbsoluteFileName_UTF8));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool OpenFileForRead(FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_OpenFileForRead__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public bool OpenFileForRead() {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_OpenFileForRead__SWIG_1(swigCPtr);
    return ret;
  }

  public bool IsOpen(FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_IsOpen__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public bool IsOpen() {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_IsOpen__SWIG_1(swigCPtr);
    return ret;
  }
  ...
  public bool CloseFile(FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_CloseFile__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public bool CloseFile() {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_CloseFile__SWIG_1(swigCPtr);
    return ret;
  }

  public double GetSamplingFrameRate(FbxStatus pStatus) {
    double ret = FbxWrapperNativePINVOKE.FbxCache_GetSamplingFrameRate__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public double GetSamplingFrameRate() {
    double ret = FbxWrapperNativePINVOKE.FbxCache_GetSamplingFrameRate__SWIG_1(swigCPtr);
    return ret;
  }

  public FbxTime GetCacheTimePerFrame(FbxStatus pStatus) {
    FbxTime ret = new FbxTime(FbxWrapperNativePINVOKE.FbxCache_GetCacheTimePerFrame__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus)), true);
    return ret;
  }

  public FbxTime GetCacheTimePerFrame() {
    FbxTime ret = new FbxTime(FbxWrapperNativePINVOKE.FbxCache_GetCacheTimePerFrame__SWIG_1(swigCPtr), true);
    return ret;
  }

  public int GetChannelCount(FbxStatus pStatus) {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelCount__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public int GetChannelCount() {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelCount__SWIG_1(swigCPtr);
    return ret;
  }

  public bool GetChannelName(int pChannelIndex, FbxString pChannelName, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelName__SWIG_0(swigCPtr, pChannelIndex, FbxString.getCPtr(pChannelName), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetChannelName(int pChannelIndex, FbxString pChannelName) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelName__SWIG_1(swigCPtr, pChannelIndex, FbxString.getCPtr(pChannelName));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool OpenFileForWrite(FbxCache.EMCFileCount pFileCount, double pSamplingFrameRate, string pChannelName, FbxCache.EMCBinaryFormat pBinaryFormat, FbxCache.EMCDataType pMCDataType, string pInterpretation, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_OpenFileForWrite__SWIG_0(swigCPtr, (int)pFileCount, pSamplingFrameRate, pChannelName, (int)pBinaryFormat, (int)pMCDataType, pInterpretation, FbxStatus.getCPtr(pStatus));
    return ret;
  }
  ...
  public bool OpenFileForWrite(FbxCache.EMCFileCount pFileCount, double pSamplingFrameRate, string pChannelName, FbxCache.EMCBinaryFormat pBinaryFormat) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_OpenFileForWrite__SWIG_3(swigCPtr, (int)pFileCount, pSamplingFrameRate, pChannelName, (int)pBinaryFormat);
    return ret;
  }
  ...
  public bool GetChannelDataType(int pChannelIndex, SWIGTYPE_p_FbxCache__EMCDataType pChannelType) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelDataType__SWIG_1(swigCPtr, pChannelIndex, SWIGTYPE_p_FbxCache__EMCDataType.getCPtr(pChannelType));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int GetChannelIndex(string pChannelName, FbxStatus pStatus) {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelIndex__SWIG_0(swigCPtr, pChannelName, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public int GetChannelIndex(string pChannelName) {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelIndex__SWIG_1(swigCPtr, pChannelName);
    return ret;
  }

  public bool Read(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_double pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_2(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_double.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Read(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_double pBuffer, uint pPointCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_3(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_double.getCPtr(pBuffer), pPointCount);
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Read(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_float pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_4(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_float.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Read(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_float pBuffer, uint pPointCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_5(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_float.getCPtr(pBuffer), pPointCount);
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Read(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_int pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_6(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_int.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Read(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_int pBuffer, uint pPointCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_7(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_int.getCPtr(pBuffer), pPointCount);
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool BeginWriteAt(FbxTime pTime, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_BeginWriteAt__SWIG_0(swigCPtr, FbxTime.getCPtr(pTime), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool BeginWriteAt(FbxTime pTime) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_BeginWriteAt__SWIG_1(swigCPtr, FbxTime.getCPtr(pTime));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Write(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_double pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Write__SWIG_0(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_double.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool Write(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_float pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Write__SWIG_2(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_float.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Write(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_float pBuffer, uint pPointCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Write__SWIG_3(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_float.getCPtr(pBuffer), pPointCount);
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Write(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_int pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Write__SWIG_4(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_int.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Write(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_int pBuffer, uint pPointCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Write__SWIG_5(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_int.getCPtr(pBuffer), pPointCount);
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool EndWriteAt(FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_EndWriteAt__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public bool EndWriteAt() {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_EndWriteAt__SWIG_1(swigCPtr);
    return ret;
  }

  public bool GetAnimationRange(int pChannelIndex, FbxTime pTimeStart, FbxTime pTimeEnd, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetAnimationRange__SWIG_0(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTimeStart), FbxTime.getCPtr(pTimeEnd), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetAnimationRange(int pChannelIndex, FbxTime pTimeStart, FbxTime pTimeEnd) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetAnimationRange__SWIG_1(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTimeStart), FbxTime.getCPtr(pTimeEnd));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool GetCacheType(SWIGTYPE_p_FbxCache__EMCFileCount pFileCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetCacheType__SWIG_1(swigCPtr, SWIGTYPE_p_FbxCache__EMCFileCount.getCPtr(pFileCount));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetChannelInterpretation(int pChannelIndex, FbxString pInterpretation, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelInterpretation__SWIG_0(swigCPtr, pChannelIndex, FbxString.getCPtr(pInterpretation), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetChannelInterpretation(int pChannelIndex, FbxString pInterpretation) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelInterpretation__SWIG_1(swigCPtr, pChannelIndex, FbxString.getCPtr(pInterpretation));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool GetChannelSamplingType(int pChannelIndex, SWIGTYPE_p_FbxCache__EMCSamplingType pSamplingType) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelSamplingType__SWIG_1(swigCPtr, pChannelIndex, SWIGTYPE_p_FbxCache__EMCSamplingType.getCPtr(pSamplingType));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetChannelSamplingRate(int pChannelIndex, FbxTime pSamplingRate, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelSamplingRate__SWIG_0(swigCPtr, pChannelIndex, FbxTime.getCPtr(pSamplingRate), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetChannelSamplingRate(int pChannelIndex, FbxTime pSamplingRate) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelSamplingRate__SWIG_1(swigCPtr, pChannelIndex, FbxTime.getCPtr(pSamplingRate));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool GetChannelSampleCount(int pChannelIndex, SWIGTYPE_p_unsigned_int pSampleCount) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelSampleCount__SWIG_1(swigCPtr, pChannelIndex, SWIGTYPE_p_unsigned_int.getCPtr(pSampleCount));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetChannelPointCount(int pChannelIndex, FbxTime pTime, SWIGTYPE_p_unsigned_int pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetChannelPointCount__SWIG_0(swigCPtr, pChannelIndex, FbxTime.getCPtr(pTime), SWIGTYPE_p_unsigned_int.getCPtr(pPointCount), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int GetCacheDataFileCount(FbxStatus pStatus) {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetCacheDataFileCount__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public int GetCacheDataFileCount() {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetCacheDataFileCount__SWIG_1(swigCPtr);
    return ret;
  }

  public bool GetCacheDataFileName(int pIndex, FbxString pRelativeFileName, FbxString pAbsoluteFileName, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetCacheDataFileName__SWIG_0(swigCPtr, pIndex, FbxString.getCPtr(pRelativeFileName), FbxString.getCPtr(pAbsoluteFileName), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetCacheDataFileName(int pIndex, FbxString pRelativeFileName, FbxString pAbsoluteFileName) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetCacheDataFileName__SWIG_1(swigCPtr, pIndex, FbxString.getCPtr(pRelativeFileName), FbxString.getCPtr(pAbsoluteFileName));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool EnableMultiChannelFetching(bool pMultiChannelFetching, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_EnableMultiChannelFetching__SWIG_0(swigCPtr, pMultiChannelFetching, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public bool EnableMultiChannelFetching(bool pMultiChannelFetching) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_EnableMultiChannelFetching__SWIG_1(swigCPtr, pMultiChannelFetching);
    return ret;
  }

  public bool GetNextTimeWithData(FbxTime pCurTime, FbxTime pNextTime, int pChannelIndex, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetNextTimeWithData__SWIG_0(swigCPtr, FbxTime.getCPtr(pCurTime), FbxTime.getCPtr(pNextTime), pChannelIndex, FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetNextTimeWithData(FbxTime pCurTime, FbxTime pNextTime, int pChannelIndex) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetNextTimeWithData__SWIG_1(swigCPtr, FbxTime.getCPtr(pCurTime), FbxTime.getCPtr(pNextTime), pChannelIndex);
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetNextTimeWithData(FbxTime pCurTime, FbxTime pNextTime) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetNextTimeWithData__SWIG_2(swigCPtr, FbxTime.getCPtr(pCurTime), FbxTime.getCPtr(pNextTime));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int GetDataCount(int pChannelIndex, FbxStatus pStatus) {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetDataCount__SWIG_0(swigCPtr, pChannelIndex, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public int GetDataCount(int pChannelIndex) {
    int ret = FbxWrapperNativePINVOKE.FbxCache_GetDataCount__SWIG_1(swigCPtr, pChannelIndex);
    return ret;
  }

  public bool GetDataTime(int pChannelIndex, uint pDataIndex, FbxTime pTime, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetDataTime__SWIG_0(swigCPtr, pChannelIndex, pDataIndex, FbxTime.getCPtr(pTime), FbxStatus.getCPtr(pStatus));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetDataTime(int pChannelIndex, uint pDataIndex, FbxTime pTime) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_GetDataTime__SWIG_1(swigCPtr, pChannelIndex, pDataIndex, FbxTime.getCPtr(pTime));
    if (FbxWrapperNativePINVOKE.SWIGPendingException.Pending) throw FbxWrapperNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool OpenFileForWrite(double pFrameStartOffset, double pSamplingFrameRate, uint pSampleCount, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_OpenFileForWrite__SWIG_4(swigCPtr, pFrameStartOffset, pSamplingFrameRate, pSampleCount, pPointCount, FbxStatus.getCPtr(pStatus));
    return ret;
  }
  ...
  public uint GetSampleCount(FbxStatus pStatus) {
    uint ret = FbxWrapperNativePINVOKE.FbxCache_GetSampleCount__SWIG_0(swigCPtr, FbxStatus.getCPtr(pStatus));
    return ret;
  }

  public uint GetSampleCount() {
    uint ret = FbxWrapperNativePINVOKE.FbxCache_GetSampleCount__SWIG_1(swigCPtr);
    return ret;
  }
  ...
  public bool Read(uint pFrameIndex, SWIGTYPE_p_double pBuffer, uint pPointCount, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Read__SWIG_8(swigCPtr, pFrameIndex, SWIGTYPE_p_double.getCPtr(pBuffer), pPointCount, FbxStatus.getCPtr(pStatus));
    return ret;
  }
  ...
  public bool Write(uint pFrameIndex, SWIGTYPE_p_double pBuffer, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_Write__SWIG_6(swigCPtr, pFrameIndex, SWIGTYPE_p_double.getCPtr(pBuffer), FbxStatus.getCPtr(pStatus));
    return ret;
  }
  ...
  public bool ConvertFromMCToPC2(double pSamplingFrameRate, uint pChannelIndex, FbxStatus pStatus) {
    bool ret = FbxWrapperNativePINVOKE.FbxCache_ConvertFromMCToPC2__SWIG_0(swigCPtr, pSamplingFrameRate, pChannelIndex, FbxStatus.getCPtr(pStatus));
    return ret;
  }
