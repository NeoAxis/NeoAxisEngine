...
public class FbxSceneRenamer : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          FbxWrapperNativePINVOKE.delete_FbxSceneRenamer(swigCPtr);
        }
  ...
  public FbxSceneRenamer(FbxScene pScene) : this(FbxWrapperNativePINVOKE.new_FbxSceneRenamer(FbxScene.getCPtr(pScene)), true) {
  }

  public void RenameFor(FbxSceneRenamer.ERenamingMode pMode) {
    FbxWrapperNativePINVOKE.FbxSceneRenamer_RenameFor(swigCPtr, (int)pMode);
  }
