...
public class FbxLayerElementTangent : FbxLayerElementTemplateFbxVector4 {
  ...
  internal FbxLayerElementTangent(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FbxWrapperNativePINVOKE.FbxLayerElementTangent_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public static FbxLayerElementTangent Create(FbxLayerContainer pOwner, string pName) {
    global::System.IntPtr cPtr = FbxWrapperNativePINVOKE.FbxLayerElementTangent_Create(FbxLayerContainer.getCPtr(pOwner), pName);
