...
namespace Internal.ComponentFactory.Krypton.Ribbon
{
                                 ...
                                 IMessageFilter
    {
        ...
        private static readonly Size _keyTipInflateSize = 
			new Size(DpiHelper.Default.ScaleValue(8), DpiHelper.Default.ScaleValue(30));
        ...
        private bool _closeButtonContextMenuAtClickWhenOpened = true;
        #endregion
        ...
        [Description( "Occurs when the MinimizedMode property before changing value." )]
        public event EventHandler BeforeMinimizedModeChanged;
        ...
        //[Bindable(true)]
        [Category("Visuals")]
        //[Description("CloseAtClickWhenOpened.")]
        [DefaultValue(true)]
        [Browsable(true)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public bool CloseButtonContextMenuAtClickWhenOpened
        {
            get { return _closeButtonContextMenuAtClickWhenOpened; }

            set {
                if (value != _closeButtonContextMenuAtClickWhenOpened)
                {
                    _closeButtonContextMenuAtClickWhenOpened = value;
                }
            }
        }
        ...
        {
            HideRibbonSize = DpiHelper.Default.ScaleValue(new Size(300, 250));
        }
        ...
        public bool MinimizedMode
        {
            ...
            set
            {
                ...
                {
                    OnBeforeMinimizedModeChanged( EventArgs.Empty );
                    ...
                    else
                    {
                        using (ScreenObscurer obscurer = new ScreenObscurer(_minimizedPopup, DesignMode))
                        {
                            ...
                            NeoAxis.Editor.EditorAPI2.ApplicationDoEvents( true );//Application.DoEvents();
                        }
                    }
        ...
        private BackstageAppMenu applicationButtonDropDownMenu;
        ...
        /// </value>
        [Description("Gets or sets the dropdown control which is invoked when the Application Button is clicked")]
        [DefaultValue(null)]
        [Category("Values")]
        public virtual BackstageAppMenu ApplicationButtonDropDownMenu
        {
            get {
                return applicationButtonDropDownMenu;
            }
            set {
                if (applicationButtonDropDownMenu == value)
                    return;
                OnApplicationButtonDropDownControlChanging();
                applicationButtonDropDownMenu = value;
        ...
        {
            if (applicationButtonDropDownMenu == null)
                return;
            applicationButtonDropDownMenu.Ribbon = null;
        }
        ...
        {
            var control = this.ApplicationButtonDropDownMenu;
            if (control != null)
            {
                if (!this.DesignMode)
            ...
            if (applicationButtonDropDownMenu == null)
                return;
            applicationButtonDropDownMenu.Ribbon = this;
        }
        #endregion
                    ...
                    case PI.WM_SYSKEYDOWN:
                        ...
                        if (Visible && Enabled)
                        {
                            ...
                            if ((ownerForm != null) && ownerForm.Visible && ownerForm.Enabled && ownerForm.ContainsFocus)
                            {
                                ...
                                if (m.Msg == PI.WM_SYSKEYUP)
                                {
                                    return ProcessKeyboard_SYSKEYUP(ref m, keys);
                                }
                                else
                                {
        ...
        bool ProcessKeyboard_SYSKEYUP(ref Message msg, Keys keyData)
        {
                ...
                (RibbonShortcuts.ToggleKeyboardAccess2 == keyData))
            {
                ...
                if (!VisualPopupManager.Singleton.IsTracking &&
                   (ApplicationButtonDropDownMenu == null || !ApplicationButtonDropDownMenu.Visible))
                {
                    if (InKeyboardMode)
                    {
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            Keys keyDataWOModifier = keyData & ~Control.ModifierKeys;
            if ((RibbonShortcuts.ToggleKeyboardAccess1 == keyDataWOModifier) ||
                (RibbonShortcuts.ToggleKeyboardAccess2 == keyDataWOModifier))
            {
                // Cannot begin/end tooltips when showing the app menu
                if (!VisualPopupManager.Singleton.IsTracking &&
                   (ApplicationButtonDropDownMenu == null || !ApplicationButtonDropDownMenu.Visible))
        ...
        {
            if (ApplicationButtonDropDownMenu != null)
                EnableOpenBackstageState(null/*Color.FromArgb(49, 117, 47)*/);
        ...
        Color? _headerColorInClosedState;

        /// <summary>
        /// 
        /// </summary>
        public bool IsOpenBackstageStateEnabled
        {
            get { return ApplicationButtonDropDownMenu != null && ApplicationButtonDropDownMenu.Visible; }
        }
        ...
        public virtual void EnableOpenBackstageState(Color? color)
        {
            if (ApplicationButtonDropDownMenu == null)
                return;
            ...
            if (color.HasValue)
            {
                _headerColorInClosedState = form.StateCommon.Header.Back.Color1;
                form.StateCommon.Header.Back.Color1 = color.Value;
            }
            form.AllowIconDisplay = false;
            form.StateCommon.Header.PerformNeedPaint(true);
        }

        /// <summary>
        /// 
        /// </summary>
        public virtual void DisableOpenBackstageState()
        {
            if (ApplicationButtonDropDownMenu == null)
                return;
            ...
            if (_headerColorInClosedState.HasValue)
                form.StateCommon.Header.Back.Color1 = _headerColorInClosedState.Value;
            form.AllowIconDisplay = true;
            form.StateCommon.Header.PerformNeedPaint(true);
        ...
        /// <summary>
        /// Raises the BeforeMinimizedModeChanged event.
        /// </summary>
        /// <param name="e">An EventArgs containing event data.</param>
        protected virtual void OnBeforeMinimizedModeChanged( EventArgs e )
        {
            if( BeforeMinimizedModeChanged != null )
                BeforeMinimizedModeChanged( this, e );
        }
        ...
        internal ViewBase GetViewForQATButton(IQuickAccessToolbarButton qatButton)
        {
            switch (QATLocation)
            {
                case QATLocation.Above:
                    return _captionArea.VisibleQAT.ViewForButton(qatButton);
                case QATLocation.Below:
                    return _qatBelowContents.ViewForButton(qatButton);
        ...
        private void AssignDefaultFields()
        {
            ...
            BackStyle = PaletteBackStyle.PanelRibbonActive;
        ...
        {
            _tabsArea?.OnAppButtonClicked( null, null );
        }
