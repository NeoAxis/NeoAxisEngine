...
namespace Internal.ComponentFactory.Krypton.Ribbon
{
    ...
    //[Designer("ComponentFactory.Krypton.Ribbon.KryptonRibbonGroupButtonDesigner, ComponentFactory.Krypton.Design, Version=125.0.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    ...
    public class KryptonRibbonGroupButton : KryptonRibbonGroupItem
    {
        ...
        //!!!!
        private long _kryptonContextMenuClosedTime;
        ...
        /// <summary>
        /// Gets and sets the visibility of the arrow.
        /// </summary>
        [Bindable(true)]
        [Category("Behavior")]
        [Description("Determines whether the arrow is visible.")]
        [DefaultValue(false)]
                ...
                if (Enabled)
                {
                        ...
                        (ButtonType == GroupButtonType.Split))
                    {
                        if (KryptonContextMenu != null)
                        {
                            ...
                            if (Ribbon.CloseButtonContextMenuAtClickWhenOpened)
                            {
                                // open a new menu if the previous one was not closed just now.
                                openMenu = !WasContextMenuClosed10MsAgo();
                            }
        ...
        //!!!!
        private bool WasContextMenuClosed10MsAgo()
        {
            return (DateTime.Now.Ticks - _kryptonContextMenuClosedTime) < 10 * TICKS_PER_MS;
        }
        ...
        private void OnKryptonContextMenuClosed(object sender, EventArgs e)
        {
            ...
            _kryptonContextMenuClosedTime = DateTime.Now.Ticks;
        }
        #endregion
    }
}
