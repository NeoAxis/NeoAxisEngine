...
namespace Internal.ComponentFactory.Krypton.Navigator
{
    ...
    public class KryptonPage : VisualPanel
    {
        ...
        public KryptonPage(string text, Image imageSmall, string uniqueName)
		{
            // Default properties
            Text = text;
            MinimumSize = DpiHelper.Default.ScaleValue(new Size(50, 50));
            ...
            _setVisible = true;
            _autoHiddenSlideSize = DpiHelper.Default.ScaleValue(new Size(200, 200));
        ...
        [EditorBrowsable( EditorBrowsableState.Never )]
        [DesignerSerializationVisibility( DesignerSerializationVisibility.Hidden )]
        public virtual bool ButtonClickOnDown 
        {
            get { return true; }
        }
