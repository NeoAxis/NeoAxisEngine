...
namespace Internal.ComponentFactory.Krypton.Navigator
{
                                          ...
                                          INavCheckItem
    {
        ...
        private static Padding _preferredBorder = DpiHelper.Default.ScaleValue(new Padding(5, 5, 5, 2));
        private static Padding _layoutBorderTop = DpiHelper.Default.ScaleValue(new Padding(4, 4, 4, 1));
        private static Padding _layoutBorderLeft = DpiHelper.Default.ScaleValue(new Padding(5, 4, 3, 1));
        private static Padding _layoutBorderRight = DpiHelper.Default.ScaleValue(new Padding(4, 5, 4, 0));
        private static Padding _layoutBorderBottom = DpiHelper.Default.ScaleValue(new Padding(4, 2, 4, 3));
        private static Padding _drawBorder = DpiHelper.Default.ScaleValue(new Padding(1, 0, 1, 0));
        #endregion
