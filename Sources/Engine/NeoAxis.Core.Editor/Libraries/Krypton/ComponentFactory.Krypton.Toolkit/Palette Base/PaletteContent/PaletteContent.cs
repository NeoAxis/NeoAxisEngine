...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
                                  ...
                                  IPaletteContent
    {
        ...
        /// <returns></returns>
        public bool GetContentShortTextCompatiblePadding(PaletteState state)
        {
            return false;
            //if (_shortText.CompatiblePadding != PaletteTextHint.Inherit)
            //    return false;
            //else
            //    return _inherit.GetContentShortTextCompatiblePadding(state);
        }
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        public bool GetContentLongTextCompatiblePadding(PaletteState state)
        {
            return false;
            //if (_shortText.CompatiblePadding != PaletteTextHint.Inherit)
            //    return false;
            //else
            //    return _inherit.GetContentLongTextCompatiblePadding(state);
        }
