...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
  ...
  //      }
		...
		///// </summary>
		///// <returns></returns>
		//public virtual InheritBool GetAllowOnePixelBorder()
		//{
		//	return _target.GetAllowOnePixelBorder();
		//}
        ...
        /// </summary>
        /// <returns></returns>
        public virtual Padding GetFormMargin()
        {
            return _target.GetFormMargin();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual int GetFormCaptionHeight()
        {
            return _target.GetFormCaptionHeight();
        }
        #endregion
