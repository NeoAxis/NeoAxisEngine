...
namespace Internal.ComponentFactory.Krypton.Toolkit
{
    ...
    //[Designer("ComponentFactory.Krypton.Toolkit.KryptonMaskedTextBoxDesigner, ComponentFactory.Krypton.Design, Version=125.0.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        AccurateText.DrawString(g, drawText, Font,
                                            new Rectangle(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top), ForeColor, stringFormat);
                                    }
                                    catch (ArgumentException)
                                    {
                                        AccurateText.DrawString(g, drawText, _kryptonMaskedTextBox.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled),
                                            new Rectangle(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top), ForeColor, stringFormat);
                                    }
                                }
