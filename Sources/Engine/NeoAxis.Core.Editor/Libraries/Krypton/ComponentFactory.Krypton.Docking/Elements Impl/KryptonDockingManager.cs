...
namespace Internal.ComponentFactory.Krypton.Docking
{
    ...
    public class KryptonDockingManager : DockingElementOpenCollection
    {
        ...
        public void SaveConfigToStream(Stream stream, Encoding encoding, Formatting formatting = Formatting.Indented )
        {
            XmlTextWriter xmlWriter = new XmlTextWriter(stream, encoding);

            // Use indenting for readability
            xmlWriter.Formatting = formatting;//Formatting.Indented;
