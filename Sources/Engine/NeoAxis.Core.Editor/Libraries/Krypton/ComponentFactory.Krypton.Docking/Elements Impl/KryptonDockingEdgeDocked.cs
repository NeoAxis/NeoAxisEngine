...
namespace Internal.ComponentFactory.Krypton.Docking
{
    ...
    public class KryptonDockingEdgeDocked : DockingElementClosedCollection
    {
        ...
        private static readonly Size _defaultDockspaceSize = DpiHelper.Default.ScaleValue(new Size(250, 250));
        #endregion
        ...
        {
            return CreateAndInsertDockspace(Count, name, _defaultDockspaceSize);
        }
        ...
        {
            return CreateAndInsertDockspace(index, name, _defaultDockspaceSize);
        }
