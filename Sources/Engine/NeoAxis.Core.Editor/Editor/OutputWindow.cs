...
namespace NeoAxis.Editor
{
	public partial class OutputWindow : DockWindow
	{
		...
		public OutputWindow()
		{
			...
			toolStripButtonOptions.Text = EditorLocalization2.Translate( "OutputWindow", toolStripButtonOptions.Text );
			toolStripButtonClear.Text = EditorLocalization2.Translate( "OutputWindow", toolStripButtonClear.Text );
		...
		{
			var window = EditorAPI2.FindWindow<OutputWindow>();
