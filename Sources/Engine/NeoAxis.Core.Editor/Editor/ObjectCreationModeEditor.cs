...
namespace NeoAxis.Editor
{
	public abstract class ObjectCreationMode
	{
		...
		public delegate void UpdateGetObjectInSceneRenderingContextDelegate( ObjectCreationMode sender, Viewport viewport, ref ObjectInSpace.RenderingContext context );
		...
		public delegate void ViewportUpdateGetCameraSettingsDelegate( ObjectCreationMode sender, ref Camera camera );
		...
		public delegate void EditorActionGetStateDelegate( ObjectCreationMode sender, EditorActionGetStateContext context );
		...
		public delegate void EditorActionClickDelegate( ObjectCreationMode sender, EditorActionClickContext context );
