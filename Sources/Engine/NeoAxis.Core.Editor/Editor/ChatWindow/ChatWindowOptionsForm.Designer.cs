...
{
	partial class ChatWindowOptionsForm
	{
		/// <summary>
   ...
   //         | System.Windows.Forms.AnchorStyles.Right)));
			...
			// 
			// ChatWindowOptionsForm
			// 
			this.AcceptButton = this.buttonClose;
			this.AutoScaleDimensions = new System.Drawing.SizeF(8F, 16F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.CancelButton = this.buttonClose;
			this.ClientSize = new System.Drawing.Size( 562, 110 );// 475);
			this.Controls.Add(this.buttonClose);
			this.Controls.Add(this.hierarchicalContainer1);
			this.MaximizeBox = false;
			this.MinimizeBox = false;
			this.Name = "ChatWindowOptionsForm";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Chat Options";
			this.Load += new System.EventHandler(this.ChatWindowOptionsForm_Load);
