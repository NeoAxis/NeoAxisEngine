...
{
	public static class EditorContextMenu2
	{
		public class ItemImpl : EditorContextMenu.Item
		{
			internal KryptonContextMenuItem item;

			//!!!!ImageUtility.Image2D
			//public Item( string text, Image image, EventHandler clickHandler )
			//{
			//}

			public ItemImpl( string text, System.EventHandler clickHandler )
			{
				item = new KryptonContextMenuItem( text, clickHandler );
			}
		...
		public class SeparatorImpl : EditorContextMenu.Separator
		{
		...
		//	{
		//		EditorAPI.EditorActionClick( EditorActionHolder.ContextMenu, "Move" );
		//	} );
		...
		//	item = new KryptonContextMenuItem( text, null, delegate ( object sender, EventArgs e )
		//	{
		//		EditorAPI.EditorActionClick( EditorActionHolder.ContextMenu, "Rotate" );
		//	} );
		...
		//	item = new KryptonContextMenuItem( text, null, delegate ( object sender, EventArgs e )
		//	{
		//		EditorAPI.EditorActionClick( EditorActionHolder.ContextMenu, "Scale" );
		//	} );
		...
		//	item = new KryptonContextMenuItem( text, null, delegate ( object sender, EventArgs e )
		//	{
		//		EditorAPI.EditorActionClick( EditorActionHolder.ContextMenu, "Select" );
		//	} );
		...
		//		{
		//			var state = EditorAPI.EditorActionGetState( EditorActionHolder.ContextMenu, action );
		//			//bool enabled = false;
		...
		//					////!!!!так?
		//					var state2 = EditorAPI.EditorActionGetState( EditorActionHolder.ContextMenu, action );
		//					//check still enabled
		//					if( state2.Enabled )
		//						EditorAPI.EditorActionClick( EditorActionHolder.ContextMenu, action.Name );
