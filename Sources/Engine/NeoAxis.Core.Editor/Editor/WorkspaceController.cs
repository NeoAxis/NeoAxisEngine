...
namespace NeoAxis.Editor
{
	public abstract class WorkspaceController : IDisposable
	{
		...
		internal/*obfuscator*/ void RemoveDockWindow( KryptonPage page, bool dispose )
		{
		...
		internal/*obfuscator*/ void KryptonPage_Disposed( object sender, EventArgs e )
		{
		...
		internal/*obfuscator*/ void KryptonPage_VisibleChanged( object sender, EventArgs e )
		{
