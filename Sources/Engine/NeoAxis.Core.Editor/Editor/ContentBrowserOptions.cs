...
namespace NeoAxis.Editor
{
	...
	public class ContentBrowserOptions : Metadata.IMetadataProvider
	{
		...
		public delegate void ConfigureDelegate( ContentBrowserOptions sender );
		...
		const int ListImageSizeDefault = 24;//32;
		...
		const int TileImageSizeDefault = 24;//32;//48;
		...
		List<PropertyImpl> additionalProperties = new List<PropertyImpl>();
