...
namespace NeoAxis.Editor
{
	...
	public class HCItemTextBox : HCItemProperty
	{
		...
		public override void UpdateControl()
		{
			...
			//password
			if( control.TextBox.PasswordChar == '\0' || !control.TextBox.UseSystemPasswordChar )
			{
				var passwordAttribute = Property.GetCustomAttribute<HCTextBoxPasswordAttribute>();
				if( passwordAttribute != null )
				{
					if( passwordAttribute.PasswordChar != null )
						control.TextBox.PasswordChar = passwordAttribute.PasswordChar.Value;
					else
						control.TextBox.UseSystemPasswordChar = true;
				}
			}
