...
namespace NeoAxis.Editor
{
	partial class HCGridTextBoxNumeric
	{
		...
		private void InitializeComponent()
		{
			...
			this.trackBar = new Internal.ComponentFactory.Krypton.Toolkit.KryptonTrackBar();
			this.SuspendLayout();
			// 
			// textBox1
			// 
			...
			this.trackBar.TrackBarSize = Internal.ComponentFactory.Krypton.Toolkit.PaletteTrackBarSize.Small;
			// 
		...
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonTrackBar trackBar;
	}
}
