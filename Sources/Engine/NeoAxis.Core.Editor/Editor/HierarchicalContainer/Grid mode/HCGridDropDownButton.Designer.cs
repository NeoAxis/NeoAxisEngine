...
namespace NeoAxis.Editor
{
	partial class HCGridDropDownButton
	{
		...
		{
			this.kryptonDropButton = new Internal.ComponentFactory.Krypton.Toolkit.KryptonDropButton();
			this.SuspendLayout();
			// 
			// kryptonDropButton
			// 
			...
			this.kryptonDropButton.ButtonStyle = Internal.ComponentFactory.Krypton.Toolkit.ButtonStyle.Custom3;
			this.kryptonDropButton.Images.Common = global::NeoAxis.Editor.Properties.Resources.DropDownButton;
