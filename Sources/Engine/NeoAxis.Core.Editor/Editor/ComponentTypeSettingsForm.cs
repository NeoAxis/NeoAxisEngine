...
namespace NeoAxis.Editor
{
	public partial class ComponentTypeSettingsForm : EngineForm
	{
		...
		public ComponentTypeSettingsForm( DocumentInstance document, Component component )
		{
			...
			Text = EditorLocalization2.Translate( "TypeSettingsForm", Text );
			EditorLocalization2.TranslateForm( "TypeSettingsForm", this );
		}
		...
		{
			displayName = EditorLocalization2.Translate( "TypeSettingsForm", displayName );
		}
