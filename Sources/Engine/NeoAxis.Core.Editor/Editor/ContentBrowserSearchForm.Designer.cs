...
namespace NeoAxis.Editor
{
	partial class ContentBrowserSearchForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.kryptonButtonSearch = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			this.kryptonTextBoxFilterByName = new Internal.ComponentFactory.Krypton.Toolkit.KryptonTextBox();
   ...
   //         | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.labelEx1.StateCommon.Border.ImageStyle = Internal.ComponentFactory.Krypton.Toolkit.PaletteImageStyle.Inherit;
		...
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton kryptonButtonSearch;
