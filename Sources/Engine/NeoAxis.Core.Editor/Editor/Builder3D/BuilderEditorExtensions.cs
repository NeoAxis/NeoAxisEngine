...
namespace NeoAxis.Editor
{
	...
	class BuilderEditorExtensions : EditorExtensions
	{
		...
		public override void OnRegister()
		{
			...
			EditorAPI2.EditorActionGetStateEvent += EditorAPI_GetEditorActionStateEvent;
			EditorAPI2.EditorActionClickEvent += EditorAPI_EditorActionClickEvent;
		}
		...
		private void EditorAPI_GetEditorActionStateEvent( EditorActionGetStateContext context )
		{
		...
		private void EditorAPI_EditorActionClickEvent( EditorActionClickContext context )
		{
			var actionContext = new BuilderActionContext( context );
			...
			case "Modeling Set Color":
				{
					...
					bool ColorValuePoweredSelectFormShowDialog( System.Drawing.Point location, ColorValuePowered initialColor, out ColorValuePowered resultColor )
					{
