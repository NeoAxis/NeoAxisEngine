...
namespace NeoAxis.Editor
{
	static class BuilderCommonFunctions
	{
		...
		/// <param name="undoLocked"></param>
		/// <returns>Returns True when the external mesh was copied.</returns>
		public static void CopyExternalMesh( IDocumentInstance document, MeshInSpace meshInSpace, ref Mesh mesh, List<UndoSystem.Action> undoForMesh, ref bool undoLocked )
		{
