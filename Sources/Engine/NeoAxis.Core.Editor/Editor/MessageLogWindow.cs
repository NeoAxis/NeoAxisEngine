...
namespace NeoAxis.Editor
{
	...
	public partial class MessageLogWindow : DockWindow
	{
		...
		public MessageLogWindow()
		{
			...
			toolStripButtonOptions.Text = EditorLocalization2.Translate( "MessageLogWindow", toolStripButtonOptions.Text );
			toolStripButtonClear.Text = EditorLocalization2.Translate( "MessageLogWindow", toolStripButtonClear.Text );
		...
		private void Handlers_ErrorHandler( string text, ref bool handled, ref bool dumpToLogFile )
		{
			...
			//show screen notification
			{
				...
				ScreenNotifications2.Show( t, true );
			}
		}
		...
		public void Print( string text, LogType type )
		{
			...
			if( type == LogType.Error )
			{
				...
				EditorAPI2.ShowDockWindow<MessageLogWindow>();
		...
		void UpdateCaption()
		{
			...
			if( warnAndErrorCount > 0 )
				KryptonPage.Text = EditorLocalization2.Translate( "Windows", WindowCaption ) + $" ({warnAndErrorCount})";
			else
				KryptonPage.Text = EditorLocalization2.Translate( "Windows", WindowCaption );
		...
		private void MessageLogWindow_Load( object sender, EventArgs e )
		{
			...
			toolStripButtonOptions.Size = new Size( (int)( 20 * EditorAPI2.DPIScale ), (int)( 20 * EditorAPI2.DPIScale + 2 ) );
			toolStripButtonClear.Size = new Size( (int)( 20 * EditorAPI2.DPIScale ), (int)( 20 * EditorAPI2.DPIScale + 2 ) );
