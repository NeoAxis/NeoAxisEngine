...
namespace NeoAxis.Editor
{
	...
	public partial class DebugInfoWindow : DockWindow
	{
		...
		void UpdateList()
		{
			...
			foreach( var page in DebugInfo.AllPages )
			{
				var item = new ContentBrowserItem_Virtual( contentBrowserList, null, EditorLocalization2.Translate( "DebugInfoWindow", page.Title ) );
				item.Tag = page;
				items.Add( item );
		...
		void UpdateContent()
		{
			...
			{
				var page = (DebugInfo)( (ContentBrowserItem_Virtual)contentBrowserList.SelectedItems[ 0 ] ).Tag;
				lines = page.Content;
			}
