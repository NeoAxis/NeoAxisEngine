...
{
	//share changes with ColorValuePoweredSelectForm.cs
	...
	public partial class ColorValuePoweredSelectControl : HCDropDownControl
	{
		...
		private void colorWheel_MouseDoubleClick( object sender, MouseEventArgs e )
		{
			//does not work
			//okButton?.PerformClick();
		}

		private void colorWheel_DoubleClick( object sender, EventArgs e )
		{
			//does not work
			//okButton?.PerformClick();
		}
