	...
	public class EngineScrollBar : UserControl
	{
		...
		void DrawArrowButton( Graphics g, System.Drawing.Rectangle bounds, ScrollBarArrowButtonState state )
		{
			...
			case ScrollBarArrowButtonState.RightNormal:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 47, 47, 47 ) : Color.FromArgb( 240, 240, 240 );
				color2 = EditorAPI2.DarkTheme ? Color.FromArgb( 130, 130, 130 ) : Color.FromArgb( 96, 96, 96 );
			...
			case ScrollBarArrowButtonState.RightHot:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 80, 80, 80 ) : Color.FromArgb( 218, 218, 218 );
				color2 = EditorAPI2.DarkTheme ? Color.FromArgb( 150, 150, 150 ) : Color.FromArgb( 0, 0, 0 );
			...
			case ScrollBarArrowButtonState.RightPressed:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 90, 90, 90 ) : Color.FromArgb( 96, 96, 96 );
				color2 = EditorAPI2.DarkTheme ? Color.FromArgb( 170, 170, 170 ) : Color.FromArgb( 255, 255, 255 );
			...
			case ScrollBarArrowButtonState.RightDisabled:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 47, 47, 47 ) : Color.FromArgb( 240, 240, 240 );
				color2 = EditorAPI2.DarkTheme ? Color.FromArgb( 90, 90, 90 ) : Color.FromArgb( 200, 200, 200 );
				break;
			}
		...
		void DrawThumb( Graphics graphics, int thumbLength, int thumbPosition )
		{
			...
			{
			case ScrollBarState.Normal:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 60, 60, 60 ) : Color.FromArgb( 205, 205, 205 );
				break;
			case ScrollBarState.Hot:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 70, 70, 70 ) : Color.FromArgb( 166, 166, 166 );
				break;
			case ScrollBarState.Pressed:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 80, 80, 80 ) : Color.FromArgb( 96, 96, 96 );
				break;
			case ScrollBarState.Disabled:
				color = EditorAPI2.DarkTheme ? Color.FromArgb( 54, 54, 54 ) : Color.FromArgb( 220, 220, 220 );
				break;
			}
