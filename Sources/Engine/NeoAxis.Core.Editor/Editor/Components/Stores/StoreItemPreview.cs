...
namespace NeoAxis.Editor
{
	public partial class StoreItemPreview : PreviewControl//WithViewport
	{
		...
		protected override void OnLoad( EventArgs e )
		{
			...
			//{
			//	var type = MetadataManager.GetType( "NeoAxis.Sky" );
			//	if( type != null )
			//	{
		...
		{
			return EditorLocalization2.Translate( "StoreItemPreviewControl", text );
		}
		...
		protected override void OnPaint( PaintEventArgs e )
		{
			...
			if( image != null )
			{
				...
				if( package != null )
				{
					...
					var margin = (int)( 2.0 * EditorAPI2.DPIScale );
					var shadowOffset = (int)( 1.0 * EditorAPI2.DPIScale );
