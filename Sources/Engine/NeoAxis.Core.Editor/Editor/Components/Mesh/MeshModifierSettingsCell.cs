...
namespace NeoAxis.Editor
{
	public class MeshModifierSettingsCell : SettingsCellProcedureUI
	{
		...
		{
			return EditorLocalization2.Translate( "MeshModifier", text );
		}
		...
		MeshModifier[] GetMeshModifiers()
		{
			return GetObjects<MeshModifier>().Where( m => m.Parent as Mesh != null ).ToArray();
		}
