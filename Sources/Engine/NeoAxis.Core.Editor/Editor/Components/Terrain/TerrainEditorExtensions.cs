	...
	class TerrainEditorExtensions : EditorExtensions
	{
		...
		static void RegisterTerrain()
		{
			...
			//Terrain Tool Radius
			{
				...
				a.Slider.Value = SceneEditor.TerrainToolRadius;
			...
			//Terrain Tool Strength
			{
				...
				a.ActionType = EditorAction.ActionTypeEnum.Slider;
				a.Slider.Value = SceneEditor.TerrainToolStrength;
			...
			//Terrain Tool Hardness
			{
				...
				a.ActionType = EditorAction.ActionTypeEnum.Slider;
				a.Slider.Value = SceneEditor.TerrainToolHardness;
		...
		internal static void AddToRibbonDefaultConfiguration()
		{
			bool VisibleCondition()
			{
				...
				return rootComponent != null && rootComponent.GetComponent<Terrain>( true ) != null;
			}
