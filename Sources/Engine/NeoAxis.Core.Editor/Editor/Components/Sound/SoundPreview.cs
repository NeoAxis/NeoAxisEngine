...
namespace NeoAxis.Editor
{
	public partial class SoundPreview : PreviewControl
	{
		...
		private void Sound_SettingsCell_Load( object sender, EventArgs e )
		{
			timer1.Start();
		}
		...
		void Play( bool loop )
		{
			var soundComponent = ObjectOfPreview as Sound;
			...
			if( soundComponent != null && soundComponent.Result != null )
			{
				...
				if( length != 0 )
				{
					...
					if( sound != null )
						channel = SoundWorld.SoundPlay( null, sound, EngineApp.DefaultSoundChannelGroup, .5f, 1 );
				}
			}
		}
