//now in:
//Sources\Engine\Tools\CommandLineTools
...
//			static bool ProcessPbxproj( string destFile, string baseProjectFileName, out string error, out bool changed )
//			{
//				error = "";
//				changed = false;
...
//					return true;
//				}
//				else if( destExtension == ".pbxproj" )
//				{
//					if( !ProcessPbxproj( destFile, baseProjectFileName, out error, out changed ) )
//						return false;
//					return true;
//				}
