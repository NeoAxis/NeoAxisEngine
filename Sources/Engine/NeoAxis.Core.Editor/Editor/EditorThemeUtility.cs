	...
	public static class EditorThemeUtility
	{
		...
		class MyToolStripRenderer : ToolStripRenderer
		{
			...
			protected override void OnRenderButtonBackground( ToolStripItemRenderEventArgs e )
			{
				...
				{
					draw = true;
					color = EditorAPI2.DarkTheme ? Color.FromArgb( 90, 90, 90 ) : Color.FromArgb( 197, 197, 197 );
				}
				...
				{
					draw = true;
					color = EditorAPI2.DarkTheme ? Color.FromArgb( 110, 110, 110 ) : Color.FromArgb( 174, 174, 174 );
				}
			...
			{
				e.ArrowColor = EditorAPI2.DarkTheme ? Color.FromArgb( 140, 140, 140 ) : Color.FromArgb( 59, 59, 59 );
		...
		{
			if( EditorAPI2.DarkTheme && !control.OwnerDraw )
			{
