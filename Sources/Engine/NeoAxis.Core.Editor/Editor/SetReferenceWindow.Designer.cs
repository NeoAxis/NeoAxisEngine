...
namespace NeoAxis.Editor
{
	partial class SetReferenceWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonSet = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			...
			this.buttonSetAndClose = new Internal.ComponentFactory.Krypton.Toolkit.KryptonButton();
			...
			this.kryptonCheckBoxCanMakeRelativeFilePath = new Internal.ComponentFactory.Krypton.Toolkit.KryptonCheckBox();
			this.SuspendLayout();
			// 
			// buttonSet
			// 
			...
			this.labelSelectedReference.LabelStyle = Internal.ComponentFactory.Krypton.Toolkit.LabelStyle.NormalControl;
		...
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton buttonSet;
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton buttonClose;
		private ContentBrowser contentBrowser1;
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonButton buttonSetAndClose;
		private System.Windows.Forms.Timer timer1;
		private NeoAxis.Editor.EngineLabel labelSelectedReference;
		private Internal.ComponentFactory.Krypton.Toolkit.KryptonTextBox kryptonTextBox1;
