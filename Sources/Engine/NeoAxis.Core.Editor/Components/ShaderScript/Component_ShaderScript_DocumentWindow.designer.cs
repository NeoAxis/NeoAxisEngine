...
{
    partial class Component_ShaderScript_DocumentWindow
	{
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			// 
			// Component_ShaderScript_DocumentWindow
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(8F, 16F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.avalonTextEditor );
			this.Margin = new System.Windows.Forms.Padding(5);
			this.Name = "Component_ShaderScript_DocumentWindow";
			this.Size = new System.Drawing.Size(477, 277);
			this.Load += new System.EventHandler(this.ShaderScriptDocumentWindow_Load);
