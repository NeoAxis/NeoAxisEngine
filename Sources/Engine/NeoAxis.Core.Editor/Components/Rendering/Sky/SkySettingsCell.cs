...
{
	public class SkySettingsCell : SettingsCellProcedureUI
	{
		...
		protected override void OnInit()
		{
			...
			//if( easyImport )
			{
				...
				editLink = ProcedureForm.CreateEdit( "https://dl.polyhaven.com/file/ph-assets/HDRIs/hdr/4k/qwantani_4k.hdr" );
				//editLink.TextChanged
				ProcedureForm.AddRow( new ProcedureUI.Control[] { editLink } );

				buttonImport = ProcedureForm.CreateButton( EditorLocalization2.Translate( "General", "Import" ) );
		...
		private void ButtonImport_Click( ProcedureUI.Button sender )
		{
			...
			var notification = ScreenNotifications2.ShowSticky( "Importing..." );
