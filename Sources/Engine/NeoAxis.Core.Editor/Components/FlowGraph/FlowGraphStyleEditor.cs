	...
	public class FlowGraphStyle_Default : FlowGraphStyle
	{
		...
		public static FlowGraphStyle_Default Instance
		{
			get
			{
				if( instance == null )
				{
					instance = new FlowGraphStyle_Default();
		...
		public override void RenderBackground( IFlowGraphEditor window )
		{
		...
		public override void RenderForeground( IFlowGraphEditor window )
		{
			RenderSpecializationName( window );
		}

		//!!!!было
		//public delegate void RenderBackgroundEventDelegate( FlowchartStyle sender, Flowchart_DocumentWindow window, ref bool processed );
		//public event RenderBackgroundEventDelegate RenderBackgroundEvent;

		public virtual void RenderBackgroundGrid( IFlowGraphEditor window2 )
		{
		...
		public virtual void RenderSpecializationName( IFlowGraphEditor window2 )
		{
			var window = (FlowGraphEditor)window2;
		...
		public override void RenderReference( IFlowGraphEditor window2, Vector2 from, bool fromInput, Vector2 to, ColorValue color, out bool mouseOver )
		{
			var window = (FlowGraphEditor)window2;
			var viewport = window.ViewportControl2.Viewport;
