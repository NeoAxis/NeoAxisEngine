...
namespace NeoAxis
{
	public class FenceAssemblyRegistrationEditor : AssemblyRegistration
	{
		public override void OnRegister()
		{
			...
			if( EngineApp.IsEditor )
			{
				...
				EditorAPI.PreviewImagesManager_RegisterResourceType( "Fence Type" );
			...
			if( !string.IsNullOrEmpty( virtualFileName ) )
			{
				...
				if( fenceType != null )
				{
					...
					using( var stream = File.OpenWrite( fullPath ) )
						generator.Generate( objectInSpace, stream );
