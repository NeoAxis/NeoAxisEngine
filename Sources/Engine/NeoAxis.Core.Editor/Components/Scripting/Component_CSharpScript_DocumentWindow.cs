...
{
	public partial class Component_CSharpScript_DocumentWindow : DocumentWindow
	{
		...
		class ComponentScriptAdapter : ScriptDocument
		{
			...
			// only Component_CSharpScript support context
		...
		public Component_CSharpScript Script
		{
			get { return (Component_CSharpScript)ObjectOfWindow; }
		}

		public Component_CSharpScript_DocumentWindow()
		{
			InitializeComponent();
		}
