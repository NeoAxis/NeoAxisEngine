...
namespace NeoAxis
{
	static class MeshExportImport
	{
		...
		public static bool ExportToFBX( Mesh sourceMesh, string realFileName, out string error )
		{

			//!!!!как для Vegetation. оверрайдить в Mesh?

			//get mesh data
			var operations = new List<RenderingPipeline.RenderSceneData.MeshDataRenderOperation>();
