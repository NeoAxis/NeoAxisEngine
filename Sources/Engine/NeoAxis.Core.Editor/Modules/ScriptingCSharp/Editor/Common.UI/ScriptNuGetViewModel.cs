...
//{
//	[Export, Shared]
//    internal sealed class ScriptNuGetViewModel : ScriptNotificationObject
//    {
...
//    [Export]
//    internal sealed class NuGetDocumentViewModel : ScriptNotificationObject
//    {
//        private readonly ScriptNuGetViewModel _nuGetViewModel;
...
//        public NuGetDocumentViewModel(ScriptNuGetViewModel nuGetViewModel)
//        {
...
//        public Task InstallPackage(PackageData package)
//        {
...
//            try
//            {
//                var result = await _nuGetViewModel.InstallPackage(
//					id, version, true, TargetFrameworkName).ConfigureAwait(false);
