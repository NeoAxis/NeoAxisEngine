...
#endif
    {
        ...
        private async void OnMouseHover(object sender, MouseEventArgs e)
        {
            ...
            if (_toolTip == null)
            {
				...
				{
					_toolTip.Background = new SolidColorBrush( Color.FromArgb( 255, 10, 10, 10 ) );
					_toolTip.Foreground = new SolidColorBrush( Color.FromArgb( 255, 230, 230, 230 ) );
				}
        ...
        private async Task ShowCompletion(TriggerMode triggerMode)
        {
            ...
            if (results.OverloadProvider != null)
            {
                ...
                else
                {
					...
					if( AvalonEditDarkThemeUtility.DarkTheme )
					{
						_insightWindow.Background = new SolidColorBrush( Color.FromArgb( 255, 10, 10, 10 ) );
						_insightWindow.Foreground = new SolidColorBrush( Color.FromArgb( 255, 230, 230, 230 ) );
					}
