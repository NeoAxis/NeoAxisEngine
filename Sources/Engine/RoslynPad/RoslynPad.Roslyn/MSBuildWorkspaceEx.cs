...
//	/// </summary>
//	public sealed class MSBuildWorkspaceEx : Workspace
//	{
...
//		/// </summary>
//		public static MSBuildWorkspaceEx Create()
//		{
...
//		public static MSBuildWorkspaceEx Create( IDictionary<string, string> properties )
//		{
...
//		public static MSBuildWorkspaceEx Create( HostServices hostServices )
//		{
...
//		/// These are the same properties that are passed to msbuild via the /property:&lt;n&gt;=&lt;v&gt; command line argument.</param>
//		/// <param name="hostServices">The <see cref="HostServices"/> used to configure this workspace.</param>
//		public static MSBuildWorkspaceEx Create( IDictionary<string, string> properties, HostServices hostServices )
//		{
//			if( properties == null )
//			{
...
//			return new MSBuildWorkspaceEx( hostServices, properties.ToImmutableDictionary() );
//		}
